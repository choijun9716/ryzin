    ...
    targetEl.innerHTML = `
      ...
      <div class="card" style="margin-bottom: var(--space-4);">
        ...
        <div style="text-align: center; background-color: #f8fafc; padding: 16px; border-radius: var(--radius-sm); border: 1px dashed var(--border);">
          <img id="admin-banner-preview" src="${store.getSetting('detail_banner_url', 'https://vybrnhyaeugfwezbygdt.supabase.co/storage/v1/object/public/class_applications/detail_banner_1785226535425.png')}" alt="현재 배너 이미지" style="max-width: 100%; max-height: 220px; object-fit: contain; border-radius: var(--radius-sm);" />
        </div>
      </div>
