...
`;return typeof a==`function`&&a(null,p),p}}));o((e=>{var t=Ci(),n=Ki(),r=Ji(),i=Yi();function a(e,r,i,a,o){let s=[].slice.call(arguments,1),c=s.length,l=typeof s[c-1]==`function`;if(!l&&!t())throw Error(`Callback required as last argument`);if(l){if(c<2)throw Error(`Too few arguments provided`);c===2?(o=i,i=r,r=a=void 0):c===3&&(r.getContext&&o===void 0?(o=a,a=void 0):(o=a,a=i,i=r,r=void 0))}else{if(c<1)throw Error(`Too few arguments provided`);return c===1?(i=r,r=a=void 0):c===2&&!r.getContext&&(a=i,i=r,r=void 0),new Promise(function(t,o){try{t(e(n.create(i,a),r,a))}catch(e){o(e)}})}try{let t=n.create(i,a);o(null,e(t,r,a))}catch(e){o(e)}}e.create=n.create,e.toCanvas=a.bind(null,r.render),e.toDataURL=a.bind(null,r.renderToDataURL),e.toString=a.bind(null,function(e,t,n){return i.render(e,n)})}))();function Xi(){U.isDemoMode&&(localStorage.setItem(`ryzin_is_demo_mode`,`false`),U.isDemoMode=!1,U.STORAGE_KEY=`livecommerce_erp_data`,U._load());let e=document.createElement(`div`);return e.className=`login-container`,e.innerHTML=`
  ...
  `;let o=()=>{i.innerHTML=``};i.querySelector(`#u-close-btn`).addEventListener(`click`,o),i.querySelector(`#u-cancel-btn`).addEventListener(`click`,o),i.querySelector(`#u-modal-form`).addEventListener(`submit`,async a=>{a.preventDefault();let s={user_code:i.querySelector(`#um-code`).value.trim(),name:i.querySelector(`#um-name`).value.trim(),email:i.querySelector(`#um-email`).value.trim(),points:parseInt(i.querySelector(`#um-points`).value)||0,coupons_count:parseInt(i.querySelector(`#um-coupons`).value)||0,membership_active:i.querySelector(`#um-mem`).checked,default_address:i.querySelector(`#um-addr`).value.trim()};try{r&&e&&e.id&&!String(e.id).startsWith(`u-fallback`)?await la.update(e.id,s):await la.insert(s),Z(`회원 정보 저장이 완료되었습니다.`)}catch{Z(`회원 정보 저장 완료`)}o(),await Oa(n,t)})}function Aa(){let e=document.createElement(`div`),t=`list`;function n(e){if(!e)return`-`;try{let t=new Date(e);return isNaN(t.getTime())?e:`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)} ${String(t.getHours()).padStart(2,`0`)}:${String(t.getMinutes()).padStart(2,`0`)}`}catch{return e}}function r(){e.innerHTML=`
    ...
    `,e.querySelectorAll(`[data-tab]`).forEach(e=>{e.addEventListener(`click`,e=>{t=e.target.dataset.tab,l()})}),d()}function u(){return t===`hero`?`
        <div class="card">
          <div class="card-header" style="display:flex; justify-content:space-between; align-items:center;">
      ...
      `:``}function d(){e.querySelector(`#btn-save-hero`)?.addEventListener(`click`,()=>{let t=e.querySelectorAll(`.input-hero-img`),n={col1:[],col2:[],col3:[],col4:[]};t.forEach(e=>{let t=e.dataset.col;e.value.trim()&&n[t].push(e.value.trim())}),i=n,r(`hero`,i),J(`메인 히어로 이미지 갤러리가 저장되었습니다.`)}),e.querySelectorAll(`.btn-del-hero-img`).forEach(e=>{e.addEventListener(`click`,e=>{let t=e.target.dataset.col,n=parseInt(e.target.dataset.idx);i[t].splice(n,1),r(`hero`,i),l()})}),e.querySelectorAll(`.btn-add-hero-img`).forEach(e=>{e.addEventListener(`click`,e=>{let t=e.target.dataset.col;i[t]||(i[t]=[]),i[t].push(`assets/001.jpg`),r(`hero`,i),l()})}),e.querySelector(`#btn-add-pf`)?.addEventListener(`click`,()=>{let e=prompt(`포트폴리오 브랜드명/제목:`);if(!e)return;let t=prompt(`이미지 경로 (예: ./assets/001.jpg):`,`./assets/001.jpg`)||`./assets/001.jpg`,n=prompt(`방송/영상 URL 링크:`,`#`)||`#`;a.unshift({title:e,category:`beauty`,image:t,link:n}),r(`portfolio`,a),J(`새 포트폴리오가 추가되었습니다.`),l()}),e.querySelectorAll(`.btn-del-pf`).forEach(e=>{e.addEventListener(`click`,e=>{let t=parseInt(e.target.dataset.idx);a.splice(t,1),r(`portfolio`,a),J(`포트폴리오 항목이 삭제되었습니다.`),l()})}),e.querySelector(`#btn-add-pkg`)?.addEventListener(`click`,()=>{let e=prompt(`패키지 명칭:`);if(!e)return;let t=prompt(`가격:`,`1,500,000원`)||`1,500,000원`,n=prompt(`구성 내용:`,`4K 촬영, 메인 쇼호스트`)||``;o.push({name:e,price:t,features:n}),r(`packages`,o),J(`새 패키지가 추가되었습니다.`),l()}),e.querySelectorAll(`.btn-del-pkg`).forEach(e=>{e.addEventListener(`click`,e=>{let t=parseInt(e.target.dataset.idx);o.splice(t,1),r(`packages`,o),l()})}),e.querySelector(`#btn-add-story`)?.addEventListener(`click`,()=>{let e=prompt(`브랜드명:`);if(!e)return;let t=prompt(`후기/스토리 한줄 문구:`)||``;s.push({brand:e,quote:t,author:`브랜드 담당자`}),r(`stories`,s),J(`브랜드 스토리가 추가되었습니다.`),l()}),e.querySelectorAll(`.btn-del-story`).forEach(e=>{e.addEventListener(`click`,e=>{let t=parseInt(e.target.dataset.idx);s.splice(t,1),r(`stories`,s),l()})}),e.querySelector(`#btn-add-logo`)?.addEventListener(`click`,()=>{let e=prompt(`파트너 브랜드명:`);if(!e)return;let t=prompt(`로고 이미지 경로:`,`./assets/logo.png`)||`./assets/logo.png`;c.push({name:e,logo:t}),r(`logos`,c),J(`파트너 로고가 추가되었습니다.`),l()}),e.querySelectorAll(`.btn-del-logo`).forEach(e=>{e.addEventListener(`click`,e=>{let t=parseInt(e.target.dataset.idx);c.splice(t,1),r(`logos`,c),l()})})}return l(),e}x(),j();async function Ia(){let e=document.getElementById(`app`);e.innerHTML=`
  ...
  `;try{let e=new Promise(e=>setTimeout(()=>e(!0),3e3));await Promise.race([U.init(),e])}catch(e){console.warn(`데이터 로딩 타임아웃/오류 발생, 로컬 데이터로 접속합니다.`,e)}let t=()=>{if(e.querySelector(`.sidebar`))return;e.innerHTML=``,e.className=`app-layout`,e.appendChild(Qe());let t=document.createElement(`div`);t.className=`mobile-overlay`,t.onclick=()=>document.querySelector(`.sidebar`).classList.remove(`open`),e.appendChild(t);let n=document.createElement(`button`);n.className=`mobile-menu-btn`,n.innerHTML=`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>`,n.onclick=()=>document.querySelector(`.sidebar`).classList.toggle(`open`),e.appendChild(n);let r=document.createElement(`main`);r.className=`main-content`,r.id=`page-content`,e.appendChild(r),M.setContainer(r)};M.beforeEach(n=>{let r=!!U.getCurrentUser();if(!r&&n!==`/login`)return`/login`;if(r&&n===`/login`)return`/`;if(r&&n===`/live_stream`){let e=U.getCurrentUser();if(U.isDemoMode||e&&(e.id===`demo`||e.role===`demo`))return`/`}return n===`/login`?(e.innerHTML=``,e.className=``,M.setContainer(e)):t(),!0}),M.register(`/login`,()=>Xi()),M.register(`/`,()=>pt()),M.register(`/live_stream`,()=>Nt()),M.register(`/projects`,()=>Gt()),M.register(`/projects/new`,()=>Gt()),M.register(`/projects/:id`,e=>qt(e)),M.register(`/hosts`,()=>It()),M.register(`/hosts/:id`,e=>Rt(e)),M.register(`/brands`,()=>Vt()),M.register(`/brands/:id`,e=>Ut(e)),M.register(`/finance`,()=>rn()),M.register(`/settlement`,()=>sn()),M.register(`/contracts`,()=>un()),M.register(`/marketing`,()=>mn()),M.register(`/crm`,()=>hn()),M.register(`/shop_manage`,()=>ya()),M.register(`/class_applications`,()=>Aa()),M.register(`/news_manage`,()=>Pa()),M.register(`/homepage_manage`,()=>Fa()),M.register(`/settings`,()=>gn()),M.start(),document.addEventListener(`click`,e=>{let t=e.target.closest(`a[href]`);t&&t.getAttribute(`href`).startsWith(`/`)&&!t.getAttribute(`target`)&&(e.preventDefault(),M.navigate(t.getAttribute(`href`)))})}Ia();