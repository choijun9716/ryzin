        ...
        <div style="display:flex; align-items:center; gap:8px; margin-top:8px;">
          ...
          ${e.isFreeGiveaway===!0||e.isFreeGiveaway===`true`?`
            <div style="display:flex; align-items:center; gap:4px; background:#fff1f2; padding:4px 8px; border-radius:8px; border:1px solid #fecdd3; white-space:nowrap;">
              ...
              <input type="number" class="modern-input" style="width:55px; padding:4px 6px; font-size:12px; font-weight:700; text-align:center;" data-idx="${t}" data-field="giveawayStock" value="${e.giveawayStock||3}">
