...
`)),e.startsWith(`data:image`)?e:`data:image/${n};base64,${e}`},l=(e,t,n,r=.82)=>new Promise((i,a)=>{let o=new Image;o.src=URL.createObjectURL(e),o.onload=()=>{let e=o.width,a=o.height;e>a?e>t&&(a=Math.round(a*t/e),e=t):a>n&&(e=Math.round(e*n/a),a=n);let s=document.createElement(`canvas`);s.width=e,s.height=a,s.getContext(`2d`).drawImage(o,0,0,e,a);let c=s.toDataURL(`image/jpeg`,r);URL.revokeObjectURL(o.src),i(c.split(`,`)[1])},o.onerror=e=>{URL.revokeObjectURL(o.src),a(e)}});window[`live_loaded_${t}`]===void 0&&(window[`live_loaded_${t}`]=!1);let u=xt(t)||{},d=Ct(t),f=Tt(t);Array.isArray(f)||(f=[]);let p=Dt(t),m=null,h=!1,g=0,_=[];X&&!window[`live_loaded_${t}`]?X.from(`live_control`).select(`*`).eq(`live_id`,t).maybeSingle().then(({data:e,error:n})=>{if(window[`live_loaded_${t}`]=!0,!n&&e){let n=yt().findIndex(e=>e.id===t),r=n===-1?1:n+1;u.brandName=e.title||`라이브 ${r}`,u.title=e.subtitle||`단독 특가 라이브 방송 중!`,u.streamUrl=e.stream_url||``;let i=e.profile_image||``,a=`라이브 보기`,o=`right`,s=``,c=!1,l=``,p=!1,m=i.split(`#`),h=m[0];if(m.slice(1).forEach(e=>{e===`nosplash`||(e.startsWith(`widgetText=`)?a=decodeURIComponent(e.replace(`widgetText=`,``)):e.startsWith(`widgetPosition=`)?o=e.replace(`widgetPosition=`,``):e.startsWith(`widgetImageUrl=`)?s=e.replace(`widgetImageUrl=`,``):e.startsWith(`showOnMain=`)?c=e.replace(`showOnMain=`,``)===`true`:e.startsWith(`standbyImageUrl=`)?l=decodeURIComponent(e.replace(`standbyImageUrl=`,``)):e.startsWith(`useStandbyImage=`)&&(p=e.replace(`useStandbyImage=`,``)===`true`))}),u.logoUrl=h,u.showSplash=!i.includes(`#nosplash`),u.widgetText=a,u.widgetPosition=o,u.widgetImageUrl=s,u.showOnMain=c,u.standbyImageUrl=l,u.useStandbyImage=p,u.thumbnailUrl=e.thumbnail_url||``,u.liveStartTime=e.start_time||``,u.showViewers=e.show_viewers!==!1,u.isLive=e.status===`ON`,u.shareTitle=e.share_title||``,u.shareDesc=e.share_desc||``,u.shareImageUrl=e.share_image||``,u.likeImageUrl=e.like_image_url||``,d.viewers=e.viewers||0,d.hearts=e.hearts||0,d.cumViewers=e.cum_viewers||0,e.products){let t=typeof e.products==`string`?JSON.parse(e.products):e.products;Array.isArray(t)&&(!f||f.length===0?(f.length=0,f.push(...t)):f.forEach(e=>{let n=t.find(t=>t.id===e.id||t.name===e.name);n&&(n.price!==void 0&&(e.price=n.price),n.normalPrice!==void 0&&(e.normalPrice=n.normalPrice),n.discountRate!==void 0&&(e.discountRate=n.discountRate),e.clicks=parseInt(n.clicks)||0,!e.image&&n.image&&(e.image=n.image))}))}St(t,u),wt(t,d),Et(t,f);let g=(e,t)=>{let n=S.querySelector(`#`+e)||document.getElementById(e);n&&document.activeElement!==n&&(n.type===`checkbox`?n.checked=!!t:n.value=t)};g(`cfg-brandName`,u.brandName),g(`cfg-title`,u.title),g(`cfg-stream`,u.streamUrl),g(`cfg-showViewers`,u.showViewers),g(`cfg-liveStartTime`,u.liveStartTime),g(`cfg-shareTitle`,u.shareTitle),g(`cfg-shareDesc`,u.shareDesc);let _=S.querySelector(`#logo-preview`)||document.getElementById(`logo-preview`);_&&(_.src=u.logoUrl);let v=S.querySelector(`#thumbnail-preview`)||document.getElementById(`thumbnail-preview`);v&&(v.src=u.thumbnailUrl);let y=S.querySelector(`#like-preview`)||document.getElementById(`like-preview`);y&&(y.src=u.likeImageUrl,y.style.display=u.likeImageUrl?`block`:`none`);let b=S.querySelector(`#btn-toggle-live`)||document.getElementById(`btn-toggle-live`);b&&document.activeElement!==b&&(b.textContent=u.isLive?`라이브 종료`:`라이브 시작`,b.className=`action-btn ${u.isLive?`btn-danger-solid`:`btn-success-solid`}`)}}).catch(e=>{window[`live_loaded_${t}`]=!0,console.warn(`Initial Supabase load failed`,e)}):window[`live_loaded_${t}`]=!0;let v=()=>{St(t,u),jt(t,u,d,f)},y=()=>{wt(t,d),jt(t,u,d,f)},b=(e=!0)=>{Et(t,f),jt(t,u,d,f,e)},x=()=>Ot(t,p),S=document.createElement(`div`);S.style.cssText=`display:flex; gap:0; height:100%; overflow:hidden;`;let C=document.createElement(`div`);C.style.cssText=`flex:1; display:flex; flex-direction:column; overflow:hidden;`;let w=document.createElement(`div`);w.style.cssText=`display:flex; align-items:center; gap:18px; padding:18px 28px; background:#fff; border-bottom:1.5px solid #e2e8f0; flex-shrink:0;`;let T=u.isLive?`<span style="font-size:10px; font-weight:800; color:#ef4444; background:#fee2e2; border:1px solid #fecaca; padding:2px 6px; border-radius:4px; white-space:nowrap; height:16px; display:inline-flex; align-items:center; gap:4px;"><span style="width:5px; height:5px; background:#ef4444; border-radius:50%; display:inline-block;"></span>라이브 중</span>`:`<span style="font-size:10px; font-weight:800; color:#64748b; background:#f1f5f9; border:1px solid #e2e8f0; padding:2px 6px; border-radius:4px; white-space:nowrap; height:16px; display:inline-flex; align-items:center;">송출 대기</span>`,E=u.isLive?`<div id="onair-timer-wrapper" style="display:inline-flex; align-items:center; gap:6px; font-size:12px; font-weight:700; color:#ef4444; background:#fef2f2; padding:4px 10px; border-radius:6px; border:1px solid #fecaca; white-space:nowrap;"> <div style="width:6px; height:6px; background:#ef4444; border-radius:50%; box-shadow:0 0 0 2px #fee2e2;"></div> 방송 중 <span id="onair-timer-text" style="font-family:monospace; margin-left:2px; letter-spacing:0.02em;">00:00:00</span> </div>`:``,D=o?`<button class="tab-btn active" data-tab="chat" style="flex:1; text-align:center; padding:6px 12px; font-size:13px; border-radius:8px;">채팅 / 봇 관리</button>`:`
  ...
  `,C.appendChild(w),setTimeout(()=>{let e=document.getElementById(`btn-copy-live-url`);e&&e.addEventListener(`click`,async()=>{let n=`https://ryzincorp.com/live/${t}`;try{await navigator.clipboard.writeText(n),e.textContent=`복사 완료!`,e.style.color=`#10b981`,e.style.borderColor=`#a7f3d0`,e.style.backgroundColor=`#ecfdf5`,setTimeout(()=>{e.textContent=`복사`,e.style.color=``,e.style.borderColor=``,e.style.backgroundColor=``},2e3)}catch(e){console.warn(`URL 복사 오류:`,e)}})},100);let O=null;u.isLive&&setTimeout(()=>{let e=document.getElementById(`onair-timer-text`);if(e){let t=u.liveStartTime?new Date(u.liveStartTime).getTime():0,n=Date.now();(!t||t>n)&&(t=n);let r=()=>{let n=Date.now()-t,r=Math.floor(n/36e5),i=Math.floor(n%36e5/6e4),a=Math.floor(n%6e4/1e3);e.textContent=`${r.toString().padStart(2,`0`)}:${i.toString().padStart(2,`0`)}:${a.toString().padStart(2,`0`)}`};r(),O=setInterval(r,1e3)}},100);let k=()=>{O&&=(clearInterval(O),null)},A=document.createElement(`div`);A.style.cssText=`flex:1; overflow-y:auto; padding:28px;`,C.appendChild(A),S.appendChild(C);let j=document.createElement(`div`);j.style.cssText=`width:340px; flex-shrink:0; display:flex; flex-direction:column; align-items:center; padding:24px 20px; background:#fff; border-left:1.5px solid #e2e8f0; gap:16px; overflow-y:auto;`;let M=`${window.location.origin.includes(`localhost:5173`)?`http://localhost:8080/live/`:`/live/`}?id=${t}&v=202608121330`,N=`https://ryzincorp.com/live/${t}`,P=`${N}?embed=1&v=202608121330`,ee=`${N}?widget=1&v=202608121330`,te=`<iframe src="${P}" width="390" height="693" frameborder="0" allow="autoplay; fullscreen" allowfullscreen style="border-radius:20px; overflow:hidden; border:none;"></iframe>`,F=`<iframe src="${P}" width="100%" height="600" frameborder="0" allow="autoplay; fullscreen" allowfullscreen style="border:none; border-radius:12px; overflow:hidden;"></iframe>`,I=`<iframe id="ryzin-live-iframe" src="${ee}" style="position:fixed; bottom:56px; right:12px; width:220px; height:90px; border:none; z-index:999999; background:transparent;" allow="autoplay; fullscreen" allowfullscreen></iframe>
<script>
...
<\/script>`;`${t}`,j.innerHTML=`
    ...
    <div style="width:100%; border-top:1.5px solid #e2e8f0; padding-top:16px; margin-top:4px;">
      ...
      <div style="margin-bottom:10px;">
        ...
        <div style="position:relative;">
          <input type="text" id="widget-url-code" readonly style="width:100%; font-size:10px; font-family:monospace; background:#f8fafc; border:1.5px solid #e2e8f0; border-radius:8px; padding:8px 64px 8px 8px; color:#334155; line-height:1.5; box-sizing:border-box; outline:none;" value="${I.replace(/"/g,`&quot;`)}">
  ...
  `,S.appendChild(j),e.appendChild(S);let ne=(e,t)=>{let n=S.querySelector(`#`+e),r=S.querySelector(`#`+t);!n||!r||navigator.clipboard.writeText(n.value).then(()=>{r.textContent=`복사됨!`,r.style.background=`#22c55e`,setTimeout(()=>{r.textContent=`복사`,r.style.background=`#3b82f6`},2e3)}).catch(()=>{n.select(),document.execCommand(`copy`),r.textContent=`복사됨!`,r.style.background=`#22c55e`,setTimeout(()=>{r.textContent=`복사`,r.style.background=`#3b82f6`},2e3)})},re=S.querySelector(`#btn-copy-embed-mobile`);re&&re.addEventListener(`click`,()=>ne(`embed-url-mobile`,`btn-copy-embed-mobile`));let ie=S.querySelector(`#btn-copy-embed-wide`);ie&&ie.addEventListener(`click`,()=>ne(`embed-url-wide`,`btn-copy-embed-wide`));let ae=S.querySelector(`#btn-copy-widget-code`);ae&&ae.addEventListener(`click`,()=>ne(`widget-url-code`,`btn-copy-widget-code`));let oe=S.querySelector(`#cfg-widgetText`);oe&&oe.addEventListener(`input`,e=>{u.widgetText=e.target.value,St(t,u),jt(t,u,d,f)});let L=S.querySelector(`#cfg-widgetPosition`);L&&L.addEventListener(`change`,e=>{u.widgetPosition=e.target.value,St(t,u),jt(t,u,d,f)});let R=S.querySelector(`#cfg-showOnMain`);R&&R.addEventListener(`change`,async e=>{u.showOnMain=e.target.checked,St(t,u);let n=(u.logoUrl||``)+(u.showSplash===!1?`#nosplash`:``)+`#widgetText=${encodeURIComponent(u.widgetText||`라이브 보기`)}#widgetPosition=${u.widgetPosition||`right`}#widgetImageUrl=${u.widgetImageUrl||``}#showOnMain=${u.showOnMain===!0}`;if(X)try{await X.from(`live_control`).update({profile_image:n,updated_at:new Date().toISOString()}).eq(`live_id`,t)}catch(e){console.warn(`Direct showOnMain update failed:`,e)}jt(t,u,d,f,!0)});let z=S.querySelector(`#btn-upload-widget-img`),se=S.querySelector(`#cfg-widgetImageFile`);z&&se&&(z.addEventListener(`click`,()=>se.click()),se.addEventListener(`change`,async e=>{let n=e.target.files[0];if(n){z.disabled=!0,z.textContent=`업로드 중...`;try{let e=await c(await l(n,256,256,.88));u.widgetImageUrl=e,St(t,u);let r=S.querySelector(`#widget-image-preview`)||document.getElementById(`widget-image-preview`),i=S.querySelector(`#widget-image-placeholder`)||document.getElementById(`widget-image-placeholder`);r&&i&&(r.src=e,r.style.display=`block`,i.style.display=`none`),jt(t,u,d,f,!0)}catch(e){console.error(`이미지 업로드 오류:`,e),alert(`이미지 업로드 실패: `+e.message)}finally{z.disabled=!1,z.textContent=`이미지 업로드`}}}));let ce=S.querySelector(`#btn-reset-widget-img`);ce&&ce.addEventListener(`click`,()=>{u.widgetImageUrl=``,St(t,u);let e=S.querySelector(`#widget-image-preview`)||document.getElementById(`widget-image-preview`),n=S.querySelector(`#widget-image-placeholder`)||document.getElementById(`widget-image-placeholder`);e&&n&&(e.src=``,e.style.display=`none`,n.style.display=`block`),jt(t,u,d,f,!0)});let le=()=>{A.innerHTML=`
...
이 작업은 복구할 수 없습니다.`)){let e=document.getElementById(`btn-clear-chats`);e.disabled=!0,e.textContent=`초기화 중...`;try{if(!X)throw Error(`Supabase client가 로드되지 않았습니다.`);let{error:e}=await X.from(`live_chats`).delete().eq(`live_id`,t);if(e)throw e;alert(`채팅 내역이 성공적으로 초기화되었습니다!`),s.innerHTML=`<div style="color:#94a3b8; text-align:center; padding-top:70px; font-weight:500;">
            <div style="font-size:24px; margin-bottom:8px;">💭</div>
            실시간 채팅 내역이 여기에 표시됩니다.
          </div>`}catch(e){alert(`채팅 내역 초기화 실패: `+e.message)}finally{e.disabled=!1,e.textContent=`채팅 내역 초기화`}}});let O=document.getElementById(`bot-chat-list`),k=document.getElementById(`bot-interval`);O.addEventListener(`input`,()=>{p.list=O.value,x()}),k.addEventListener(`input`,()=>{p.interval=parseInt(k.value)||10,x()});let j=()=>{let e=document.getElementById(`bot-icon`),t=document.getElementById(`bot-text`),n=document.getElementById(`btn-toggle-bot`);n&&(h?(e.textContent=`⏸`,t.textContent=`채팅 봇 중지`,n.className=`action-btn btn-danger-solid`,n.style.cssText=`width:100%; justify-content:center; padding:14px; font-size:15px; gap:8px;`):(e.textContent=`▶`,t.textContent=`채팅 봇 시작`,n.className=`action-btn btn-primary-solid`,n.style.cssText=`width:100%; justify-content:center; padding:14px; font-size:15px; gap:8px;`))};j(),document.getElementById(`btn-toggle-bot`).addEventListener(`click`,()=>{if(h=!h,h){if(_=O.value.split(`
`).map(e=>e.trim()).filter(e=>e.includes(`|`)),_.length===0){alert(`닉네임|내용 형식으로 1줄 이상 입력해주세요.`),h=!1;return}g>=_.length&&(g=0),j();let e=parseInt(k.value)||10;m&&clearInterval(m),m=setInterval(async()=>{if(g>=_.length){clearInterval(m),m=null,h=!1,j();return}let[e,...n]=_[g++].split(`|`),r=n.join(`|`).trim();if(!e||!r)return;let i=Date.now(),a=document.createElement(`div`);a.style.cssText=`margin-bottom:8px; padding:6px 0; border-bottom:1px solid #f1f5f9;`,a.innerHTML=`<span style="font-weight:700; color:#64748b;">${e.trim()}:</span> ${r}`,s.innerHTML.includes(`실시간 채팅`)&&(s.innerHTML=``),s.appendChild(a),s.scrollTop=s.scrollHeight;try{if(!X)return;await X.from(`live_chats`).insert([{live_id:t,created_at:i,nickname:e.trim(),content:r}])}catch(e){console.warn(`Bot chat failed`,e)}},e*1e3)}else m&&clearInterval(m),m=null,j()});let M=document.getElementById(`auto-reply-active`),N=document.getElementById(`btn-add-ar`),P=document.getElementById(`ar-title`),ee=document.getElementById(`ar-keywords`),te=document.getElementById(`ar-answer`),F=document.getElementById(`ar-list-container`),I=()=>{if(F){if(!p.autoReplyRules||p.autoReplyRules.length===0){F.innerHTML=`<div style="text-align:center; padding:20px; color:#94a3b8; font-size:13px; font-weight:500;">등록된 자동응답 규칙이 없습니다.</div>`;return}F.innerHTML=p.autoReplyRules.map((e,t)=>`
    ...
    `,X&&X.from(`live_control`).select(`products`).eq(`live_id`,t).maybeSingle().then(({data:t,error:n})=>{if(n)throw n;if(t&&t.products)try{let n=typeof t.products==`string`?JSON.parse(t.products):t.products;if(Array.isArray(n)||(n=[]),Array.isArray(n)){!f||f.length===0?(f.length=0,f.push(...n)):f.forEach(e=>{let t=n.find(t=>t.id===e.id||t.name===e.name);t&&(t.price!==void 0&&(e.price=t.price),t.normalPrice!==void 0&&(e.normalPrice=t.normalPrice),t.discountRate!==void 0&&(e.discountRate=t.discountRate),e.clicks=parseInt(t.clicks)||0,!e.image&&t.image&&(e.image=t.image))}),b();let t=document.getElementById(`product-list-container`);t&&(t.innerHTML=V(),e())}}catch{}}).catch(e=>console.warn(`Failed to load product clicks from Supabase`,e));let e=()=>{let n=document.getElementById(`product-list-container`),r=null,i=()=>{r&&clearTimeout(r),r=setTimeout(()=>{b(!0)},300)};n.querySelectorAll(`.price-input`).forEach(e=>{e.addEventListener(`input`,e=>{let t=e.target.value.replace(/[^0-9]/g,``);e.target.value=t?Number(t).toLocaleString():``;let r=parseInt(e.target.dataset.idx),a=e.target.dataset.field;if(f[r]){f[r][a]=t;let e=Number((f[r].normalPrice||``).toString().replace(/[^0-9]/g,``)),o=Number((f[r].price||``).toString().replace(/[^0-9]/g,``));if(e>0&&e>=o){f[r].discountRate=Math.floor((e-o)/e*100);let t=n.querySelector(`input[data-idx="${r}"][data-field="discountRate"]`);t&&(t.value=f[r].discountRate)}else{f[r].discountRate=0;let e=n.querySelector(`input[data-idx="${r}"][data-field="discountRate"]`);e&&(e.value=0)}i()}}),e.addEventListener(`blur`,()=>{b(!0)})}),n.querySelectorAll(`input[data-field]`).forEach(t=>{let r=t=>{let r=parseInt(t.target.dataset.idx),i=t.target.dataset.field;if(t.target.type===`checkbox`){if(f[r][i]=t.target.checked,i===`isFreeGiveaway`){t.target.checked?(f[r].price=`0`,f[r].hideByDefault=!0,f[r].isGiveawayActive=!0,f[r].giveawayStock||(f[r].giveawayStock=3),f[r].giveawayClaimed===void 0&&(f[r].giveawayClaimed=0)):f[r].isGiveawayActive=!1,b(!0),n.innerHTML=V(),e();return}if(i===`isLeadForm`){t.target.checked?f[r].url=`__LEAD_FORM__`:f[r].url===`__LEAD_FORM__`&&(f[r].url=``),b(!0),n.innerHTML=V(),e();return}}else i===`price`||i===`normalPrice`?f[r][i]=t.target.value.replace(/[^0-9]/g,``):f[r][i]=t.target.value;if(i===`price`||i===`normalPrice`){let e=Number((f[r].normalPrice||``).toString().replace(/[^0-9]/g,``)),t=Number((f[r].price||``).toString().replace(/[^0-9]/g,``));if(e>0&&e>=t){f[r].discountRate=Math.floor((e-t)/e*100);let i=n.querySelector(`input[data-idx="${r}"][data-field="discountRate"]`);i&&(i.value=f[r].discountRate)}else{f[r].discountRate=0;let e=n.querySelector(`input[data-idx="${r}"][data-field="discountRate"]`);e&&(e.value=0)}}b(!0)};t.addEventListener(`input`,e=>{let t=parseInt(e.target.dataset.idx),n=e.target.dataset.field;f[t]&&(n===`name`?(f[t].name=e.target.value.trim(),i()):n===`url`?(f[t].url=e.target.value.trim(),i()):n===`giveawayStock`&&(f[t].giveawayStock=parseInt(e.target.value)||3,i()))}),t.addEventListener(`change`,r),t.addEventListener(`blur`,r)}),n.querySelectorAll(`.prod-img-upload`).forEach(r=>{r.addEventListener(`change`,async r=>{let i=r.target.files[0];if(!i)return;let a=parseInt(r.target.dataset.idx),o=document.getElementById(`img-prev-${a}`);o&&(o.style.opacity=`0.5`);try{let r=await c(await l(i,600,600,.85));if(!r)throw Error(`서버로부터 이미지 URL을 받지 못했습니다.`);f[a].image=r,o&&(o.src=r),b(!0),jt(t,u,d,f,!0),n.innerHTML=V(),e()}catch(e){console.error(`상품 이미지 업로드 에러:`,e),alert(`상품 이미지 업로드 에러: `+e.message)}finally{o&&(o.style.opacity=`1`)}})}),n.querySelectorAll(`.btn-deal-start`).forEach(r=>{r.addEventListener(`click`,r=>{let i=parseInt(r.target.dataset.idx),a=parseInt(document.getElementById(`deal-min-${i}`).value);a>0&&(f[i].dealText=document.getElementById(`deal-text-${i}`).value||`깜짝딜 종료까지`,f[i].dealEndTime=Date.now()+a*60*1e3,b(),n.innerHTML=V(),e(),jt(t,u,d,f,!0),setTimeout(()=>alert(`${a}분 깜짝딜이 시작되었습니다!`),10))})}),n.querySelectorAll(`.btn-deal-cancel`).forEach(r=>{r.addEventListener(`click`,r=>{let i=parseInt(r.target.dataset.idx);f[i].dealEndTime=0,b(),n.innerHTML=V(),e(),jt(t,u,d,f,!0)})}),n.querySelectorAll(`.btn-giveaway-start`).forEach(r=>{r.addEventListener(`click`,r=>{let i=parseInt(r.target.dataset.idx),a=f[i];if(!a)return;let o=parseInt(a.giveawayStock)||3;a.isFreeGiveaway=!0,a.price=`0`,a.hideByDefault=!0,a.giveawayStock=o,a.giveawayClaimed=0,a.isGiveawayActive=!0,a.giveawayStartedAt=Date.now(),b(!0),n.innerHTML=V(),e(),jt(t,u,d,f,!0),alert(`선착순 ${o}개 무료나눔이 라이브 화면에 시작되었습니다!`)})}),n.querySelectorAll(`.btn-giveaway-stop`).forEach(r=>{r.addEventListener(`click`,r=>{let i=parseInt(r.target.dataset.idx),a=f[i];a&&(a.isGiveawayActive=!1,a.giveawayStartedAt=0,b(!0),n.innerHTML=V(),e(),jt(t,u,d,f,!0),alert(`무료나눔 화면 송출이 종료되었습니다.`))})}),n.querySelectorAll(`.btn-del-product`).forEach(t=>{t.addEventListener(`click`,t=>{let r=parseInt(t.currentTarget.dataset.idx),i=f[r]?.name||`이 상품`;confirm(`정말 "${i}" 상품을 삭제하시겠습니까?`)&&(f.splice(r,1),b(!0),n.innerHTML=V(),e())})}),n.querySelectorAll(`.btn-move-up`).forEach(t=>{t.addEventListener(`click`,t=>{let r=parseInt(t.currentTarget.dataset.idx);if(r>0){let t=f[r-1];f[r-1]=f[r],f[r]=t,b(!0),n.innerHTML=V(),e()}})}),n.querySelectorAll(`.btn-move-down`).forEach(t=>{t.addEventListener(`click`,t=>{let r=parseInt(t.currentTarget.dataset.idx);if(r<f.length-1){let t=f[r+1];f[r+1]=f[r],f[r]=t,b(!0),n.innerHTML=V(),e()}})})};e(),document.getElementById(`btn-add-product`).addEventListener(`click`,()=>{f.push({id:Date.now(),name:`새 상품`,price:``,normalPrice:``,discountRate:0,image:`https://via.placeholder.com/72`,url:`#`}),b(!0),document.getElementById(`product-list-container`).innerHTML=V(),e()}),window.__autoSaveAllProducts=()=>{let e=document.getElementById(`product-list-container`);e&&e.querySelectorAll(`.product-row`).forEach((e,t)=>{if(!f[t])return;let n=e.querySelector(`input[data-field="name"]`),r=e.querySelector(`input[data-field="price"]`),i=e.querySelector(`input[data-field="normalPrice"]`),a=e.querySelector(`input[data-field="url"]`),o=e.querySelector(`input[data-field="isLeadForm"]`),s=e.querySelector(`input[data-field="hideByDefault"]`),c=e.querySelector(`input[data-field="isFreeGiveaway"]`),l=e.querySelector(`input[data-field="giveawayStock"]`);if(n&&(f[t].name=n.value.trim()),i&&(f[t].normalPrice=i.value.replace(/[^0-9]/g,``)),r&&(f[t].price=r.value.replace(/[^0-9]/g,``)),a&&(f[t].url=a.value.trim()),o&&(f[t].isLeadForm=o.checked),s&&(f[t].hideByDefault=s.checked),c&&c.checked){f[t].isFreeGiveaway=!0,f[t].price=`0`,f[t].hideByDefault=!0,f[t].isGiveawayActive===void 0&&(f[t].isGiveawayActive=!0);let e=l?parseInt(l.value):parseInt(f[t].giveawayStock)||3;f[t].giveawayStock=e>0?e:3,f[t].giveawayClaimed===void 0&&(f[t].giveawayClaimed=0)}else c&&!c.checked&&(f[t].isFreeGiveaway=!1,f[t].isGiveawayActive=!1)}),b(!0)}},de=()=>{A.innerHTML=`
      <div class="section-card">
        <div style="display:flex; justify-content:space-between; align-items:center; padding-bottom:16px; border-bottom:1.5px solid #f1f5f9; margin-bottom:20px;">
...
`;e.forEach(e=>{let t=new Date(e.created_at).toLocaleString(`ko-KR`).replace(/,/g,``),r=(e.name||``).replace(/,/g,` `),i=(e.phone||``).replace(/,/g,` `);n+=`${t},${r},${i}\n`});let r=new Blob([`﻿`+n],{type:`text/csv;charset=utf-8;`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=`상담DB_${t}.csv`,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(i)})},fe=()=>{A.innerHTML=`
      <div class="section-card">
        <div style="display:flex; justify-content:space-between; align-items:center; padding-bottom:16px; border-bottom:1.5px solid #f1f5f9; margin-bottom:20px;">
          <div style="display:flex; align-items:center; gap:8px;">
...
`;e.forEach(e=>{let t=e.created_at?new Date(e.created_at).toLocaleString(`ko-KR`).replace(/,/g,``):``,i=``;Array.isArray(e.items)&&e.items.length>0?i=e.items.length>1?`${e.items[0].name} 외 ${e.items.length-1}건`:e.items[0].name:typeof e.items==`string`&&(i=e.items),i=i.replace(/,/g,` `);let a=Number(e.total_amount)||0,o=(e.customer_name||``).replace(/,/g,` `),s=(e.customer_phone||``).replace(/,/g,` `),c=(e.customer_address||``).replace(/,/g,` `),l=r.includes((e.payment_status||``).toLowerCase())?e.status_detail||`결제취소`:`결제완료`,u=e.pg_receipt_id||``;n+=`${t},${i},${a},${o},${s},${c},${l},${u}\n`});let a=new Blob([`﻿`+n],{type:`text/csv;charset=utf-8;`}),o=URL.createObjectURL(a),s=document.createElement(`a`);s.href=o,s.download=`주문내역_${t}.csv`,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(o)});let o=document.getElementById(`order-search-input`);o&&o.addEventListener(`input`,a)},pe=S.querySelector(`#btn-back`);pe&&pe.addEventListener(`click`,()=>{A.dispatchEvent(new Event(`adminTabLeave`)),k(),m&&clearInterval(m),ge&&X.removeChannel(ge),he&&X.removeChannel(he),n(null)});let me=S.querySelector(`#btn-refresh-preview`);me&&me.addEventListener(`click`,()=>{let e=S.querySelector(`#live-preview-iframe`);e&&(e.src=M)});let he=null;X&&(he=X.channel(`bot-sync-${t}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`live_chats`,filter:`live_id=eq.${t}`},e=>{let n=e.new;if(n&&p.autoReplyActive&&p.autoReplyRules&&p.autoReplyRules.length>0){let e=n.nickname||``;if(!e.includes(`|`)&&e!==`관리자`&&e!==`자동응답봇`){let e=(n.content||``).toLowerCase();for(let n of p.autoReplyRules)if(n.keywords.split(`,`).map(e=>e.trim().toLowerCase()).filter(e=>e).some(t=>e.includes(t))){setTimeout(async()=>{try{if(!X)return;await X.from(`live_chats`).insert([{live_id:t,nickname:`자동응답봇`,content:n.answer,created_at:Date.now().toString()}])}catch(e){console.warn(`Auto-reply failed`,e)}},600);break}}}}).subscribe());let ge=null;X&&(ge=X.channel(`admin-sync-${t}`).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`live_control`,filter:`live_id=eq.${t}`},e=>{let n=e.new;if(!n)return;u.brandName=n.title||``,u.title=n.subtitle||``;let r=n.profile_image||``,i=`라이브 보기`,a=`right`,o=``,s=!1,c=r.split(`#`),l=c[0];c.slice(1).forEach(e=>{e===`nosplash`||(e.startsWith(`widgetText=`)?i=decodeURIComponent(e.replace(`widgetText=`,``)):e.startsWith(`widgetPosition=`)?a=e.replace(`widgetPosition=`,``):e.startsWith(`widgetImageUrl=`)?o=e.replace(`widgetImageUrl=`,``):e.startsWith(`showOnMain=`)&&(s=e.replace(`showOnMain=`,``)===`true`))}),u.showSplash=!r.includes(`#nosplash`),u.logoUrl=l,u.widgetText=i,u.widgetPosition=a,u.widgetImageUrl=o,u.showOnMain=s,u.streamUrl=n.stream_url||``,u.showViewers=n.show_viewers!==!1,u.thumbnailUrl=n.thumbnail_url||``,u.liveStartTime=n.start_time||``,u.isLive=n.status===`ON`,u.shareTitle=n.share_title||``,u.shareDesc=n.share_desc||``,u.shareImageUrl=n.share_image||``,u.likeImageUrl=n.like_image_url||``,u.bannedWords=n.banned_words||``,u.bannedUsers=n.banned_users||``,n.winner_name!==void 0&&(u.winner_name=n.winner_name),n.winner_timestamp!==void 0&&(u.winner_timestamp=n.winner_timestamp),n.viewers!==void 0&&(d.viewers=parseInt(n.viewers)||0),n.cum_viewers!==void 0&&(d.cumViewers=parseInt(n.cum_viewers)||0),n.hearts!==void 0&&(d.hearts=parseInt(n.hearts)||0),St(t,u),wt(t,d),typeof window.updateAdminViewersDisplay==`function`&&window.updateAdminViewersDisplay();let p=(e,t)=>{let n=S.querySelector(`#`+e)||document.getElementById(e);n&&document.activeElement!==n&&(n.type===`checkbox`?n.checked=!!t:n.value=t)};p(`cfg-brandName`,u.brandName),p(`cfg-title`,u.title),p(`cfg-stream`,u.streamUrl),p(`cfg-showViewers`,u.showViewers),p(`cfg-liveStartTime`,u.liveStartTime),p(`cfg-shareTitle`,u.shareTitle),p(`cfg-shareDesc`,u.shareDesc),p(`cfg-bannedWords`,u.bannedWords),p(`cfg-bannedUsers`,u.bannedUsers);let m=S.querySelector(`#logo-preview`)||document.getElementById(`logo-preview`);m&&(m.src=u.logoUrl);let h=S.querySelector(`#thumbnail-preview`)||document.getElementById(`thumbnail-preview`);h&&(h.src=u.thumbnailUrl);let g=S.querySelector(`#like-preview`)||document.getElementById(`like-preview`);g&&(g.src=u.likeImageUrl,g.style.display=u.likeImageUrl?`block`:`none`);let _=S.querySelector(`#like-preview-placeholder`)||document.getElementById(`like-preview-placeholder`);_&&(_.style.display=u.likeImageUrl?`none`:`block`);let v=S.querySelector(`#btn-clear-like-icon`)||document.getElementById(`btn-clear-like-icon`);v&&(v.style.display=u.likeImageUrl?`block`:`none`);let y=S.querySelector(`#btn-toggle-live`)||document.getElementById(`btn-toggle-live`);if(y&&document.activeElement!==y&&(y.textContent=u.isLive?`라이브 종료`:`라이브 시작`,y.className=`action-btn ${u.isLive?`btn-danger-solid`:`btn-success-solid`}`),n.products&&Array.isArray(n.products)){let e=JSON.stringify(n.products);if(JSON.stringify(f)!==e){Array.isArray(f)||(f=[]),f.length=0,f.push(...n.products),Et(t,f);let e=S.querySelector(`#product-list-container`)||document.getElementById(`product-list-container`);e&&!e.contains(document.activeElement)&&typeof V==`function`&&(e.innerHTML=V())}}}).subscribe()),X&&setInterval(async()=>{try{let{data:e,error:n}=await X.from(`live_control`).select(`viewers, cum_viewers, hearts`).eq(`live_id`,t).maybeSingle();e&&!n&&(d.viewers=parseInt(e.viewers)||0,d.cumViewers=parseInt(e.cum_viewers)||0,d.hearts=parseInt(e.hearts)||0,wt(t,d),typeof window.updateAdminViewersDisplay==`function`&&window.updateAdminViewersDisplay())}catch{}},2500);let _e=w.querySelectorAll(`.tab-btn`),ve=e=>{A.dispatchEvent(new Event(`adminTabLeave`)),_e.forEach(t=>t.classList.toggle(`active`,t.dataset.tab===e)),e===`config`?le():e===`chat`?B():e===`product`?ue():e===`orders`?fe():e===`leads`&&de()};_e.forEach(e=>{e.addEventListener(`click`,()=>ve(e.dataset.tab))}),o?B():le()}function It(){let e=document.createElement(`div`),t=``,n=null,r=`desc`;function i(){let a=W.getAll(`hosts`);if(t){let e=t.toLowerCase();a=a.filter(t=>t.name.toLowerCase().includes(e)||t.phone&&t.phone.includes(e))}let o=a.map(e=>{let t=W.getHostStats(e.id);return{...e,stats:t}});n&&o.sort((e,t)=>{let i=e.stats[n]||0,a=t.stats[n]||0;return i<a?r===`asc`?-1:1:i>a?r===`asc`?1:-1:0});let s=e=>n===e?r===`asc`?`<span style="color:#3b82f6; font-size:10px; margin-left:4px;">▲</span>`:`<span style="color:#3b82f6; font-size:10px; margin-left:4px;">▼</span>`:`<span style="color:#cbd5e1; font-size:10px; margin-left:4px;">↕</span>`,c=`
    ...
    `,setTimeout(()=>{e.querySelector(`#host-search`)?.addEventListener(`input`,e=>{t=e.target.value,i()}),e.querySelector(`#btn-add-host`)?.addEventListener(`click`,()=>{Lt()}),u()},0)}return i(),W.on(`hosts:changed`,i),e}function Lt(e=null){let t=!!e,n=t?W.getById(`hosts`,e):{},r=`
    <div class="form-grid">
  ...
  `,i=document.createElement(`div`);i.style.cssText=`display: flex; gap: var(--space-3); justify-content: flex-end; width: 100%;`;let a=document.createElement(`button`);a.className=`btn btn-secondary`,a.textContent=`취소`,a.addEventListener(`click`,q);let o=document.createElement(`button`);o.className=`btn btn-primary`,o.textContent=`저장`,o.addEventListener(`click`,()=>{let t={};n.forEach(e=>{t[e.key]=document.getElementById(`memo-${e.key}`).value.trim()}),W.update(`hosts`,e.id,{memo:t}),q(),J(`메모가 저장되었습니다.`),M.navigate(`/hosts/${e.id}`)}),i.appendChild(a),i.appendChild(o),K({title:`메모 수정`,size:`lg`,content:r,footer:i})}function Vt(){let e=document.createElement(`div`),t=``;function n(){let r=W.getAll(`brands`);if(t){let e=t.toLowerCase();r=r.filter(t=>t.name.toLowerCase().includes(e)||t.manager&&t.manager.toLowerCase().includes(e)||t.category&&t.category.toLowerCase().includes(e))}let i=r.map(e=>{let t=W.getBrandStats(e.id);return{...e,stats:t}});e.innerHTML=`
      <div class="page-header">
        <div class="page-header-left">
          <div>
  ...
  `,i=document.createElement(`div`);if(i.style.cssText=`display: flex; gap: var(--space-3); justify-content: flex-end; width: 100%;`,t){let t=document.createElement(`button`);t.className=`btn btn-danger`,t.textContent=`삭제`,t.style.marginRight=`auto`,t.addEventListener(`click`,()=>{q(),st({title:`브랜드 삭제`,message:`"${n.name}" 브랜드를 삭제하시겠습니까?`,confirmText:`삭제`,danger:!0,onConfirm:()=>{W.delete(`brands`,e),J(`브랜드가 삭제되었습니다.`)}})}),i.appendChild(t)}let a=document.createElement(`button`);a.className=`btn btn-secondary`,a.textContent=`취소`,a.addEventListener(`click`,q);let o=document.createElement(`button`);o.className=`btn btn-primary`,o.textContent=t?`수정`:`등록`,o.addEventListener(`click`,()=>{let n=document.getElementById(`brand-name`).value.trim();if(!n){Y(`브랜드명을 입력해주세요.`);return}let r={name:n,companyName:document.getElementById(`brand-company`).value.trim(),category:document.getElementById(`brand-category`).value,manager:document.getElementById(`brand-manager`).value.trim(),phone:document.getElementById(`brand-phone`).value.trim(),email:document.getElementById(`brand-email`).value.trim(),businessNo:document.getElementById(`brand-biz`).value.trim(),taxInvoice:document.getElementById(`brand-tax`).value===`true`,address:document.getElementById(`brand-address`).value.trim(),memo:document.getElementById(`brand-memo`).value.trim()};t?(W.update(`brands`,e,r),J(`브랜드 정보가 수정되었습니다.`)):(r.id=L(`brand`),r.createdAt=new Date().toISOString().split(`T`)[0],W.create(`brands`,r),J(`브랜드가 등록되었습니다.`)),q()}),i.appendChild(a),i.appendChild(o),K({title:t?`브랜드 수정`:`브랜드 등록`,size:`lg`,content:r,footer:i})}function Ut(e){let t=document.createElement(`div`),n=W.getById(`brands`,e.id);if(!n)return t.innerHTML=`<div class="page-header"><div class="page-header-left"><h1 class="page-title">브랜드를 찾을 수 없습니다</h1></div></div>
