        ...
        <tr class="product-row" data-idx="${t}">
          ...
          <td>
            <div style="display:flex; align-items:center; gap:4px;">
              ...
              <a href="${e.prodUrl?e.prodUrl.startsWith(`http`)?e.prodUrl:`https://${e.prodUrl}`:`#`}" target="_blank" class="btn btn-secondary btn-prod-url-link" style="padding: 2px 6px; font-size: 11px; white-space: nowrap; text-decoration: none; display: ${e.prodUrl?`inline-block`:`none`};">바로가기</a>
            </div>
          </td>
