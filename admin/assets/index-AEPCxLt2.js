...
`;return typeof a==`function`&&a(null,p),p}}));o((e=>{var t=xi(),n=Wi(),r=Ki(),i=qi();function a(e,r,i,a,o){let s=[].slice.call(arguments,1),c=s.length,l=typeof s[c-1]==`function`;if(!l&&!t())throw Error(`Callback required as last argument`);if(l){if(c<2)throw Error(`Too few arguments provided`);c===2?(o=i,i=r,r=a=void 0):c===3&&(r.getContext&&o===void 0?(o=a,a=void 0):(o=a,a=i,i=r,r=void 0))}else{if(c<1)throw Error(`Too few arguments provided`);return c===1?(i=r,r=a=void 0):c===2&&!r.getContext&&(a=i,i=r,r=void 0),new Promise(function(t,o){try{t(e(n.create(i,a),r,a))}catch(e){o(e)}})}try{let t=n.create(i,a);o(null,e(t,r,a))}catch(e){o(e)}}e.create=n.create,e.toCanvas=a.bind(null,r.render),e.toDataURL=a.bind(null,r.renderToDataURL),e.toString=a.bind(null,function(e,t,n){return i.render(e,n)})}))();function Ji(){U.isDemoMode&&(localStorage.setItem(`ryzin_is_demo_mode`,`false`),U.isDemoMode=!1,U.STORAGE_KEY=`livecommerce_erp_data`,U._load());let e=document.createElement(`div`);return e.className=`login-container`,e.innerHTML=`
  ...
  `;let o=()=>{i.innerHTML=``};i.querySelector(`#u-close-btn`).addEventListener(`click`,o),i.querySelector(`#u-cancel-btn`).addEventListener(`click`,o),i.querySelector(`#u-modal-form`).addEventListener(`submit`,async a=>{a.preventDefault();let s={user_code:i.querySelector(`#um-code`).value.trim(),name:i.querySelector(`#um-name`).value.trim(),email:i.querySelector(`#um-email`).value.trim(),points:parseInt(i.querySelector(`#um-points`).value)||0,coupons_count:parseInt(i.querySelector(`#um-coupons`).value)||0,membership_active:i.querySelector(`#um-mem`).checked,default_address:i.querySelector(`#um-addr`).value.trim()};try{r&&e&&e.id&&!String(e.id).startsWith(`u-fallback`)?await sa.update(e.id,s):await sa.insert(s),Z(`회원 정보 저장이 완료되었습니다.`)}catch{Z(`회원 정보 저장 완료`)}o(),await Ea(n,t)})}function Oa(){let e=document.createElement(`div`),t=`all`;function n(e){if(!e)return`-`;try{let t=new Date(e);return isNaN(t.getTime())?e:`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)} ${String(t.getHours()).padStart(2,`0`)}:${String(t.getMinutes()).padStart(2,`0`)}`}catch{return e}}function r(){let o=(U.getAll(`classApplications`)||[]).filter(e=>t===`all`?!0:e.class_date&&e.class_date.startsWith(t));e.innerHTML=`
      ...
      <div class="page-body">
        ...
        <div class="card" style="margin-bottom: var(--space-4);">
          <div style="padding: var(--space-4); display: flex; gap: var(--space-2); align-items: center;">
            ...
            ${[`all`,`1기`,`2기`,`3기`,`4기`].map(e=>`<button class="btn ${t===e?`btn-primary`:`btn-secondary`} btn-sm filter-btn" data-edition="${e}">${e===`all`?`전체 보기`:e}</button>`).join(``)}
          </div>
        </div>
    ...
    `,e.querySelectorAll(`.filter-btn`).forEach(e=>{e.addEventListener(`click`,()=>{t=e.getAttribute(`data-edition`),r()})}),e.querySelectorAll(`.application-row`).forEach(e=>{e.addEventListener(`click`,()=>{i(e.getAttribute(`data-id`))})}),e.querySelectorAll(`.btn-detail`).forEach(e=>{e.addEventListener(`click`,()=>{i(e.getAttribute(`data-id`))})}),e.querySelectorAll(`.btn-delete`).forEach(e=>{e.addEventListener(`click`,()=>{a(e.getAttribute(`data-id`))})}),e.querySelector(`#btn-refresh-class`).addEventListener(`click`,async()=>{let t=e.querySelector(`#btn-refresh-class`);t.disabled=!0,t.textContent=`불러오는 중...`;try{await U.init(),J(`신청 목록이 성공적으로 갱신되었습니다.`)}catch{Y(`데이터를 가져오는데 실패했습니다.`)}finally{t.disabled=!1,t.textContent=`새로고침`,r()}})}function i(e){let t=U.getById(`classApplications`,e);if(!t)return;let r=document.createElement(`div`);r.style.display=`flex`,r.style.flexDirection=`column`,r.style.gap=`var(--space-4)`,r.style.fontSize=`var(--text-sm)`,r.innerHTML=`
      ...
      <div style="display: grid; grid-template-columns: 100px 1fr; gap: var(--space-3); border-bottom: 1px solid var(--border); padding-bottom: var(--space-3);">
        ...
        <span><span class="badge badge-indigo">${t.class_date||``}</span></span>
      </div>
      <div style="display: grid; grid-template-columns: 100px 1fr; gap: var(--space-3); border-bottom: 1px solid var(--border); padding-bottom: var(--space-3);">
      ...
      `:``}
    `;let i=document.createElement(`div`);i.style.display=`flex`,i.style.justifyContent=`flex-end`,i.style.width=`100%`;let a=document.createElement(`button`);a.className=`btn btn-secondary`,a.textContent=`닫기`,a.addEventListener(`click`,q),i.appendChild(a),K({title:`수강 신청 상세 정보`,size:`md`,content:r,footer:i,onClose:null})}function a(e){let t=U.getById(`classApplications`,e);t&&st({title:`신청 정보 삭제`,message:`${t.name} 님의 수강신청 내역을 영구히 삭제하시겠습니까?`,danger:!0,confirmText:`삭제`,cancelText:`취소`,onConfirm:async()=>{try{U.delete(`classApplications`,e),J(`신청 정보가 삭제되었습니다.`),r()}catch{Y(`삭제 처리 중 에러가 발생했습니다.`)}}})}return r(),e}x(),j();async function ka(){let e=document.getElementById(`app`);if(e.innerHTML=`
  ...
  `,!await U.init()){e.innerHTML=`
    ...
    `;return}let t=()=>{if(e.querySelector(`.sidebar`))return;e.innerHTML=``,e.className=`app-layout`,e.appendChild(Qe());let t=document.createElement(`div`);t.className=`mobile-overlay`,t.onclick=()=>document.querySelector(`.sidebar`).classList.remove(`open`),e.appendChild(t);let n=document.createElement(`button`);n.className=`mobile-menu-btn`,n.innerHTML=`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>`,n.onclick=()=>document.querySelector(`.sidebar`).classList.toggle(`open`),e.appendChild(n);let r=document.createElement(`main`);r.className=`main-content`,r.id=`page-content`,e.appendChild(r),M.setContainer(r)};M.beforeEach(n=>{let r=!!U.getCurrentUser();if(!r&&n!==`/login`)return`/login`;if(r&&n===`/login`)return`/`;if(r&&n===`/live_stream`){let e=U.getCurrentUser();if(U.isDemoMode||e&&(e.id===`demo`||e.role===`demo`))return`/`}return n===`/login`?(e.innerHTML=``,e.className=``,M.setContainer(e)):t(),!0}),M.register(`/login`,()=>Ji()),M.register(`/`,()=>pt()),M.register(`/live_stream`,()=>Nt()),M.register(`/projects`,()=>Gt()),M.register(`/projects/new`,()=>Gt()),M.register(`/projects/:id`,e=>qt(e)),M.register(`/hosts`,()=>It()),M.register(`/hosts/:id`,e=>Rt(e)),M.register(`/brands`,()=>Vt()),M.register(`/brands/:id`,e=>Ut(e)),M.register(`/finance`,()=>rn()),M.register(`/settlement`,()=>an()),M.register(`/contracts`,()=>cn()),M.register(`/marketing`,()=>fn()),M.register(`/crm`,()=>pn()),M.register(`/shop_manage`,()=>_a()),M.register(`/class_applications`,()=>Oa()),M.register(`/settings`,()=>mn()),M.start(),document.addEventListener(`click`,e=>{let t=e.target.closest(`a[href]`);t&&t.getAttribute(`href`).startsWith(`/`)&&!t.getAttribute(`target`)&&(e.preventDefault(),M.navigate(t.getAttribute(`href`)))})}ka();