    ...
    <div style="width:100%; border-top:1.5px solid #e2e8f0; padding-top:16px; margin-top:4px;">
      ...
      <div style="margin-bottom:14px;">
        ...
        <div style="position:relative;">
          <input type="text" id="share-gateway-url" readonly style="width:100%; font-size:11px; font-family:monospace; background:#fff8f8; border:1.5px solid #fecdd3; border-radius:8px; padding:10px 64px 10px 8px; color:#e11d48; box-sizing:border-box; outline:none;" value="${`https://vybrnhyaeugfwezbygdt.supabase.co/functions/v1/share?id=${t}`}">
...
다시 원래의 실제 운영 데이터를 불러옵니다.`,confirmText:`복귀하기`,onConfirm:()=>H.toggleDemoMode(!1),onCancel:()=>{n.checked=!0}})}),e.querySelector(`#btn-sync-data`)?.addEventListener(`click`,async()=>{let t=e.querySelector(`#btn-sync-data`);t.textContent=`동기화 중...`,t.disabled=!0;try{if(await H.init()){Y(`데이터 동기화가 완료되었습니다.`);let e=document.getElementById(`page-content`);e&&(e.innerHTML=``,e.appendChild(Wt()))}else X(`동기화에 실패했습니다.`)}catch{X(`초기화 실패`)}finally{t.disabled=!1,t.textContent=`구글 시트 동기화`}}),t===`admin`){let t=JSON.parse(localStorage.getItem(`ryzin_live_data`)||`{}`),n=t.settings||{},r=e.querySelector(`#setting-popbill-linkid`),i=e.querySelector(`#setting-popbill-secret`),a=e.querySelector(`#setting-popbill-sender`);r&&(r.value=n.popbillLinkId||``),i&&(i.value=n.popbillSecretKey||``),a&&(a.value=n.popbillSenderNumber||``),e.querySelector(`#btn-save-api-settings`)?.addEventListener(`click`,()=>{t.settings||={},t.settings.popbillLinkId=r.value.trim(),t.settings.popbillSecretKey=i.value.trim(),t.settings.popbillSenderNumber=a.value.trim(),localStorage.setItem(`ryzin_live_data`,JSON.stringify(t)),Y(`API 연동 설정이 저장되었습니다.`)})}t===`admin`&&(Gt(e),e.querySelector(`#btn-create-user`)?.addEventListener(`click`,()=>{Kt()}))},0),e}function Gt(e){let t=e.querySelector(`#user-list-tbody`);if(!t)return;let n=H.getAll(`users`);if(n.length===0){t.innerHTML=`<tr><td colspan="5" class="text-center" style="padding: var(--space-8); color: var(--text-tertiary);">등록된 사용자가 없습니다.</td></tr>`;return}t.innerHTML=n.map(e=>`
  ...
  `).join(``),t.querySelectorAll(`.edit-user-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=H.getById(`users`,e.getAttribute(`data-id`));t&&Kt(t)})}),t.querySelectorAll(`.delete-user-btn`).forEach(t=>{t.addEventListener(`click`,()=>{let n=t.getAttribute(`data-id`);Le({title:`사용자 삭제`,message:`해당 사용자를 삭제하시겠습니까?`,confirmText:`삭제`,danger:!0,onConfirm:()=>{H.delete(`users`,n),Y(`사용자가 삭제되었습니다.`),Gt(e)}})})})}function Kt(e=null){let t=JSON.parse(localStorage.getItem(`ryzin_lives`)||`[]`),n=document.createElement(`div`);n.className=`form-grid`,n.innerHTML=`
    <div class="input-group">
