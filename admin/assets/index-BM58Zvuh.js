        ...
        <div class="product-inputs">
          <div style="display:flex; align-items:center; gap:8px;">
            ...
            <div style="display:flex; align-items:center; gap:4px; background:#f8fafc; border:1px solid #cbd5e1; border-radius:8px; padding:0 8px; flex-shrink:0;" title="담을 수 있는 최대 재고 수량 (비워두면 무제한)">
              ...
              <input type="number" min="0" class="modern-input" style="width:56px; padding:6px 2px; font-size:12px; font-weight:700; text-align:center; border:none; background:transparent;" value="${e.stock!==void 0&&e.stock!==null&&e.stock!==``?e.stock:``}" data-idx="${t}" data-field="stock" placeholder="무제한">
