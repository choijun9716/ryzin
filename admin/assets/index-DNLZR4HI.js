...
`;return typeof a==`function`&&a(null,p),p}}));o((e=>{var t=Ci(),n=Ki(),r=Ji(),i=Yi();function a(e,r,i,a,o){let s=[].slice.call(arguments,1),c=s.length,l=typeof s[c-1]==`function`;if(!l&&!t())throw Error(`Callback required as last argument`);if(l){if(c<2)throw Error(`Too few arguments provided`);c===2?(o=i,i=r,r=a=void 0):c===3&&(r.getContext&&o===void 0?(o=a,a=void 0):(o=a,a=i,i=r,r=void 0))}else{if(c<1)throw Error(`Too few arguments provided`);return c===1?(i=r,r=a=void 0):c===2&&!r.getContext&&(a=i,i=r,r=void 0),new Promise(function(t,o){try{t(e(n.create(i,a),r,a))}catch(e){o(e)}})}try{let t=n.create(i,a);o(null,e(t,r,a))}catch(e){o(e)}}e.create=n.create,e.toCanvas=a.bind(null,r.render),e.toDataURL=a.bind(null,r.renderToDataURL),e.toString=a.bind(null,function(e,t,n){return i.render(e,n)})}))();function Xi(){U.isDemoMode&&(localStorage.setItem(`ryzin_is_demo_mode`,`false`),U.isDemoMode=!1,U.STORAGE_KEY=`livecommerce_erp_data`,U._load());let e=document.createElement(`div`);return e.className=`login-container`,e.innerHTML=`
  ...
  `;let o=()=>{i.innerHTML=``};i.querySelector(`#u-close-btn`).addEventListener(`click`,o),i.querySelector(`#u-cancel-btn`).addEventListener(`click`,o),i.querySelector(`#u-modal-form`).addEventListener(`submit`,async a=>{a.preventDefault();let s={user_code:i.querySelector(`#um-code`).value.trim(),name:i.querySelector(`#um-name`).value.trim(),email:i.querySelector(`#um-email`).value.trim(),points:parseInt(i.querySelector(`#um-points`).value)||0,coupons_count:parseInt(i.querySelector(`#um-coupons`).value)||0,membership_active:i.querySelector(`#um-mem`).checked,default_address:i.querySelector(`#um-addr`).value.trim()};try{r&&e&&e.id&&!String(e.id).startsWith(`u-fallback`)?await la.update(e.id,s):await la.insert(s),Z(`회원 정보 저장이 완료되었습니다.`)}catch{Z(`회원 정보 저장 완료`)}o(),await Oa(n,t)})}function Aa(){let e=document.createElement(`div`),t=`list`;function n(e){if(!e)return`-`;try{let t=new Date(e);return isNaN(t.getTime())?e:`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)} ${String(t.getHours()).padStart(2,`0`)}:${String(t.getMinutes()).padStart(2,`0`)}`}catch{return e}}function r(){e.innerHTML=`
          ...
          <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 12px;">
            ...
            <div class="form-group">
              ...
              <select id="news-form-image-position" class="input" style="width: 100%;">
                <option value="center" ${e&&e.imagePosition===`center`?`selected`:``}>가운데 정렬</option>
                <option value="top" ${e&&e.imagePosition===`top`?`selected`:``}>상단 기준 (얼굴 위주)</option>
                <option value="bottom" ${e&&e.imagePosition===`bottom`?`selected`:``}>하단 기준</option>
              </select>
            </div>
          </div>
    ...
    `;let o=document.createElement(`div`);o.style.cssText=`display: flex; gap: var(--space-3); justify-content: flex-end; width: 100%; margin-top: 16px;`;let s=document.createElement(`button`);s.className=`btn btn-secondary`,s.textContent=`취소`,s.addEventListener(`click`,q);let c=document.createElement(`button`);c.className=`btn btn-primary`,c.textContent=`저장`,c.addEventListener(`click`,()=>{let a=document.getElementById(`news-form-title`).value.trim(),o=document.getElementById(`news-form-category`).value,s=document.getElementById(`news-form-publisher`).value.trim(),c=document.getElementById(`news-form-date`).value.trim(),l=document.getElementById(`news-form-image`).value.trim();document.getElementById(`news-form-image-position`).value;let u=document.getElementById(`news-form-url`).value.trim(),d=document.getElementById(`news-form-summary`).value.trim(),f=document.getElementById(`news-form-content`).value.trim();if(!a){Y(`보도자료 제목을 입력해주세요.`);return}let p=null;if(t){let t=r.findIndex(t=>t.id===e.id);t!==-1&&(r[t]={...r[t],title:a,category:o,publisher:s,date:c,image:l,url:u,summary:d,content:f},p=r[t])}else p={id:`news-${Date.now()}`,title:a,category:o,publisher:s,date:c,image:l||`assets/001.jpg`,url:u,summary:d,content:f},r.unshift(p);n(r,p,`upsert`),J(t?`보도자료가 수정되었습니다.`:`새 보도자료가 등록되었습니다.`),q(),i()}),setTimeout(()=>{let e=document.getElementById(`news-form-file-input`),t=document.getElementById(`btn-trigger-news-file`),n=document.getElementById(`news-form-image`);t&&e&&(t.addEventListener(`click`,()=>e.click()),e.addEventListener(`change`,e=>{let t=e.target.files[0];if(!t)return;let r=t.name.match(/\.([a-zA-Z0-9]+)$/),i=r?r[1].toLowerCase():`jpg`,a=`news_${Date.now()}_${Math.random().toString(36).substring(2,6)}.${i}`,o=new FileReader;o.onload=e=>{n.value=e.target.result,J(`'${t.name}' 파일이 '${a}'(으)로 안전 변환되어 등록되었습니다.`)},o.readAsDataURL(t)}))},0),o.appendChild(s),o.appendChild(c),K({title:t?`뉴스룸 보도자료 수정`:`새 보도자료 등록`,content:a,footer:o})}return i(),e}var Fa=`https://vybrnhyaeugfwezbygdt.supabase.co`,Ia=`sb_publishable_FxH6HGkUaKfcJD9by_TLFQ_0PJk80J9`,La={apikey:Ia,Authorization:`Bearer ${Ia}`,"Content-Type":`application/json`,Prefer:`resolution=merge-duplicates`};function Ra(){let e=document.createElement(`div`),t=`hero`,n=async(e,t)=>{try{let t=await fetch(`${Fa}/rest/v1/homepage_settings?key=eq.${e}&select=*`,{headers:La}).catch(()=>null);if(t&&t.ok){let e=await t.json();if(e&&e[0]&&e[0].value)return e[0].value}}catch{}try{let t=localStorage.getItem(`ryzin_hp_${e}`);if(t)return JSON.parse(t)}catch{}return t},r=async(e,t)=>{localStorage.setItem(`ryzin_hp_${e}`,JSON.stringify(t));try{await fetch(`${Fa}/rest/v1/homepage_settings`,{method:`POST`,headers:La,body:JSON.stringify({key:e,value:t,updated_at:new Date().toISOString()})}).catch(()=>null)}catch{}},i=null,a=null,o=null,s=null,c=null;async function l(){i=await n(`hero`,{col1:[`everyhabit_enzyme.jpg`,`baegayul.jpg`,`Screenshot 2026-05-01 19-46-03.png`],col2:[`1779278961975_Screenshot_2026-05-20_17-33-25.png`,`gangneung.jpg`,`miyabis.jpg`],col3:[`1783519975524_KakaoTalk_Photo_2026-07-08-23-07-21.png`,`003.jpg`,`yadah.jpg`],col4:[`001.png`,`002.jpg`]}),a=await n(`portfolio`,[{title:`만나강정`,category:`food`,image:`./assets/1783519975524_KakaoTalk_Photo_2026-07-08-23-07-21.png`,link:`#`},{title:`트루쿡`,category:`life`,image:`./assets/1782397523767_123.png`,link:`#`},{title:`쏘랩 (SOLAB)`,category:`beauty`,image:`./assets/1779278961975_Screenshot_2026-05-20_17-33-25.png`,link:`#`},{title:`강릉은정한과`,category:`food`,image:`./assets/001.jpg`,link:`https://view.shoppinglive.naver.com/replays/1836196`}]),o=await n(`packages`,[{name:`STANDARD LIGHT`,price:`990,000원`,features:`1인 단독 진행, 기본 조명/음향, 1시간 방송`},{name:`DELUXE PREMIUM`,price:`1,990,000원`,features:`2인 메인 쇼호스트, 4K 시네마틱 카메밍, 커스텀 세트 연출`}]),s=await n(`stories`,[{brand:`강릉은정한과`,quote:`방송 1회 만에 매출액 300% 상승 달성!`,author:`대표 채이준`}]),c=await n(`logos`,[{name:`네이버 쇼핑라이브`,logo:`./assets/logo.png`}])}async function u(){i||await l(),e.innerHTML=`
      <div class="page-header">
        <div class="page-header-left">
          <div>
    ...
    `,e.querySelectorAll(`[data-tab]`).forEach(e=>{e.addEventListener(`click`,e=>{t=e.target.dataset.tab,u()})}),f()}function d(){return t===`hero`?`
        <div class="card">
          <div class="card-header" style="display:flex; justify-content:space-between; align-items:center;">
          ...
          <div class="card-body">
            <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px;">
              ${[`col1`,`col2`,`col3`,`col4`].map((e,t)=>`
                <div style="background: var(--bg-secondary); padding: 16px; border-radius: var(--radius-md); border: 1px solid var(--border-light);">
                  <h4 style="font-weight:700; margin-bottom:12px; font-size:14px;">컬럼 ${t+1}</h4>
                  <div style="display:flex; flex-direction:column; gap:8px;">
                    ${(i[e]||[]).map((t,n)=>`
                      <div style="display:flex; gap:6px; align-items:center;">
                        <input type="text" class="input input-hero-img" data-col="${e}" data-idx="${n}" value="${t}" style="font-size:12px; flex:1;">
                        <button class="btn btn-xs btn-danger btn-del-hero-img" data-col="${e}" data-idx="${n}">X</button>
                      </div>
                    `).join(``)}
                    <button class="btn btn-xs btn-secondary btn-add-hero-img" data-col="${e}">+ 이미지 추가</button>
                  </div>
                </div>
              `).join(``)}
            </div>
      ...
      `:``}function f(){e.querySelector(`#btn-save-hero`)?.addEventListener(`click`,async()=>{let t=e.querySelectorAll(`.input-hero-img`),n={col1:[],col2:[],col3:[],col4:[]};t.forEach(e=>{let t=e.dataset.col;e.value.trim()&&n[t].push(e.value.trim())}),i=n,await r(`hero`,i),J(`메인 히어로 갤러리가 Supabase DB에 성공적으로 동기화 저장되었습니다.`)}),e.querySelectorAll(`.btn-del-hero-img`).forEach(e=>{e.addEventListener(`click`,async e=>{let t=e.target.dataset.col,n=parseInt(e.target.dataset.idx);i[t].splice(n,1),await r(`hero`,i),u()})}),e.querySelectorAll(`.btn-add-hero-img`).forEach(e=>{e.addEventListener(`click`,async e=>{let t=e.target.dataset.col;i[t]||(i[t]=[]),i[t].push(`assets/001.jpg`),await r(`hero`,i),u()})}),e.querySelector(`#btn-add-pf`)?.addEventListener(`click`,async()=>{let e=prompt(`포트폴리오 브랜드명/제목:`);if(!e)return;let t=prompt(`이미지 경로:`,`./assets/001.jpg`)||`./assets/001.jpg`,n=prompt(`방송/영상 URL 링크:`,`#`)||`#`;a.unshift({title:e,category:`beauty`,image:t,link:n}),await r(`portfolio`,a),J(`포트폴리오가 Supabase DB에 동기화되었습니다.`),u()}),e.querySelectorAll(`.btn-del-pf`).forEach(e=>{e.addEventListener(`click`,async e=>{let t=parseInt(e.target.dataset.idx);a.splice(t,1),await r(`portfolio`,a),J(`포트폴리오 항목이 삭제되었습니다.`),u()})}),e.querySelector(`#btn-add-pkg`)?.addEventListener(`click`,async()=>{let e=prompt(`패키지 명칭:`);if(!e)return;let t=prompt(`가격:`,`1,500,000원`)||`1,500,000원`,n=prompt(`구성 내용:`,`4K 촬영, 메인 쇼호스트`)||``;o.push({name:e,price:t,features:n}),await r(`packages`,o),J(`패키지가 Supabase DB에 동기화되었습니다.`),u()}),e.querySelectorAll(`.btn-del-pkg`).forEach(e=>{e.addEventListener(`click`,async e=>{let t=parseInt(e.target.dataset.idx);o.splice(t,1),await r(`packages`,o),u()})}),e.querySelector(`#btn-add-story`)?.addEventListener(`click`,async()=>{let e=prompt(`브랜드명:`);if(!e)return;let t=prompt(`후기/스토리 한줄 문구:`)||``;s.push({brand:e,quote:t,author:`브랜드 담당자`}),await r(`stories`,s),J(`브랜드 스토리가 Supabase DB에 동기화되었습니다.`),u()}),e.querySelectorAll(`.btn-del-story`).forEach(e=>{e.addEventListener(`click`,async e=>{let t=parseInt(e.target.dataset.idx);s.splice(t,1),await r(`stories`,s),u()})}),e.querySelector(`#btn-add-logo`)?.addEventListener(`click`,async()=>{let e=prompt(`파트너 브랜드명:`);if(!e)return;let t=prompt(`로고 이미지 경로:`,`./assets/logo.png`)||`./assets/logo.png`;c.push({name:e,logo:t}),await r(`logos`,c),J(`파트너 로고가 Supabase DB에 동기화되었습니다.`),u()}),e.querySelectorAll(`.btn-del-logo`).forEach(e=>{e.addEventListener(`click`,async e=>{let t=parseInt(e.target.dataset.idx);c.splice(t,1),await r(`logos`,c),u()})})}return u(),e}x(),j();async function za(){let e=document.getElementById(`app`);e.innerHTML=`
