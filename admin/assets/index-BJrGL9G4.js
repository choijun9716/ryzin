      ...
      <div class="section-card">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr 1fr 1fr; gap:18px;">
          <div>
            ...
            <input type="number" class="modern-input" id="cfg-viewers" value="${i.viewers}">
          </div>
          <div>
