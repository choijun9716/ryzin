...
`;return typeof a==`function`&&a(null,p),p}}));o((e=>{var t=Ci(),n=Ki(),r=Ji(),i=Yi();function a(e,r,i,a,o){let s=[].slice.call(arguments,1),c=s.length,l=typeof s[c-1]==`function`;if(!l&&!t())throw Error(`Callback required as last argument`);if(l){if(c<2)throw Error(`Too few arguments provided`);c===2?(o=i,i=r,r=a=void 0):c===3&&(r.getContext&&o===void 0?(o=a,a=void 0):(o=a,a=i,i=r,r=void 0))}else{if(c<1)throw Error(`Too few arguments provided`);return c===1?(i=r,r=a=void 0):c===2&&!r.getContext&&(a=i,i=r,r=void 0),new Promise(function(t,o){try{t(e(n.create(i,a),r,a))}catch(e){o(e)}})}try{let t=n.create(i,a);o(null,e(t,r,a))}catch(e){o(e)}}e.create=n.create,e.toCanvas=a.bind(null,r.render),e.toDataURL=a.bind(null,r.renderToDataURL),e.toString=a.bind(null,function(e,t,n){return i.render(e,n)})}))();function Xi(){U.isDemoMode&&(localStorage.setItem(`ryzin_is_demo_mode`,`false`),U.isDemoMode=!1,U.STORAGE_KEY=`livecommerce_erp_data`,U._load());let e=document.createElement(`div`);return e.className=`login-container`,e.innerHTML=`
  ...
  `;let o=()=>{i.innerHTML=``};i.querySelector(`#u-close-btn`).addEventListener(`click`,o),i.querySelector(`#u-cancel-btn`).addEventListener(`click`,o),i.querySelector(`#u-modal-form`).addEventListener(`submit`,async a=>{a.preventDefault();let s={user_code:i.querySelector(`#um-code`).value.trim(),name:i.querySelector(`#um-name`).value.trim(),email:i.querySelector(`#um-email`).value.trim(),points:parseInt(i.querySelector(`#um-points`).value)||0,coupons_count:parseInt(i.querySelector(`#um-coupons`).value)||0,membership_active:i.querySelector(`#um-mem`).checked,default_address:i.querySelector(`#um-addr`).value.trim()};try{r&&e&&e.id&&!String(e.id).startsWith(`u-fallback`)?await la.update(e.id,s):await la.insert(s),Z(`회원 정보 저장이 완료되었습니다.`)}catch{Z(`회원 정보 저장 완료`)}o(),await Oa(n,t)})}function Aa(){let e=document.createElement(`div`),t=`list`;function n(e){if(!e)return`-`;try{let t=new Date(e);return isNaN(t.getTime())?e:`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)} ${String(t.getHours()).padStart(2,`0`)}:${String(t.getMinutes()).padStart(2,`0`)}`}catch{return e}}function r(){e.innerHTML=`
    ...
    `,e.querySelector(`#btn-add-news`)?.addEventListener(`click`,()=>{a()}),e.querySelectorAll(`.btn-edit-news`).forEach(e=>{e.addEventListener(`click`,e=>{let t=e.target.dataset.id,n=r.find(e=>e.id===t);n&&a(n)})}),e.querySelectorAll(`.btn-delete-news`).forEach(e=>{e.addEventListener(`click`,e=>{let t=e.target.dataset.id;st(`정말 이 보도자료를 삭제하시겠습니까?`,()=>{r=r.filter(e=>e.id!==t),n(r),J(`보도자료가 삭제되었습니다.`),i()})})})}function a(e=null){let t=!!e,a=document.createElement(`div`);a.innerHTML=`
      <div style="padding: var(--space-4);">
    ...
    `;let o=document.createElement(`div`);o.style.cssText=`display: flex; gap: var(--space-3); justify-content: flex-end; width: 100%; margin-top: 16px;`;let s=document.createElement(`button`);s.className=`btn btn-secondary`,s.textContent=`취소`,s.addEventListener(`click`,q);let c=document.createElement(`button`);c.className=`btn btn-primary`,c.textContent=`저장`,c.addEventListener(`click`,()=>{let a=document.getElementById(`news-form-title`).value.trim(),o=document.getElementById(`news-form-category`).value,s=document.getElementById(`news-form-publisher`).value.trim(),c=document.getElementById(`news-form-date`).value.trim(),l=document.getElementById(`news-form-image`).value.trim(),u=document.getElementById(`news-form-url`).value.trim(),d=document.getElementById(`news-form-summary`).value.trim(),f=document.getElementById(`news-form-content`).value.trim();if(!a){Y(`보도자료 제목을 입력해주세요.`);return}if(t){let t=r.findIndex(t=>t.id===e.id);t!==-1&&(r[t]={...r[t],title:a,category:o,publisher:s,date:c,image:l,url:u,summary:d,content:f})}else{let e={id:`news-${Date.now()}`,title:a,category:o,publisher:s,date:c,image:l||`assets/001.jpg`,url:u,summary:d,content:f};r.unshift(e)}n(r),J(t?`보도자료가 수정되었습니다.`:`새 보도자료가 등록되었습니다.`),q(),i()}),o.appendChild(s),o.appendChild(c),K({title:t?`뉴스룸 보도자료 수정`:`새 보도자료 등록`,content:a,footer:o})}return i(),e}x(),j();async function Ma(){let e=document.getElementById(`app`);e.innerHTML=`
  ...
  `;try{let e=new Promise(e=>setTimeout(()=>e(!0),3e3));await Promise.race([U.init(),e])}catch(e){console.warn(`데이터 로딩 타임아웃/오류 발생, 로컬 데이터로 접속합니다.`,e)}let t=()=>{if(e.querySelector(`.sidebar`))return;e.innerHTML=``,e.className=`app-layout`,e.appendChild(Qe());let t=document.createElement(`div`);t.className=`mobile-overlay`,t.onclick=()=>document.querySelector(`.sidebar`).classList.remove(`open`),e.appendChild(t);let n=document.createElement(`button`);n.className=`mobile-menu-btn`,n.innerHTML=`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>`,n.onclick=()=>document.querySelector(`.sidebar`).classList.toggle(`open`),e.appendChild(n);let r=document.createElement(`main`);r.className=`main-content`,r.id=`page-content`,e.appendChild(r),M.setContainer(r)};M.beforeEach(n=>{let r=!!U.getCurrentUser();if(!r&&n!==`/login`)return`/login`;if(r&&n===`/login`)return`/`;if(r&&n===`/live_stream`){let e=U.getCurrentUser();if(U.isDemoMode||e&&(e.id===`demo`||e.role===`demo`))return`/`}return n===`/login`?(e.innerHTML=``,e.className=``,M.setContainer(e)):t(),!0}),M.register(`/login`,()=>Xi()),M.register(`/`,()=>pt()),M.register(`/live_stream`,()=>Nt()),M.register(`/projects`,()=>Gt()),M.register(`/projects/new`,()=>Gt()),M.register(`/projects/:id`,e=>qt(e)),M.register(`/hosts`,()=>It()),M.register(`/hosts/:id`,e=>Rt(e)),M.register(`/brands`,()=>Vt()),M.register(`/brands/:id`,e=>Ut(e)),M.register(`/finance`,()=>rn()),M.register(`/settlement`,()=>sn()),M.register(`/contracts`,()=>un()),M.register(`/marketing`,()=>mn()),M.register(`/crm`,()=>hn()),M.register(`/shop_manage`,()=>ya()),M.register(`/class_applications`,()=>Aa()),M.register(`/news_manage`,()=>ja()),M.register(`/settings`,()=>gn()),M.start(),document.addEventListener(`click`,e=>{let t=e.target.closest(`a[href]`);t&&t.getAttribute(`href`).startsWith(`/`)&&!t.getAttribute(`target`)&&(e.preventDefault(),M.navigate(t.getAttribute(`href`)))})}Ma();