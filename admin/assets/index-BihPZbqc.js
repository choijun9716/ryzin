...
설정을 저장한 후 라이브를 시작할 수 있습니다.`),document.getElementById(`cfg-stream`).focus(),document.getElementById(`cfg-stream`).style.borderColor=`#ef4444`,document.getElementById(`cfg-stream`).style.boxShadow=`0 0 0 3px rgba(239,68,68,0.15)`,setTimeout(()=>{document.getElementById(`cfg-stream`).style.borderColor=``,document.getElementById(`cfg-stream`).style.boxShadow=``},3e3);return}if(u.isLive=!u.isLive,u.isLive){u.liveStartTime=new Date().toISOString();let e=document.getElementById(`cfg-liveStartTime`);e&&(e.value=new Date(new Date().getTime()-new Date().getTimezoneOffset()*6e4).toISOString().slice(0,16))}e.target.textContent=u.isLive?`라이브 종료`:`라이브 시작`,e.target.className=`action-btn ${u.isLive?`btn-danger-solid`:`btn-success-solid`}`,e.target.style.cssText=`flex:1; justify-content:center; padding:14px; font-size:15px;`,v(),jt(t,u,d,f,!0)});let h=async(e,n,r)=>{if(e){document.getElementById(n).style.opacity=`0.5`;try{let i=r===`logoUrl`,a=await c(await l(e,i?256:1080,i?256:1920,i?.88:.82));u[r]=a;let o=document.getElementById(n);if(o.src=a,o.style.display=`block`,r===`shareImageUrl`){let e=document.getElementById(`og-preview-img`),t=document.getElementById(`og-preview-img-placeholder`),n=document.getElementById(`og-img-placeholder`);e&&(e.src=a,e.style.display=`block`),t&&(t.style.display=`none`),n&&(n.style.display=`none`)}else if(r===`standbyImageUrl`){u.useStandbyImage=!0;let e=document.getElementById(`cfg-useStandbyImage`);e&&(e.checked=!0);let t=document.getElementById(`cfg-useStandbyImage-label`);t&&(t.textContent=`ON`,t.style.color=`#2563eb`);let n=document.getElementById(`standby-image-placeholder`);n&&(n.style.display=`none`);let r=document.getElementById(`btn-clear-standby-image`);r&&(r.style.display=`block`)}v(),jt(t,u,d,f,!0)}catch(e){console.error(`이미지 업로드 오류:`,e),alert(`이미지 업로드 실패: `+e.message)}finally{document.getElementById(n).style.opacity=`1`}}},g=async e=>{if(!e)return;let t=document.getElementById(`like-preview`),n=document.getElementById(`like-preview-placeholder`),r=document.getElementById(`btn-clear-like-icon`);t.style.opacity=`0.5`;try{let i=``;i=e.size<1.2*1024*1024?await new Promise(t=>{let n=new FileReader;n.onload=e=>t(e.target.result.split(`,`)[1]),n.readAsDataURL(e)}):await l(e,512,512,.9);let a=await c(i);u.likeImageUrl=a,t.src=a,t.style.display=`block`,n&&(n.style.display=`none`),r&&(r.style.display=`block`),v()}catch(e){console.error(`응원 이미지 업로드 오류:`,e),alert(`응원 이미지 업로드 실패: `+e.message)}finally{t.style.opacity=`1`}};document.getElementById(`cfg-logoFile`).addEventListener(`change`,e=>h(e.target.files[0],`logo-preview`,`logoUrl`)),document.getElementById(`cfg-thumbnailFile`).addEventListener(`change`,e=>h(e.target.files[0],`thumbnail-preview`,`thumbnailUrl`)),document.getElementById(`cfg-shareImageFile`).addEventListener(`change`,e=>h(e.target.files[0],`share-image-preview`,`shareImageUrl`)),document.getElementById(`cfg-likeFile`).addEventListener(`change`,e=>g(e.target.files[0])),document.getElementById(`cfg-standbyImageFile`).addEventListener(`change`,async e=>{let t=e.target.files[0];if(!t)return;await h(t,`standby-image-preview`,`standbyImageUrl`),u.useStandbyImage=!0,v();let n=document.getElementById(`cfg-useStandbyImage`);n&&(n.checked=!0);let r=document.getElementById(`cfg-useStandbyImage-label`);r&&(r.textContent=`ON`,r.style.color=`#2563eb`);let i=document.getElementById(`standby-image-placeholder`);i&&(i.style.display=`none`);let a=document.getElementById(`btn-clear-standby-image`);a&&(a.style.display=`block`)});let _=document.getElementById(`btn-clear-standby-image`);_&&_.addEventListener(`click`,()=>{u.standbyImageUrl=``,u.useStandbyImage=!1,v(),le()});let x=document.getElementById(`cfg-useStandbyImage`);x&&x.addEventListener(`change`,e=>{u.useStandbyImage=e.target.checked,v();let t=document.getElementById(`cfg-useStandbyImage-label`);t&&(t.textContent=u.useStandbyImage?`ON`:`OFF`,t.style.color=u.useStandbyImage?`#2563eb`:`#94a3b8`);let n=document.getElementById(`live-preview-iframe`);n&&(n.src=M+`?t=`+Date.now())}),document.getElementById(`btn-clear-like-icon`).addEventListener(`click`,()=>{u.likeImageUrl=``;let e=document.getElementById(`like-preview`),t=document.getElementById(`like-preview-placeholder`),n=document.getElementById(`btn-clear-like-icon`);e&&(e.src=``,e.style.display=`none`),t&&(t.style.display=`block`),n&&(n.style.display=`none`),v()}),X&&X.from(`live_control`).select(`*`).eq(`live_id`,t).maybeSingle().then(({data:e,error:t})=>{if(t)throw t;if(e){let t=parseInt(e.cum_viewers)||0,n=parseInt(e.viewers)||0,r=parseInt(e.hearts)||0,i=document.getElementById(`cfg-cumViewers`);i&&(i.value=t);let a=document.getElementById(`cfg-viewers`);a&&!a.matches(`:focus`)&&(a.value=n);let o=document.getElementById(`cfg-hearts`);o&&!o.matches(`:focus`)&&(o.value=r),d.cumViewers=t,d.viewers=n,d.hearts=r,y()}}).catch(e=>console.warn(`Failed to fetch stats from Supabase`,e))},B=()=>{A.innerHTML=`
    ...
    `;let e=document.getElementById(`cfg-scheme`);e&&(e.value=u.scheme||``);let n=document.getElementById(`btn-save-scheme`);n&&n.addEventListener(`click`,async()=>{n.disabled=!0,n.textContent=`저장 중...`;try{u.scheme=e.value,v(),X&&await X.from(`live_control`).update({scheme:u.scheme,updated_at:new Date().toISOString()}).eq(`live_id`,t),alert(`스킴 정보가 정상적으로 저장되었습니다.`)}catch(e){console.error(`스킴 저장 실패:`,e),alert(`스킴 저장 중 오류가 발생했습니다.`)}finally{n.disabled=!1,n.textContent=`스킴 저장`}})},ue=()=>{A.innerHTML=`
      <!-- 서브 탭 네비게이션 -->
...
`).map(e=>e.trim()).filter(e=>e.includes(`|`)),_.length===0){alert(`닉네임|내용 형식으로 1줄 이상 입력해주세요.`),h=!1;return}g>=_.length&&(g=0),j();let e=parseInt(k.value)||10;m&&clearInterval(m),m=setInterval(async()=>{if(g>=_.length){clearInterval(m),m=null,h=!1,j();return}let[e,...n]=_[g++].split(`|`),r=n.join(`|`).trim();if(!e||!r)return;let i=Date.now(),a=document.createElement(`div`);a.style.cssText=`margin-bottom:8px; padding:6px 0; border-bottom:1px solid #f1f5f9;`,a.innerHTML=`<span style="font-weight:700; color:#64748b;">${e.trim()}:</span> ${r}`,s.innerHTML.includes(`실시간 채팅`)&&(s.innerHTML=``),s.appendChild(a),s.scrollTop=s.scrollHeight;try{if(!X)return;await X.from(`live_chats`).insert([{live_id:t,created_at:i,nickname:e.trim(),content:r}])}catch(e){console.warn(`Bot chat failed`,e)}},e*1e3)}else m&&clearInterval(m),m=null,j()});let M=document.getElementById(`auto-reply-active`),N=document.getElementById(`btn-add-ar`),P=document.getElementById(`ar-title`),ee=document.getElementById(`ar-keywords`),te=document.getElementById(`ar-answer`),F=document.getElementById(`ar-list-container`),I=()=>{if(F){if(!p.autoReplyRules||p.autoReplyRules.length===0){F.innerHTML=`<div style="text-align:center; padding:20px; color:#94a3b8; font-size:13px; font-weight:500;">등록된 자동응답 규칙이 없습니다.</div>`;return}F.innerHTML=p.autoReplyRules.map((e,t)=>`
    ...
    `,X&&X.from(`live_control`).select(`products`).eq(`live_id`,t).maybeSingle().then(({data:t,error:n})=>{if(n)throw n;if(t&&t.products)try{let n=typeof t.products==`string`?JSON.parse(t.products):t.products;if(Array.isArray(n)||(n=[]),Array.isArray(n)){!f||f.length===0?(f.length=0,f.push(...n)):f.forEach(e=>{let t=n.find(t=>t.id===e.id||t.name===e.name);t&&(t.price!==void 0&&(e.price=t.price),t.normalPrice!==void 0&&(e.normalPrice=t.normalPrice),t.discountRate!==void 0&&(e.discountRate=t.discountRate),e.clicks=parseInt(t.clicks)||0,!e.image&&t.image&&(e.image=t.image))}),b();let t=document.getElementById(`product-list-container`);t&&(t.innerHTML=de(),e())}}catch{}}).catch(e=>console.warn(`Failed to load product clicks from Supabase`,e));let e=()=>{let n=document.getElementById(`product-list-container`);n.querySelectorAll(`.price-input`).forEach(e=>{e.addEventListener(`input`,e=>{let t=e.target.value.replace(/[^0-9]/g,``);e.target.value=t?Number(t).toLocaleString():``}),e.addEventListener(`blur`,e=>{let t=parseInt(e.target.dataset.idx),r=e.target.dataset.field;if(r===`price`||r===`normalPrice`){let i=e.target.value.replace(/[^0-9]/g,``);f[t][r]=i;let a=Number((f[t].normalPrice||``).toString().replace(/[^0-9]/g,``)),o=Number((f[t].price||``).toString().replace(/[^0-9]/g,``));if(a>0&&a>=o){f[t].discountRate=Math.floor((a-o)/a*100);let e=n.querySelector(`input[data-idx="${t}"][data-field="discountRate"]`);e&&(e.value=f[t].discountRate)}else{f[t].discountRate=0;let e=n.querySelector(`input[data-idx="${t}"][data-field="discountRate"]`);e&&(e.value=0)}b()}})}),n.querySelectorAll(`input[data-field]`).forEach(t=>{t.addEventListener(`change`,t=>{let r=parseInt(t.target.dataset.idx),i=t.target.dataset.field;if(t.target.type===`checkbox`){if(f[r][i]=t.target.checked,i===`isLeadForm`){t.target.checked?f[r].url=`__LEAD_FORM__`:f[r].url===`__LEAD_FORM__`&&(f[r].url=``),n.innerHTML=de(),e();return}}else i===`price`||i===`normalPrice`?f[r][i]=t.target.value.replace(/[^0-9]/g,``):f[r][i]=t.target.value;if(i===`price`||i===`normalPrice`){let e=Number((f[r].normalPrice||``).toString().replace(/[^0-9]/g,``)),t=Number((f[r].price||``).toString().replace(/[^0-9]/g,``));if(e>0&&e>=t){f[r].discountRate=Math.floor((e-t)/e*100);let i=n.querySelector(`input[data-idx="${r}"][data-field="discountRate"]`);i&&(i.value=f[r].discountRate)}else{f[r].discountRate=0;let e=n.querySelector(`input[data-idx="${r}"][data-field="discountRate"]`);e&&(e.value=0)}}b()})}),n.querySelectorAll(`.prod-img-upload`).forEach(t=>{t.addEventListener(`change`,async t=>{let r=t.target.files[0];if(!r)return;let i=parseInt(t.target.dataset.idx),a=document.getElementById(`img-prev-${i}`);a&&(a.style.opacity=`0.5`);try{let t=await c(await new Promise((e,t)=>{let n=new FileReader;n.onload=()=>e(n.result.split(`,`)[1]),n.onerror=t,n.readAsDataURL(r)}));if(!t)throw Error(`서버로부터 다운로드 URL을 받지 못했습니다.`);f[i].image=t,a&&(a.src=t),b(),n.innerHTML=de(),e(),alert(`🎉 상품 이미지 변경 성공!`)}catch(e){console.error(e),alert(`❌ 상품 이미지 업로드 에러:
`+e.message)}finally{a&&(a.style.opacity=`1`)}})}),n.querySelectorAll(`.btn-deal-start`).forEach(r=>{r.addEventListener(`click`,r=>{let i=parseInt(r.target.dataset.idx),a=parseInt(document.getElementById(`deal-min-${i}`).value);a>0&&(f[i].dealText=document.getElementById(`deal-text-${i}`).value||`깜짝딜 종료까지`,f[i].dealEndTime=Date.now()+a*60*1e3,b(),n.innerHTML=de(),e(),jt(t,u,d,f,!0),setTimeout(()=>alert(`${a}분 깜짝딜이 시작되었습니다!`),10))})}),n.querySelectorAll(`.btn-deal-cancel`).forEach(r=>{r.addEventListener(`click`,r=>{let i=parseInt(r.target.dataset.idx);f[i].dealEndTime=0,b(),n.innerHTML=de(),e(),jt(t,u,d,f,!0)})}),n.querySelectorAll(`.btn-del-product`).forEach(t=>{t.addEventListener(`click`,t=>{let r=parseInt(t.target.dataset.idx),i=f[r]?.name||`이 상품`;confirm(`정말 "${i}" 상품을 삭제하시겠습니까?`)&&(f.splice(r,1),b(),n.innerHTML=de(),e())})}),n.querySelectorAll(`.btn-move-up`).forEach(t=>{t.addEventListener(`click`,t=>{let r=parseInt(t.target.dataset.idx);if(r>0){let t=f[r-1];f[r-1]=f[r],f[r]=t,b(),n.innerHTML=de(),e()}})}),n.querySelectorAll(`.btn-move-down`).forEach(t=>{t.addEventListener(`click`,t=>{let r=parseInt(t.target.dataset.idx);if(r<f.length-1){let t=f[r+1];f[r+1]=f[r],f[r]=t,b(),n.innerHTML=de(),e()}})})};e(),document.getElementById(`btn-add-product`).addEventListener(`click`,()=>{f.push({id:Date.now(),name:`새 상품`,price:``,normalPrice:``,discountRate:0,image:`https://via.placeholder.com/72`,url:`#`}),b(),document.getElementById(`product-list-container`).innerHTML=de(),e()}),document.getElementById(`btn-save-products`).addEventListener(`click`,()=>{jt(t,u,d,f,!0),alert(`상품 목록이 적용되었습니다!`)})},pe=()=>{A.innerHTML=`
      <div class="section-card">
        <div style="display:flex; justify-content:space-between; align-items:center; padding-bottom:16px; border-bottom:1.5px solid #f1f5f9; margin-bottom:20px;">
  ...
  `,r=document.createElement(`div`);r.style.cssText=`display: flex; gap: var(--space-3); justify-content: flex-end; width: 100%;`;let i=document.createElement(`button`);i.className=`btn btn-secondary`,i.textContent=`취소`,i.addEventListener(`click`,q);let a=document.createElement(`button`);a.className=`btn btn-primary`,a.textContent=`등록`,a.addEventListener(`click`,()=>{let n=document.getElementById(`proj-brandName`).value.trim(),r=document.getElementById(`proj-date`).value;if(!n){Y(`방송 제목(브랜드)을 입력해주세요.`);return}if(!r){Y(`방송일을 선택해주세요.`);return}let i=t.find(e=>e.name===n),a=i?i.id:`b_`+n,o={id:L(`live`),brandId:a,brandName:n,adName:``,category:document.getElementById(`proj-category`).value,broadcastMonth:r.substring(0,7),broadcastDate:r,broadcastTime:document.getElementById(`proj-time`).value,platform:document.getElementById(`proj-platform`).value,liveUrl:``,pd:document.getElementById(`proj-pd`).value.trim(),designer:document.getElementById(`proj-designer`).value.trim(),cuesheetLink:``,note:document.getElementById(`proj-note`).value.trim(),broadcastStatus:`new`,settleStatus:`wait`,createdAt:new Date().toISOString().split(`T`)[0]};U.create(`projects`,o),q(),J(`프로젝트가 등록되었습니다.`),e&&e()}),r.appendChild(i),r.appendChild(a),K({title:`신규 프로젝트 등록`,size:`lg`,content:n,footer:r})}function qt(e){let t=document.createElement(`div`),n=U.getCurrentRole(),r=n&&n.startsWith(`brand:`);r&&n.split(`:`)[1];let i=r?`scheme`:`info`;function a(){let n=U.getById(`projects`,e.id);if(!n){t.innerHTML=`<div class="page-header"><div class="page-header-left"><h1 class="page-title">프로젝트를 찾을 수 없습니다</h1></div></div>
    ...
    `;let l=t.querySelector(`#tab-content`);switch(i){case`info`:l.appendChild(Xt(n,o));break;case`scheme`:l.appendChild(Jt(n));break;case`hosts`:l.appendChild(Qt(n));break;case`design`:l.appendChild(en(n));break;case`result`:l.appendChild(rn(n));break;case`finance`:l.appendChild(an(n));break}setTimeout(()=>{t.querySelector(`#breadcrumb-list`)?.addEventListener(`click`,()=>M.navigate(`/projects`)),t.querySelectorAll(`.tab`).forEach(e=>{e.addEventListener(`click`,()=>{i=e.getAttribute(`data-tab`),a()})}),t.querySelector(`#btn-delete-project`)?.addEventListener(`click`,()=>{st({title:`프로젝트 삭제`,message:`"${n.adName}" 프로젝트를 삭제하시겠습니까? 관련된 체크리스트, 쇼호스트 매칭, 성과, 정산 데이터도 모두 삭제됩니다.`,confirmText:`삭제`,danger:!0,onConfirm:()=>{U.query(`tasks`,e=>e.liveId===n.id).forEach(e=>U.delete(`tasks`,e.id)),U.query(`liveHosts`,e=>e.liveId===n.id).forEach(e=>U.delete(`liveHosts`,e.id)),U.query(`designs`,e=>e.liveId===n.id).forEach(e=>U.delete(`designs`,e.id)),U.delete(`results`,n.id),U.delete(`finances`,n.id),U.delete(`projects`,n.id),J(`프로젝트가 삭제되었습니다.`),M.navigate(`/projects`)}})})},0)}return a(),t}function Jt(e,t=!1){let n=document.createElement(`div`),r=e.scheme||{liveInfo:{mainProduct:``,brandIntro:``,sellingPoints:``,highlight:``,delivery:``},products:[],events:[],productionDriveUrl:``};r.liveInfo||={mainProduct:``,brandIntro:``,sellingPoints:``,highlight:``,delivery:``},r.products||=[],r.events||=[],r.productionDriveUrl===void 0&&(r.productionDriveUrl=``);function i(){return r.products.length===0?`<tr><td colspan="12" class="text-center" style="padding:var(--space-4); color:var(--text-tertiary);" id="no-products-row">등록된 상품이 없습니다.</td></tr>`:r.products.map((e,t)=>{let n=parseFloat(e.price)||0,r=parseFloat(e.livePrice)||0,i=parseInt(e.targetQty,10)||0,a=parseFloat(e.feeRate)||0,o=n>0?Math.round((n-r)/n*100)+`%`:`0%`,s=r*i,c=Math.round(a/100*s),l=s-c;return`
        <tr class="product-row" data-idx="${t}">
          ...
          <td class="prod-discountRate text-center" style="font-size: 13px; font-weight: bold; color: var(--status-error);">${o}</td>
          ...
          <td class="prod-targetSales text-right" style="font-size: 13px; font-weight: 600; color: var(--text-primary);">${s.toLocaleString()}</td>
          <td><input type="number" class="input prod-feeRate" style="width: 70px; padding: 6px 8px; font-size: 13px;" value="${e.feeRate||``}" placeholder="%"></td>
          <td class="prod-feeTotal text-right" style="font-size: 13px; color: var(--text-secondary);">${c.toLocaleString()}</td>
          ...
          <div class="card-body" style="padding: 20px;">
            <div style="display:flex; flex-direction:column; gap:8px;">
              ...
              <div style="display:flex; gap:12px; align-items:center;">
                ...
                <a href="${r.productionDriveUrl}" target="_blank" class="btn btn-secondary" style="white-space:nowrap; padding:10px 18px; text-decoration:none; display:inline-flex; align-items:center; justify-content:center; gap:6px;">
    ...
    `,t||n.querySelector(`#btn-copy-scheme-url`)?.addEventListener(`click`,()=>{let t=`${window.location.origin}${window.location.pathname}#/shared_scheme/${e.id}`;navigator.clipboard.writeText(t).then(()=>J(`공유 URL이 클립보드에 복사되었습니다.`)).catch(()=>Y(`URL 복사에 실패했습니다.`))}),n.querySelector(`#btn-add-prod-row`).addEventListener(`click`,()=>{s(),r.products.push({prodName:``,prodUrl:``,stock:``,price:``,livePrice:``,targetQty:``,feeRate:``}),o()}),n.querySelectorAll(`.btn-delete-prod-row`).forEach(e=>{e.addEventListener(`click`,()=>{s();let t=parseInt(e.getAttribute(`data-idx`),10);r.products.splice(t,1),o()})});let c=e=>{let t=e.replace(/[^0-9]/g,``);return t?parseInt(t,10).toLocaleString():``},l=e=>parseFloat(e.replace(/,/g,``))||0,u=e=>{let t=l(e.querySelector(`.prod-price`).value),n=l(e.querySelector(`.prod-livePrice`).value),r=parseInt(e.querySelector(`.prod-targetQty`).value,10)||0,i=parseFloat(e.querySelector(`.prod-feeRate`).value)||0,a=t>0?Math.round((t-n)/t*100)+`%`:`0%`;e.querySelector(`.prod-discountRate`).textContent=a;let o=n*r;e.querySelector(`.prod-targetSales`).textContent=o.toLocaleString();let s=Math.round(i/100*o);e.querySelector(`.prod-feeTotal`).textContent=s.toLocaleString();let c=o-s;e.querySelector(`.prod-expectedMargin`).textContent=c.toLocaleString()};n.querySelectorAll(`.product-row`).forEach(e=>{let t=e.querySelector(`.prod-price`),n=e.querySelector(`.prod-livePrice`),r=t=>{t.addEventListener(`input`,t=>{let n=t.target.selectionStart,r=t.target.value.length,i=c(t.target.value);t.target.value=i;let a=i.length;t.target.setSelectionRange(n+(a-r),n+(a-r)),u(e)})};t&&r(t),n&&r(n),e.querySelectorAll(`input`).forEach(r=>{r!==t&&r!==n&&r.addEventListener(`input`,()=>{u(e)})})}),n.querySelector(`#btn-add-evt-row`).addEventListener(`click`,()=>{s(),r.events.push({type:``,condition:``,benefit:``,price:``,count:``,budget:``}),o()}),n.querySelectorAll(`.btn-delete-evt-row`).forEach(e=>{e.addEventListener(`click`,()=>{s();let t=parseInt(e.getAttribute(`data-idx`),10);r.events.splice(t,1),o()})}),n.querySelector(`#btn-save-project-scheme`).addEventListener(`click`,async()=>{s();let t=n.querySelector(`#btn-save-project-scheme`);t.disabled=!0,t.textContent=`저장 중...`;try{U.update(`projects`,e.id,{scheme:r}),J(`스킴 정보가 정상적으로 저장되었습니다.`)}catch(e){console.error(`스킴 저장 실패:`,e),Y(`스킴 저장 중 오류가 발생했습니다.`)}finally{t.disabled=!1,t.textContent=`스킴 정보 저장`}})}function s(){r.liveInfo.mainProduct=n.querySelector(`#sch-mainProduct`).value,r.liveInfo.brandIntro=n.querySelector(`#sch-brandIntro`).value,r.liveInfo.sellingPoints=n.querySelector(`#sch-sellingPoints`).value,r.liveInfo.highlight=n.querySelector(`#sch-highlight`).value,r.liveInfo.delivery=n.querySelector(`#sch-delivery`).value;let e=n.querySelectorAll(`.product-row`);r.products=Array.from(e).map(e=>{let t=e.querySelector(`.prod-price`).value.replace(/,/g,``),n=e.querySelector(`.prod-livePrice`).value.replace(/,/g,``);return{prodName:e.querySelector(`.prod-prodName`).value,prodUrl:e.querySelector(`.prod-prodUrl`).value,stock:e.querySelector(`.prod-stock`).value?parseInt(e.querySelector(`.prod-stock`).value,10):``,price:t?parseFloat(t):``,livePrice:n?parseFloat(n):``,targetQty:e.querySelector(`.prod-targetQty`).value?parseInt(e.querySelector(`.prod-targetQty`).value,10):``,feeRate:e.querySelector(`.prod-feeRate`).value?parseFloat(e.querySelector(`.prod-feeRate`).value):``}});let t=n.querySelectorAll(`.event-row`);r.events=Array.from(t).map(e=>({type:e.querySelector(`.evt-type`).value,condition:e.querySelector(`.evt-cond`).value,benefit:e.querySelector(`.evt-benefit`).value,price:e.querySelector(`.evt-price`).value?parseFloat(e.querySelector(`.evt-price`).value):``,count:e.querySelector(`.evt-count`).value?parseInt(e.querySelector(`.evt-count`).value,10):``,budget:e.querySelector(`.evt-budget`).value?parseFloat(e.querySelector(`.evt-budget`).value):``})),r.productionDriveUrl=n.querySelector(`#sch-productionDriveUrl`).value.trim()}return o(),n}function Yt(e){let t=document.createElement(`div`);t.style.padding=`var(--space-8)`,t.style.maxWidth=`1200px`,t.style.margin=`0 auto`;function n(){let n=U.getById(`projects`,e.id);if(!n){t.innerHTML=`
      ...
      <div class="page-header" style="margin-bottom: var(--space-6);">
        <div class="page-header-left">
          <div>
            <h1 class="page-title" style="font-size: 24px;">${`[${n.brandName||(r?r.name:``)}] 라이브 스킴 _ ${n.broadcastDate||``}`}</h1>
...
`;return typeof a==`function`&&a(null,p),p}}));o((e=>{var t=Ti(),n=Ji(),r=Xi(),i=Zi();function a(e,r,i,a,o){let s=[].slice.call(arguments,1),c=s.length,l=typeof s[c-1]==`function`;if(!l&&!t())throw Error(`Callback required as last argument`);if(l){if(c<2)throw Error(`Too few arguments provided`);c===2?(o=i,i=r,r=a=void 0):c===3&&(r.getContext&&o===void 0?(o=a,a=void 0):(o=a,a=i,i=r,r=void 0))}else{if(c<1)throw Error(`Too few arguments provided`);return c===1?(i=r,r=a=void 0):c===2&&!r.getContext&&(a=i,i=r,r=void 0),new Promise(function(t,o){try{t(e(n.create(i,a),r,a))}catch(e){o(e)}})}try{let t=n.create(i,a);o(null,e(t,r,a))}catch(e){o(e)}}e.create=n.create,e.toCanvas=a.bind(null,r.render),e.toDataURL=a.bind(null,r.renderToDataURL),e.toString=a.bind(null,function(e,t,n){return i.render(e,n)})}))();function Qi(){U.isDemoMode&&(localStorage.setItem(`ryzin_is_demo_mode`,`false`),U.isDemoMode=!1,U.STORAGE_KEY=`livecommerce_erp_data`,U._load());let e=document.createElement(`div`);return e.className=`login-container`,e.innerHTML=`
  ...
  `}var va=`products`,ya=[],ba=[];function xa(){let e=document.createElement(`div`);e.style.cssText=`min-height:100vh; background:#f8fafc; padding:24px; color:#0f172a; font-family:"Pretendard",sans-serif;`,pa(e);let t=document.createElement(`div`);return t.style.cssText=`max-width:1100px; margin:0 auto;`,t.innerHTML=`
    ...
    <div style="display:flex; gap:8px; margin-bottom:20px; border-bottom:1px solid #e2e8f0; padding-bottom:10px; overflow-x:auto;">
      ${[{key:`products`,label:`상품 관리`},{key:`sections`,label:`기획전 관리`},{key:`banners`,label:`탑배너 관리`},{key:`menus`,label:`퀵메뉴 관리`},{key:`magazines`,label:`매거진 관리`},{key:`users`,label:`유저 관리`}].map(e=>`<button class="sm-tab-btn${e.key===va?` active`:``}" data-tab="${e.key}">${e.label}</button>`).join(``)}
    </div>
  ...
  `,t.querySelectorAll(`.sm-tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{va=e.dataset.tab,t.querySelectorAll(`.sm-tab-btn`).forEach(e=>{e.classList.toggle(`active`,e.dataset.tab===va)}),Sa(t)})}),t.querySelector(`#btn-refresh`).addEventListener(`click`,()=>{Z(`데이터를 새로고침합니다.`),Sa(t)}),e.appendChild(t),setTimeout(async()=>{try{ya=await sa.getAll()}catch{ya=[]}await Sa(t)},0),e}async function Sa(e){let t=e.querySelector(`#sm-loading`),n=e.querySelector(`#sm-panel`);t.style.display=`block`,n.innerHTML=``;try{ba=await la.getAll(),va===`products`?await Ca(n,e):va===`sections`?await Ea(n,e):va===`banners`?await Da(n):va===`menus`?await Oa(n):va===`magazines`?await ka(n):va===`users`&&await Aa(n,e)}catch(e){n.innerHTML=`
    ...
    `}t.style.display=`none`}async function Ca(e,t){e.innerHTML=`
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px; flex-wrap:wrap; gap:12px;">
      <div>
        <h2 style="font-size:16px; font-weight:800; color:#0f172a; margin:0 0 4px 0;">전체 상품 리스트 (${ba.length}개 등록)</h2>
  ...
  `;let n=e.querySelector(`#prod-table-body`),r=e.querySelector(`#prod-search-input`);function i(){let e=r.value.trim().toLowerCase(),i=ba.filter(t=>{let n=(t.product_code||``).toLowerCase(),r=(t.product_title||t.brand_title||``).toLowerCase(),i=(t.brand_name||``).toLowerCase();return!e||n.includes(e)||r.includes(e)||i.includes(e)});if(!i.length){n.innerHTML=`<tr><td colspan="8" style="text-align:center; padding:30px; color:#94a3b8;">검색된 상품이 없습니다.</td></tr>`;return}n.innerHTML=i.map(e=>{let t=e.product_code||fa(),n=e.badge_color||`#ef4444`,r=e.best_rank&&e.best_rank>0?`RANK #${e.best_rank}`:`-`;return`
      ...
      `}).join(``),n.querySelectorAll(`.btn-edit-prod`).forEach(e=>{e.addEventListener(`click`,()=>{let n=ba.find(t=>t.id===e.dataset.id);n&&wa(n,t)})}),n.querySelectorAll(`.btn-del-prod`).forEach(e=>{e.addEventListener(`click`,async()=>{confirm(`이 상품을 삭제하시겠습니까?`)&&(await la.delete(e.dataset.id),Z(`삭제되었습니다.`),await Sa(t))})})}r.addEventListener(`input`,i),i(),e.querySelector(`#btn-open-add-modal`).addEventListener(`click`,()=>{wa(null,t)})}function wa(e,t){let n=!!e,r=e&&e.product_code||fa(),i=t.querySelector(`#sm-modal-container`),a=e&&e.badge_color||`#ef4444`,o=e&&e.best_rank||0;i.innerHTML=`
        ...
        <form id="modal-prod-form" style="display:grid; grid-template-columns:1fr 1fr; gap:12px;">
          ...
          <div>
            ...
            <select class="sm-input" id="m-psection" style="font-weight:700; cursor:pointer; height:37px;">
              ...
              ${ya.map(t=>`<option value="${t.id}" ${e&&e.section_id===t.id?`selected`:``}>${Q(t.title)}</option>`).join(``)}
            </select>
          </div>
  ...
  `;let r=()=>{n.innerHTML=``};n.querySelector(`#search-modal-close`).addEventListener(`click`,r);let i=n.querySelector(`#modal-search-keyword`),a=n.querySelector(`#search-result-list`);function o(){let e=i.value.trim().toLowerCase(),n=ba.filter(t=>{let n=(t.product_code||``).toLowerCase(),r=(t.product_title||t.brand_title||``).toLowerCase(),i=(t.brand_name||``).toLowerCase();return!e||n.includes(e)||r.includes(e)||i.includes(e)});if(!n.length){a.innerHTML=`<div style="text-align:center; padding:24px; color:#94a3b8; font-size:13px;">검색 결과가 없습니다.</div>`;return}a.innerHTML=n.map(e=>`
    ...
    `).join(``),a.querySelectorAll(`.search-item-card`).forEach(e=>{e.addEventListener(`click`,()=>{let n=ba.find(t=>t.id===e.dataset.id);n&&(t(n),r())})})}i.addEventListener(`input`,o),o()}async function Ea(e,t){ya=await sa.getAll();let n=ba,r={};n.forEach(e=>{r[e.section_id]||(r[e.section_id]=[]),r[e.section_id].push(e)}),e.innerHTML=`
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px;">
      <h2 style="font-size:15px; font-weight:800; color:#0f172a; margin:0;">기획전 관리 (${ya.length}개 섹션)</h2>
      <button id="add-sec" class="sm-action-btn sm-btn-primary">+ 새 기획전 섹션 추가</button>
    </div>
    <div id="section-list"></div>
  `,e.querySelector(`#add-sec`).addEventListener(`click`,async()=>{await sa.insert({sort_order:99,title:`새 기획전 섹션`,subtitle:`단독 특가로 만나보세요`,show_timer:!1}),Z(`새 기획전 섹션이 생성되었습니다.`),await Ea(e,t)});let i=e.querySelector(`#section-list`);ya.forEach(n=>{let a=r[n.id]||[],o=document.createElement(`div`);o.className=`sm-card`,o.innerHTML=`
    ...
    `;let s=o.querySelector(`.sec-b-uploader`),c=o.querySelector(`.sec-b-url`);ga(s,c,e=>{o.querySelector(`.sec-b-thumb`).src=e}),o.querySelector(`.sec-save`).addEventListener(`click`,async()=>{await sa.update(n.id,{title:o.querySelector(`.sec-title`).value.trim(),subtitle:o.querySelector(`.sec-subtitle`).value.trim(),banner_img_url:c.value.trim()}),Z(`기획전 정보 저장 완료`)}),o.querySelector(`.sec-del`).addEventListener(`click`,async()=>{confirm(`이 기획전 섹션을 삭제합니까?`)&&(await sa.delete(n.id),Z(`삭제되었습니다.`),await Ea(e,t))}),o.querySelector(`.sec-search-add`).addEventListener(`click`,()=>{Ta(t,async e=>{await la.update(e.id,{section_id:n.id}),Z(`[${e.product_code||`상품`}]이 '${n.title}' 기획전에 추가되었습니다.`),await Sa(t)})});let l=o.querySelector(`.sec-prod-list`);a.forEach(e=>{let n=document.createElement(`div`);n.style.cssText=`background:#fff; border:1px solid #e2e8f0; border-radius:8px; padding:10px 12px; display:flex; align-items:center; justify-content:space-between; gap:12px;`,n.innerHTML=`
      ...
      `,n.querySelector(`.btn-remove-sec-prod`).addEventListener(`click`,async()=>{await la.update(e.id,{section_id:null}),Z(`기획전에서 제외되었습니다.`),await Sa(t)}),l.appendChild(n)}),i.appendChild(o)})}async function Da(e){let t=await oa.getAll();e.innerHTML=`
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px;">
  ...
  `,e.querySelector(`#add-banner`).addEventListener(`click`,async()=>{await oa.insert({sort_order:99,title:`새 기획 배너`,desc:``,label:`오늘`,time_text:`오후 8시`,img_url:``,link_url:`/shop/live_teaser.html`}),Z(`새 배너가 추가되었습니다.`),await Da(e)});let n=e.querySelector(`#banner-list`);t.forEach(t=>{let r=document.createElement(`div`);r.className=`sm-card`,r.innerHTML=`
    ...
    `,ga(r.querySelector(`.b-uploader`),r.querySelector(`.b-img`),e=>{r.querySelector(`.b-thumb`).src=e}),r.querySelector(`.b-img-preview`).addEventListener(`click`,()=>{r.querySelector(`.b-thumb`).src=r.querySelector(`.b-img`).value.trim()}),r.querySelector(`.b-save`).addEventListener(`click`,async()=>{await oa.update(t.id,{title:r.querySelector(`.b-title`).value.trim(),desc:r.querySelector(`.b-desc`).value.trim(),label:r.querySelector(`.b-label`).value.trim(),time_text:r.querySelector(`.b-time`).value.trim(),img_url:r.querySelector(`.b-img`).value.trim(),link_url:r.querySelector(`.b-link`).value.trim()}),Z(`배너 저장 완료`)}),r.querySelector(`.b-del`).addEventListener(`click`,async()=>{confirm(`배너를 삭제합니까?`)&&(await oa.delete(t.id),Z(`삭제되었습니다.`),await Da(e))}),n.appendChild(r)})}async function Oa(e){let[t,n]=await Promise.all([ca.getAll(),sa.getAll()]);ya=n;let r=`<option value="">-- 기획전 섹션 연결 안함 --</option>`+n.map(e=>`<option value="${e.id}">${Q(e.title)}</option>`).join(``);e.innerHTML=`
  ...
  `,e.querySelector(`#add-menu`).addEventListener(`click`,async()=>{await ca.insert({sort_order:99,name:`새 카테고리 탭`,section_id:null}),Z(`새 탭이 추가되었습니다.`),await Oa(e)});let i=e.querySelector(`#menu-list`);t.forEach((t,n)=>{let a=document.createElement(`div`);a.className=`sm-card`,a.style.cssText=`padding:14px 16px; display:flex; align-items:center; gap:14px; flex-wrap:wrap; margin-bottom:10px;`,a.innerHTML=`
    ...
    `;let o=a.querySelector(`.m-sec`);o.value=t.section_id||``,a.querySelector(`.m-save`).addEventListener(`click`,async()=>{await ca.update(t.id,{name:a.querySelector(`.m-name`).value.trim(),section_id:o.value||null}),Z(`탭 저장 완료`)}),a.querySelector(`.m-del`).addEventListener(`click`,async()=>{confirm(`이 탭 메뉴를 삭제합니까?`)&&(await ca.delete(t.id),Z(`삭제되었습니다.`),await Oa(e))}),i.appendChild(a)})}async function ka(e){let t=[];try{t=await ua.getAll()}catch{t=[]}e.innerHTML=`
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px;">
      <div>
  ...
  `,e.querySelector(`#add-user-btn`).addEventListener(`click`,()=>{ja(null,t,e)}),e.querySelectorAll(`.user-edit-btn`).forEach(r=>{r.addEventListener(`click`,()=>{ja(n.find(e=>e.id===r.dataset.id),t,e)})})}function ja(e,t,n){let r=!!e,i=t.querySelector(`#sm-modal-container`),a=e?e.user_code:`USER-${Math.floor(Math.random()*89999+1e4)}`;i.innerHTML=`
    <div class="sm-modal-backdrop">
...
(새로 직접 등록하실 수 있도록 전부 비워집니다.)`)&&(i=[],await r(`hero`,i),J(`히어로 카드가 전체 삭제되었습니다. 새 카드를 직접 추가해 보세요.`),f())});let t=async()=>{i.push(``),f()};e.querySelector(`#btn-add-hero-card`)?.addEventListener(`click`,t),e.querySelector(`#btn-add-hero-card-empty`)?.addEventListener(`click`,t),e.querySelectorAll(`.btn-move-hero`).forEach(e=>{e.addEventListener(`click`,async e=>{let t=parseInt(e.currentTarget.dataset.idx),n=t+parseInt(e.currentTarget.dataset.dir);if(n>=0&&n<i.length){let e=i[t];i[t]=i[n],i[n]=e,await r(`hero`,i),f()}})}),e.querySelectorAll(`.btn-del-hero-card`).forEach(e=>{e.addEventListener(`click`,async e=>{let t=parseInt(e.currentTarget.dataset.idx);i.splice(t,1),await r(`hero`,i),J(`카드가 삭제되었습니다.`),f()})}),e.querySelectorAll(`.input-hero-path`).forEach(e=>{e.addEventListener(`change`,e=>{let t=parseInt(e.target.dataset.idx);i[t]=e.target.value.trim()})}),e.querySelectorAll(`.btn-upload-hero-card`).forEach(e=>{e.addEventListener(`click`,e=>{let t=e.currentTarget.dataset.idx,n=document.getElementById(`hero-card-file-${t}`);n&&n.click()})}),e.querySelectorAll(`.hero-card-file-input`).forEach(t=>{t.addEventListener(`change`,async t=>{let n=parseInt(t.target.dataset.idx),a=t.target.files[0];if(!a)return;let o=e.querySelector(`.btn-upload-hero-card[data-idx="${n}"]`);o&&(o.disabled=!0,o.textContent=`⏳ 업로드 중...`);try{a.type.startsWith(`image/`)&&(a=await new Promise(e=>{let t=new Image,n=new FileReader;n.onload=n=>{t.onload=()=>{let n=document.createElement(`canvas`),r=t.width,i=t.height,o=1920;r>o&&(i=Math.round(i*o/r),r=o),n.width=r,n.height=i,n.getContext(`2d`).drawImage(t,0,0,r,i),n.toBlob(t=>{if(!t){e(a);return}e(new File([t],a.name.replace(/\.[^/.]+$/,``)+`.jpg`,{type:`image/jpeg`,lastModified:Date.now()}))},`image/jpeg`,.88)},t.src=n.target.result},n.readAsDataURL(a)}));let e=window.supabaseClient;if(!e){alert(`Supabase 연동 클라이언트를 찾을 수 없습니다.`);return}let t=a.name.split(`.`).pop(),o=`hero/${`${Date.now()}_${Math.random().toString(36).substring(2,7)}.${t}`}`,{data:s,error:c}=await e.storage.from(`news_images`).upload(o,a,{cacheControl:`3600`,upsert:!0});if(c){let t=await e.storage.from(`hp_assets`).upload(o,a,{cacheControl:`3600`,upsert:!0});s=t.data,c=t.error}if(c){console.error(`Storage Upload Error:`,c),alert(`파일 업로드 실패: `+c.message);return}let{data:l}=e.storage.from(`news_images`).getPublicUrl(o),u=l.publicUrl;i[n]=u,await r(`hero`,i),J(`사진이 Supabase 고화질 스토리지로 성공적으로 업로드되었습니다!`),f()}catch(e){console.error(e),alert(`업로드 처리 중 오류 발생: `+e.message)}finally{o&&(o.disabled=!1,o.textContent=`사진 선택`)}})})}e.querySelector(`#btn-add-pf`)?.addEventListener(`click`,async()=>{let e=prompt(`포트폴리오 브랜드명/제목:`);if(!e)return;let t=prompt(`이미지 경로:`,`./assets/001.jpg`)||`./assets/001.jpg`,n=prompt(`방송/영상 URL 링크:`,`#`)||`#`;a.unshift({title:e,category:`beauty`,image:t,link:n}),await r(`portfolio`,a),J(`포트폴리오가 Supabase DB에 동기화되었습니다.`),f()}),e.querySelectorAll(`.btn-del-pf`).forEach(e=>{e.addEventListener(`click`,async e=>{let t=parseInt(e.target.dataset.idx);a.splice(t,1),await r(`portfolio`,a),J(`포트폴리오 항목이 삭제되었습니다.`),f()})}),e.querySelector(`#btn-add-pkg`)?.addEventListener(`click`,async()=>{let e=prompt(`패키지 명칭:`);if(!e)return;let t=prompt(`가격:`,`1,500,000원`)||`1,500,000원`,n=prompt(`구성 내용:`,`4K 촬영, 메인 쇼호스트`)||``;o.push({name:e,price:t,features:n}),await r(`packages`,o),J(`패키지가 Supabase DB에 동기화되었습니다.`),f()}),e.querySelectorAll(`.btn-del-pkg`).forEach(e=>{e.addEventListener(`click`,async e=>{let t=parseInt(e.target.dataset.idx);o.splice(t,1),await r(`packages`,o),f()})}),e.querySelector(`#btn-add-story`)?.addEventListener(`click`,async()=>{let e=prompt(`브랜드명:`);if(!e)return;let t=prompt(`후기/스토리 한줄 문구:`)||``;c.push({brand:e,quote:t,author:`브랜드 담당자`}),await r(`stories`,c),J(`브랜드 스토리가 Supabase DB에 동기화되었습니다.`),f()}),e.querySelectorAll(`.btn-del-story`).forEach(e=>{e.addEventListener(`click`,async e=>{let t=parseInt(e.target.dataset.idx);c.splice(t,1),await r(`stories`,c),f()})}),e.querySelector(`#btn-add-logo`)?.addEventListener(`click`,async()=>{let e=prompt(`파트너 브랜드명:`);if(!e)return;let t=prompt(`로고 이미지 경로:`,`./assets/logo.png`)||`./assets/logo.png`;l.push({name:e,logo:t}),await r(`logos`,l),J(`파트너 로고가 Supabase DB에 동기화되었습니다.`),f()}),e.querySelectorAll(`.btn-del-logo`).forEach(e=>{e.addEventListener(`click`,async e=>{let t=parseInt(e.target.dataset.idx);l.splice(t,1),await r(`logos`,l),f()})})}return f(),e}var Va=()=>JSON.parse(localStorage.getItem(`ryzin_demo_list`)||`[]`),Ha=e=>localStorage.setItem(`ryzin_demo_list`,JSON.stringify(e));function Ua(e){e.innerHTML=`
  ...
  `,(async()=>{let t=e.querySelector(`#demo-live-select`),n=window.supabaseClient;if(!(!t||!n))try{let{data:e,error:r}=await n.from(`live_control`).select(`live_id, title`);!r&&e&&e.length>0&&(t.innerHTML=e.map(e=>`
        ...
        `).join(``))}catch{}})();let t=()=>{let n=e.querySelector(`#demo-list-table-container`),r=e.querySelector(`#demo-count-badge`),i=Va();if(r&&(r.textContent=`${i.length}개`),i.length===0){n.innerHTML=`
    ...
    `,n.querySelectorAll(`.btn-copy-clean-link`).forEach(e=>{e.addEventListener(`click`,e=>{let t=e.currentTarget.dataset.url;navigator.clipboard.writeText(t).then(()=>{let t=e.currentTarget.textContent;e.currentTarget.textContent=`복사 완료!`,e.currentTarget.style.background=`#16a34a`,setTimeout(()=>{e.currentTarget.textContent=t,e.currentTarget.style.background=`#2563eb`},2e3)})})}),n.querySelectorAll(`.btn-preview-demo`).forEach(e=>{e.addEventListener(`click`,e=>{window.open(e.currentTarget.dataset.url,`_blank`)})}),n.querySelectorAll(`.btn-delete-demo`).forEach(e=>{e.addEventListener(`click`,e=>{if(!confirm(`이 데모 시연을 삭제하시겠습니까?`))return;let n=parseInt(e.currentTarget.dataset.index),r=Va();r.splice(n,1),Ha(r),t()})})},n=e.querySelector(`#btn-create-demo`);n&&n.addEventListener(`click`,()=>{let n=e.querySelector(`#demo-name-input`).value.trim(),r=e.querySelector(`#demo-url-input`).value.trim(),i=e.querySelector(`#demo-live-select`).value;if(!n||!r){alert(`데모명과 타겟 사이트 URL을 모두 입력해주세요.`);return}let a=Va();a.unshift({name:n,url:r,liveId:i,createdAt:new Date().toISOString()}),Ha(a),e.querySelector(`#demo-name-input`).value=``,e.querySelector(`#demo-url-input`).value=``,t()});let r=async()=>{let t=e.querySelector(`#demo-leads-table-container`);if(!t)return;let n=window.supabaseClient;if(!n){t.innerHTML=`
      ...
      `}},i=e.querySelector(`#btn-refresh-demo-leads`);i&&i.addEventListener(`click`,()=>{r()}),t(),r()}x(),j();async function Wa(){let e=document.getElementById(`app`);e.innerHTML=`
  ...
  `;try{let e=new Promise(e=>setTimeout(()=>e(!0),3e3));await Promise.race([U.init(),e])}catch(e){console.warn(`데이터 로딩 타임아웃/오류 발생, 로컬 데이터로 접속합니다.`,e)}let t=()=>{if(e.querySelector(`.sidebar`))return;e.innerHTML=``,e.className=`app-layout`,e.appendChild(Qe());let t=document.createElement(`div`);t.className=`mobile-overlay`,t.onclick=()=>document.querySelector(`.sidebar`).classList.remove(`open`),e.appendChild(t);let n=document.createElement(`button`);n.className=`mobile-menu-btn`,n.innerHTML=`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>`,n.onclick=()=>document.querySelector(`.sidebar`).classList.toggle(`open`),e.appendChild(n);let r=document.createElement(`main`);r.className=`main-content`,r.id=`page-content`,e.appendChild(r),M.setContainer(r)};M.beforeEach(n=>{let r=n.startsWith(`/shared_scheme/`),i=!!U.getCurrentUser();if(!r&&!i&&n!==`/login`)return`/login`;if(i&&n===`/login`)return`/`;if(i&&n===`/live_stream`){let e=U.getCurrentUser();if(U.isDemoMode||e&&(e.id===`demo`||e.role===`demo`))return`/`}if(i){U.getCurrentUser();let e=U.getCurrentRole();if(e&&e.startsWith(`live_stream:`)&&n!==`/live_stream`&&n!==`/settings`&&n!==`/login`)return`/live_stream`;if(e&&e.startsWith(`brand:`)&&n!==`/projects`&&!n.startsWith(`/projects/`)&&n!==`/settings`&&n!==`/login`)return`/projects`}return n===`/login`||n.startsWith(`/shared_scheme/`)?(e.innerHTML=``,e.className=``,M.setContainer(e)):t(),!0}),M.register(`/login`,()=>Qi()),M.register(`/`,()=>pt()),M.register(`/live_stream`,()=>Nt()),M.register(`/projects`,()=>Gt()),M.register(`/projects/new`,()=>Gt()),M.register(`/projects/:id`,e=>qt(e)),M.register(`/shared_scheme/:id`,e=>Yt(e)),M.register(`/hosts`,()=>It()),M.register(`/hosts/:id`,e=>Rt(e)),M.register(`/brands`,()=>Vt()),M.register(`/brands/:id`,e=>Ut(e)),M.register(`/finance`,()=>on()),M.register(`/settlement`,()=>ln()),M.register(`/contracts`,()=>fn()),M.register(`/marketing`,()=>gn()),M.register(`/crm`,()=>_n()),M.register(`/shop_manage`,()=>xa()),M.register(`/class_applications`,()=>Ma()),M.register(`/news_manage`,()=>Ia()),M.register(`/homepage_manage`,()=>Ba()),M.register(`/demo_manage`,()=>Ua(document.getElementById(`page-content`))),M.register(`/settings`,()=>vn()),M.start(),document.addEventListener(`click`,e=>{let t=e.target.closest(`a[href]`);t&&t.getAttribute(`href`).startsWith(`/`)&&!t.getAttribute(`target`)&&(e.preventDefault(),M.navigate(t.getAttribute(`href`)))})}Wa();