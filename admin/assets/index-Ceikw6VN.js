              ...
              ${[`col1`,`col2`,`col3`,`col4`].map((e,t)=>`
                <div style="background: var(--bg-secondary); padding: 16px; border-radius: var(--radius-md); border: 1px solid var(--border-light);">
                  ...
                  <div style="display:flex; flex-direction:column; gap:8px;">
                    ${(i[e]||[]).map((t,n)=>`
                      <div style="display:flex; gap:6px; align-items:center;">
                        <input type="text" class="input input-hero-img" id="hero-img-${e}-${n}" data-col="${e}" data-idx="${n}" value="${t}" style="font-size:12px; flex:1;">
                        <input type="file" class="hero-file-input" id="hero-file-${e}-${n}" data-col="${e}" data-idx="${n}" accept="image/*" style="display:none;">
                        <button class="btn btn-xs btn-secondary btn-trigger-hero-upload" data-col="${e}" data-idx="${n}" title="컴퓨터에서 사진 업로드">📁</button>
