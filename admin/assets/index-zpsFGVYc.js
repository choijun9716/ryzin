          ...
          <div class="stats-grid">
            ...
            <div class="stat-card" style="border-color: var(--border-strong);">
              ...
              <div class="stat-value" style="color: ${(n.netMargin||0)>=0?`var(--status-success)`:`var(--status-error)`};">
                ${W(n.netMargin)}
                <span style="font-size: 13px; font-weight: 600; margin-left: 4px;">(${n.salesRevenue?((n.netMargin||0)/n.salesRevenue*100).toFixed(1):0}%)</span>
              </div>
            </div>
            <div class="stat-card">
