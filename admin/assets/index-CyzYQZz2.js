...
`;return typeof a==`function`&&a(null,p),p}}));o((e=>{var t=xi(),n=Wi(),r=Ki(),i=qi();function a(e,r,i,a,o){let s=[].slice.call(arguments,1),c=s.length,l=typeof s[c-1]==`function`;if(!l&&!t())throw Error(`Callback required as last argument`);if(l){if(c<2)throw Error(`Too few arguments provided`);c===2?(o=i,i=r,r=a=void 0):c===3&&(r.getContext&&o===void 0?(o=a,a=void 0):(o=a,a=i,i=r,r=void 0))}else{if(c<1)throw Error(`Too few arguments provided`);return c===1?(i=r,r=a=void 0):c===2&&!r.getContext&&(a=i,i=r,r=void 0),new Promise(function(t,o){try{t(e(n.create(i,a),r,a))}catch(e){o(e)}})}try{let t=n.create(i,a);o(null,e(t,r,a))}catch(e){o(e)}}e.create=n.create,e.toCanvas=a.bind(null,r.render),e.toDataURL=a.bind(null,r.renderToDataURL),e.toString=a.bind(null,function(e,t,n){return i.render(e,n)})}))();function Ji(){H.isDemoMode&&(localStorage.setItem(`ryzin_is_demo_mode`,`false`),H.isDemoMode=!1,H.STORAGE_KEY=`livecommerce_erp_data`,H._load());let e=document.createElement(`div`);return e.className=`login-container`,e.innerHTML=`
  ...
  `}var pa=`products`,ma=[],ha=[];function ga(){let e=document.createElement(`div`);e.style.cssText=`min-height:100vh; background:#f8fafc; padding:24px; color:#0f172a; font-family:"Pretendard",sans-serif;`,ca(e);let t=document.createElement(`div`);return t.style.cssText=`max-width:1100px; margin:0 auto;`,t.innerHTML=`
    ...
    <div style="display:flex; gap:8px; margin-bottom:20px; border-bottom:1px solid #e2e8f0; padding-bottom:10px; overflow-x:auto;">
      ${[{key:`products`,label:`마스터 상품 리스트 (모달 등록)`},{key:`sections`,label:`상품 섹션 & 기획전`},{key:`best10`,label:`베스트 TOP 10 랭킹`},{key:`lives`,label:`라이브 NOW / 예정`},{key:`banners`,label:`상단 배너`},{key:`menus`,label:`퀵메뉴 탭 설정`}].map(e=>`<button class="sm-tab-btn${e.key===pa?` active`:``}" data-tab="${e.key}">${e.label}</button>`).join(``)}
    </div>
  ...
  `,t.querySelectorAll(`.sm-tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{pa=e.dataset.tab,t.querySelectorAll(`.sm-tab-btn`).forEach(e=>{e.classList.toggle(`active`,e.dataset.tab===pa)}),_a(t)})}),t.querySelector(`#btn-refresh`).addEventListener(`click`,()=>{Z(`데이터를 새로고침합니다.`),_a(t)}),e.appendChild(t),setTimeout(async()=>{try{ma=await ra.getAll()}catch{ma=[]}await _a(t)},0),e}async function _a(e){let t=e.querySelector(`#sm-loading`),n=e.querySelector(`#sm-panel`);t.style.display=`block`,n.innerHTML=``;try{ha=await aa.getAll(),pa===`products`?await va(n,e):pa===`sections`?await xa(n,e):pa===`best10`?await Sa(n):pa===`lives`?await Ca(n):pa===`banners`?await wa(n):pa===`menus`&&await Ta(n)}catch(e){n.innerHTML=`
    ...
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px; flex-wrap:wrap; gap:12px;">
      <div>
        <h2 style="font-size:16px; font-weight:800; color:#0f172a; margin:0 0 4px 0;">전체 마스터 상품 리스트 (${ha.length}개 등록)</h2>
  ...
  `;let n=e.querySelector(`#prod-table-body`),r=e.querySelector(`#prod-search-input`);function i(){let e=r.value.trim().toLowerCase(),i=ha.filter(t=>{let n=(t.product_code||``).toLowerCase(),r=(t.product_title||t.brand_title||``).toLowerCase(),i=(t.brand_name||``).toLowerCase();return!e||n.includes(e)||r.includes(e)||i.includes(e)});if(!i.length){n.innerHTML=`<tr><td colspan="8" style="text-align:center; padding:30px; color:#94a3b8;">검색된 상품이 없습니다.</td></tr>`;return}n.innerHTML=i.map(e=>{let t=e.product_code||sa(),n=e.badge_color||`#ef4444`;return`
        <tr>
          ...
          <td style="color:#dc2626; font-weight:700;">${Q(e.discount||`-`)}</td>
          <td>
            <div style="display:flex; align-items:center; gap:6px;">
  ...
  `;let o=()=>{i.innerHTML=``};i.querySelector(`#modal-close-btn`).addEventListener(`click`,o),i.querySelector(`#modal-cancel-btn`).addEventListener(`click`,o);let s=i.querySelector(`#m-picker`),c=i.querySelector(`#m-color`);s.addEventListener(`input`,e=>c.value=e.target.value),c.addEventListener(`input`,e=>s.value=e.target.value);let l=i.querySelector(`#m-uploader`),u=i.querySelector(`#m-imgurl`);da(l,u,e=>{i.querySelector(`#m-thumb-img`).src=e}),i.querySelector(`#modal-prod-form`).addEventListener(`submit`,async r=>{r.preventDefault();let a=i.querySelector(`#m-pcode`).value.trim(),s=i.querySelector(`#m-psection`).value||null,l=i.querySelector(`#m-bname`).value.trim(),d=i.querySelector(`#m-ptitle`).value.trim(),f={product_code:a,section_id:s,brand_name:l,product_title:d,brand_title:l?`${l} ${d}`:d,sale_price:i.querySelector(`#m-sale`).value.trim(),origin_price:i.querySelector(`#m-origin`).value.trim(),discount:i.querySelector(`#m-disc`).value.trim(),badge_color:c.value.trim()||`#ef4444`,md_comment:i.querySelector(`#m-mdcomment`).value.trim(),img_url:u.value.trim()};n?(await aa.update(e.id,f),Z(`상품 수정 완료`)):(f.sort_order=99,f.rating=`5.0`,f.reviews=`10`,await aa.insert(f),Z(`새 상품 등록 완료`)),o(),await _a(t)})}function ba(e,t){let n=e.querySelector(`#sm-modal-container`);n.innerHTML=`
  ...
  `;let r=()=>{n.innerHTML=``};n.querySelector(`#search-modal-close`).addEventListener(`click`,r);let i=n.querySelector(`#modal-search-keyword`),a=n.querySelector(`#search-result-list`);function o(){let e=i.value.trim().toLowerCase(),n=ha.filter(t=>{let n=(t.product_code||``).toLowerCase(),r=(t.product_title||t.brand_title||``).toLowerCase(),i=(t.brand_name||``).toLowerCase();return!e||n.includes(e)||r.includes(e)||i.includes(e)});if(!n.length){a.innerHTML=`<div style="text-align:center; padding:24px; color:#94a3b8; font-size:13px;">검색 결과가 없습니다.</div>`;return}a.innerHTML=n.map(e=>`
    ...
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px;">
      <h2 style="font-size:15px; font-weight:800; color:#0f172a; margin:0;">기획전 상품 섹션 관리 (${ma.length}개 섹션)</h2>
      <button id="add-sec" class="sm-action-btn sm-btn-primary">+ 새 상품 섹션 추가</button>
    </div>
    <div id="section-list"></div>
  `,e.querySelector(`#add-sec`).addEventListener(`click`,async()=>{await ra.insert({sort_order:99,title:`새 기획전 섹션`,subtitle:`단독 특가로 만나보세요`,show_timer:!1}),Z(`새 섹션이 생성되었습니다.`),await xa(e,t)});let i=e.querySelector(`#section-list`);ma.forEach(n=>{let a=r[n.id]||[],o=document.createElement(`div`);o.className=`sm-card`,o.innerHTML=`
    ...
    `,o.querySelector(`.sec-save`).addEventListener(`click`,async()=>{await ra.update(n.id,{title:o.querySelector(`.sec-title`).value.trim(),subtitle:o.querySelector(`.sec-subtitle`).value.trim()}),Z(`섹션 정보 저장 완료`)}),o.querySelector(`.sec-del`).addEventListener(`click`,async()=>{confirm(`이 섹션을 삭제합니까?`)&&(await ra.delete(n.id),Z(`삭제되었습니다.`),await xa(e,t))}),o.querySelector(`.sec-search-add`).addEventListener(`click`,()=>{ba(t,async e=>{await aa.update(e.id,{section_id:n.id}),Z(`[${e.product_code||`상품`}]이 '${n.title}' 섹션에 추가되었습니다.`),await _a(t)})});let s=o.querySelector(`.sec-prod-list`);a.forEach(e=>{let n=document.createElement(`div`);n.style.cssText=`background:#fff; border:1px solid #e2e8f0; border-radius:8px; padding:10px 12px; display:flex; align-items:center; justify-content:space-between; gap:12px;`,n.innerHTML=`
      ...
      `,n.querySelector(`.btn-remove-sec-prod`).addEventListener(`click`,async()=>{await aa.update(e.id,{section_id:null}),Z(`섹션에서 제외되었습니다.`),await _a(t)}),s.appendChild(n)}),i.appendChild(o)})}async function Sa(e){let t=ha,n=t.filter(e=>e.best_rank&&e.best_rank>0).sort((e,t)=>(e.best_rank||99)-(t.best_rank||99)).slice(0,10),r=n.length?n:t.slice(0,10);e.innerHTML=`
    ...
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px;">
      <h2 style="font-size:15px; font-weight:800; color:#0f172a; margin:0;">베스트 TOP 10 등록 상품 (${r.length}개)</h2>
    </div>
  ...
  `;let i=e.querySelector(`#best10-list`);r.forEach((e,t)=>{let n=e.best_rank||t+1,r=e.badge_color||`#ef4444`,a=document.createElement(`div`);a.className=`sm-card`,a.innerHTML=`
      <div style="display:flex; gap:16px; align-items:flex-start; flex-wrap:wrap;">
        <div style="width:110px; flex-shrink:0;">
          <div style="margin-bottom:6px;">
            <span class="sm-rank-badge top3" style="background:${Q(r)}">RANK #${n}</span>
          </div>
          <div class="sm-thumb-uploader b10-uploader" style="width:100%; height:86px;">
            <img class="b10-thumb" src="${Q(e.img_url||``)}" style="width:100%; height:100%; object-fit:cover;">
            <div class="sm-thumb-uploader-overlay">클릭 업로드</div>
          </div>
        </div>
        <div style="flex:1; min-width:260px; display:grid; grid-template-columns:1fr 1fr; gap:10px;">
          <div>
            <label class="sm-label">상품 코드: ${Q(e.product_code||`PROD-00000`)}</label>
          ...
          <div>
            <label class="sm-label">뱃지 배경 색상 (Badge Color)</label>
            <div class="color-picker-box">
              <input class="color-picker-input b10-picker" type="color" value="${Q(r)}">
              <input class="sm-input b10-color" type="text" value="${Q(r)}" placeholder="#ef4444" style="font-weight:700;">
            </div>
          </div>
          ${$(`브랜드명`,`b10-bname`,e.brand_name||``)}
          ${$(`상품명`,`b10-title`,e.product_title||e.brand_title||``)}
          ${$(`판매가`,`b10-sale`,e.sale_price)}
          ${$(`할인 태그`,`b10-disc`,e.discount)}
          ${fa(`이미지 URL`,`b10-img`,e.img_url)}
        </div>
      </div>
    ...
    `,da(a.querySelector(`.b10-uploader`),a.querySelector(`.b10-img`),e=>{a.querySelector(`.b10-thumb`).src=e});let o=a.querySelector(`.b10-picker`),s=a.querySelector(`.b10-color`);o.addEventListener(`input`,e=>{s.value=e.target.value,a.querySelector(`.sm-rank-badge`).style.background=e.target.value}),s.addEventListener(`input`,e=>{o.value=e.target.value,a.querySelector(`.sm-rank-badge`).style.background=e.target.value}),a.querySelector(`.b10-save`).addEventListener(`click`,async()=>{let n=parseInt(a.querySelector(`.b10-rank`).value)||t+1,r=a.querySelector(`.b10-color`).value.trim()||`#ef4444`,i=a.querySelector(`.b10-bname`).value.trim(),o=a.querySelector(`.b10-title`).value.trim(),s=i?`${i} ${o}`:o;await aa.update(e.id,{best_rank:n,badge_color:r,brand_name:i,product_title:o,brand_title:s,sale_price:a.querySelector(`.b10-sale`).value.trim(),discount:a.querySelector(`.b10-disc`).value.trim(),img_url:a.querySelector(`.b10-img`).value.trim()}),Z(`베스트 #${n}위 저장 완료`)}),i.appendChild(a)})}async function Ca(e){let t=await oa.getAll();e.innerHTML=`
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px;">
  ...
  `,e.querySelector(`#add-live`).addEventListener(`click`,async()=>{await oa.insert({sort_order:99,title:`신규 라이브 방송`,viewers:`0명 시청 중`,img_url:``,link_url:``,status:`live`}),Z(`새 라이브가 생성되었습니다.`),await Ca(e)});let n=e.querySelector(`#live-list`);t.forEach(t=>{let r=document.createElement(`div`);r.className=`sm-card`;let i=t.status===`upcoming`;r.innerHTML=`
      <div style="display:flex; gap:16px; align-items:flex-start; flex-wrap:wrap;">
        <div style="width:130px; flex-shrink:0;">
          <label class="sm-label">방송 썸네일 (클릭 업로드)</label>
          <div class="sm-thumb-uploader lv-uploader" style="width:100%; height:86px;">
            <img class="lv-thumb" src="${Q(t.img_url||``)}" style="width:100%; height:100%; object-fit:cover;">
            <div class="sm-thumb-uploader-overlay">클릭 업로드</div>
          </div>
        </div>
        <div style="flex:1; min-width:260px; display:grid; grid-template-columns:1fr 1fr; gap:10px;">
    ...
    `,da(r.querySelector(`.lv-uploader`),r.querySelector(`.lv-img`),e=>{r.querySelector(`.lv-thumb`).src=e}),r.querySelector(`.lv-img-preview`).addEventListener(`click`,()=>{r.querySelector(`.lv-thumb`).src=r.querySelector(`.lv-img`).value.trim()}),r.querySelector(`.lv-save`).addEventListener(`click`,async()=>{await oa.update(t.id,{title:r.querySelector(`.lv-title`).value.trim(),viewers:r.querySelector(`.lv-viewers`).value.trim(),link_url:r.querySelector(`.lv-link`).value.trim(),img_url:r.querySelector(`.lv-img`).value.trim(),status:r.querySelector(`.lv-status`).value}),Z(`라이브 정보 저장 완료`)}),r.querySelector(`.lv-del`).addEventListener(`click`,async()=>{confirm(`라이브를 삭제합니까?`)&&(await oa.delete(t.id),Z(`삭제되었습니다.`),await Ca(e))}),n.appendChild(r)})}async function wa(e){let t=await na.getAll();e.innerHTML=`
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px;">
  ...
  `,e.querySelector(`#add-banner`).addEventListener(`click`,async()=>{await na.insert({sort_order:99,title:`새 기획 배너`,desc:``,label:`오늘`,time_text:`오후 8시`,img_url:``,link_url:`/shop/live_teaser.html`}),Z(`새 배너가 추가되었습니다.`),await wa(e)});let n=e.querySelector(`#banner-list`);t.forEach(t=>{let r=document.createElement(`div`);r.className=`sm-card`,r.innerHTML=`
      <div style="display:flex; gap:16px; align-items:flex-start; flex-wrap:wrap;">
        <div style="width:130px; flex-shrink:0;">
