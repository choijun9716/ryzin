          ...
          <div class="card-body">
            <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap:16px;">
              <div style="display:flex; flex-direction:column; gap:6px;">
                ...
                <input type="text" class="input" id="input-hero-eyebrow" value="${s.eyebrow||``}" placeholder="예: 감도높은 라이브커머스" style="font-size:13px;">
              </div>
              <div style="display:flex; flex-direction:column; gap:6px;">
            ...
            <div style="margin-top:16px; border-top:1px solid var(--border-light); padding-top:16px;">
              ...
              <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap:12px;">
                <div style="display:flex; flex-direction:column; gap:4px;">
                  ...
                  <input type="text" class="input input-hero-phrase" data-idx="0" value="${s.phrases&&s.phrases[0]||``}" placeholder="예: 브랜드를 라이브합니다." style="font-size:13px;">
                </div>
                <div style="display:flex; flex-direction:column; gap:4px;">
                  <span style="font-size:11px; color:var(--text-secondary);">롤링 문구 2</span>
                  <input type="text" class="input input-hero-phrase" data-idx="1" value="${s.phrases&&s.phrases[1]||``}" placeholder="예: 브랜드의 매출을 만듭니다." style="font-size:13px;">
                </div>
                <div style="display:flex; flex-direction:column; gap:4px;">
                  <span style="font-size:11px; color:var(--text-secondary);">롤링 문구 3</span>
                  <input type="text" class="input input-hero-phrase" data-idx="2" value="${s.phrases&&s.phrases[2]||``}" placeholder="예: 고객이 구매하는 순간을 만듭니다." style="font-size:13px;">
                </div>
              </div>
            </div>
          </div>
