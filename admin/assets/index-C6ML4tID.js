...
`;return typeof a==`function`&&a(null,p),p}})),$r=c(o((e=>{var t=Er(),n=Yr(),r=Zr(),i=Qr();function a(e,r,i,a,o){let s=[].slice.call(arguments,1),c=s.length,l=typeof s[c-1]==`function`;if(!l&&!t())throw Error(`Callback required as last argument`);if(l){if(c<2)throw Error(`Too few arguments provided`);c===2?(o=i,i=r,r=a=void 0):c===3&&(r.getContext&&o===void 0?(o=a,a=void 0):(o=a,a=i,i=r,r=void 0))}else{if(c<1)throw Error(`Too few arguments provided`);return c===1?(i=r,r=a=void 0):c===2&&!r.getContext&&(a=i,i=r,r=void 0),new Promise(function(t,o){try{t(e(n.create(i,a),r,a))}catch(e){o(e)}})}try{let t=n.create(i,a);o(null,e(t,r,a))}catch(e){o(e)}}e.create=n.create,e.toCanvas=a.bind(null,r.render),e.toDataURL=a.bind(null,r.renderToDataURL),e.toString=a.bind(null,function(e,t,n){return i.render(e,n)})}))(),1);function ei(){let e=document.createElement(`div`);return e.className=`login-container`,e.innerHTML=`
  ...
  `,!await V.init()){e.innerHTML=`
    ...
    `;return}let t=()=>{if(e.querySelector(`.sidebar`))return;e.innerHTML=``,e.className=`app-layout`,e.appendChild(Oe());let t=document.createElement(`main`);t.className=`main-content`,t.id=`page-content`,e.appendChild(t),u.setContainer(t)};u.beforeEach(n=>{let r=!!V.getCurrentUser();return!r&&n!==`/login`?`/login`:r&&n===`/login`?`/`:(n===`/login`?(e.innerHTML=``,e.className=``,u.setContainer(e)):t(),!0)}),u.register(`/login`,()=>ei()),u.register(`/`,()=>ze()),u.register(`/projects`,()=>$e()),u.register(`/projects/new`,()=>$e()),u.register(`/projects/:id`,e=>tt(e)),u.register(`/hosts`,()=>We()),u.register(`/hosts/:id`,e=>Ke(e)),u.register(`/brands`,()=>Ye()),u.register(`/brands/:id`,e=>Ze(e)),u.register(`/finance`,()=>dt()),u.register(`/settlement`,()=>ft()),u.register(`/contracts`,()=>ht()),u.register(`/marketing`,()=>yt()),u.register(`/settings`,()=>bt()),u.start(),document.addEventListener(`click`,e=>{let t=e.target.closest(`a[href]`);t&&t.getAttribute(`href`).startsWith(`/`)&&!t.getAttribute(`target`)&&(e.preventDefault(),u.navigate(t.getAttribute(`href`)))})}ti();