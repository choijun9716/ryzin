...
`;e.forEach(e=>{let t=new Date(e.created_at).toLocaleString(`ko-KR`).replace(/,/g,``),r=(e.name||``).replace(/,/g,` `),i=(e.phone||``).replace(/,/g,` `);n+=`${t},${r},${i}\n`});let r=new Blob([`﻿`+n],{type:`text/csv;charset=utf-8;`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=`상담DB_${t}.csv`,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(i)})},me=S.querySelector(`#btn-back`);me&&me.addEventListener(`click`,()=>{A.dispatchEvent(new Event(`adminTabLeave`)),k(),m&&clearInterval(m),_e&&X.removeChannel(_e),ge&&X.removeChannel(ge),n(null)});let he=S.querySelector(`#btn-refresh-preview`);he&&he.addEventListener(`click`,()=>{let e=S.querySelector(`#live-preview-iframe`);e&&(e.src=M)});let ge=null;X&&(ge=X.channel(`bot-sync-${t}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`live_chats`,filter:`live_id=eq.${t}`},e=>{let n=e.new;if(n&&p.autoReplyActive&&p.autoReplyRules&&p.autoReplyRules.length>0){let e=n.nickname||``;if(!e.includes(`|`)&&e!==`관리자`&&e!==`자동응답봇`){let e=(n.content||``).toLowerCase();for(let n of p.autoReplyRules)if(n.keywords.split(`,`).map(e=>e.trim().toLowerCase()).filter(e=>e).some(t=>e.includes(t))){setTimeout(async()=>{try{if(!X)return;await X.from(`live_chats`).insert([{live_id:t,nickname:`자동응답봇`,content:n.answer,created_at:Date.now().toString()}])}catch(e){console.warn(`Auto-reply failed`,e)}},600);break}}}}).subscribe());let _e=null;X&&(_e=X.channel(`admin-sync-${t}`).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`live_control`,filter:`live_id=eq.${t}`},e=>{let n=e.new;if(!n)return;u.brandName=n.title||``,u.title=n.subtitle||``;let r=n.profile_image||``,i=`라이브 보기`,a=`right`,o=``,s=!1,c=r.split(`#`),l=c[0];c.slice(1).forEach(e=>{e===`nosplash`||(e.startsWith(`widgetText=`)?i=decodeURIComponent(e.replace(`widgetText=`,``)):e.startsWith(`widgetPosition=`)?a=e.replace(`widgetPosition=`,``):e.startsWith(`widgetImageUrl=`)?o=e.replace(`widgetImageUrl=`,``):e.startsWith(`showOnMain=`)&&(s=e.replace(`showOnMain=`,``)===`true`))}),u.showSplash=!r.includes(`#nosplash`),u.logoUrl=l,u.widgetText=i,u.widgetPosition=a,u.widgetImageUrl=o,u.showOnMain=s,u.streamUrl=n.stream_url||``,u.showViewers=n.show_viewers!==!1,u.thumbnailUrl=n.thumbnail_url||``,u.liveStartTime=n.start_time||``,u.isLive=n.status===`ON`,u.shareTitle=n.share_title||``,u.shareDesc=n.share_desc||``,u.shareImageUrl=n.share_image||``,u.likeImageUrl=n.like_image_url||``,u.bannedWords=n.banned_words||``,u.bannedUsers=n.banned_users||``,n.winner_name!==void 0&&(u.winner_name=n.winner_name),n.winner_timestamp!==void 0&&(u.winner_timestamp=n.winner_timestamp),n.viewers!==void 0&&(d.viewers=parseInt(n.viewers)||0),n.cum_viewers!==void 0&&(d.cumViewers=parseInt(n.cum_viewers)||0),n.hearts!==void 0&&(d.hearts=parseInt(n.hearts)||0),St(t,u),wt(t,d),typeof window.updateAdminViewersDisplay==`function`&&window.updateAdminViewersDisplay();let p=(e,t)=>{let n=S.querySelector(`#`+e)||document.getElementById(e);n&&document.activeElement!==n&&(n.type===`checkbox`?n.checked=!!t:n.value=t)};p(`cfg-brandName`,u.brandName),p(`cfg-title`,u.title),p(`cfg-stream`,u.streamUrl),p(`cfg-showViewers`,u.showViewers),p(`cfg-liveStartTime`,u.liveStartTime),p(`cfg-shareTitle`,u.shareTitle),p(`cfg-shareDesc`,u.shareDesc),p(`cfg-bannedWords`,u.bannedWords),p(`cfg-bannedUsers`,u.bannedUsers);let m=S.querySelector(`#logo-preview`)||document.getElementById(`logo-preview`);m&&(m.src=u.logoUrl);let h=S.querySelector(`#thumbnail-preview`)||document.getElementById(`thumbnail-preview`);h&&(h.src=u.thumbnailUrl);let g=S.querySelector(`#like-preview`)||document.getElementById(`like-preview`);g&&(g.src=u.likeImageUrl,g.style.display=u.likeImageUrl?`block`:`none`);let _=S.querySelector(`#like-preview-placeholder`)||document.getElementById(`like-preview-placeholder`);_&&(_.style.display=u.likeImageUrl?`none`:`block`);let v=S.querySelector(`#btn-clear-like-icon`)||document.getElementById(`btn-clear-like-icon`);v&&(v.style.display=u.likeImageUrl?`block`:`none`);let y=S.querySelector(`#btn-toggle-live`)||document.getElementById(`btn-toggle-live`);if(y&&document.activeElement!==y&&(y.textContent=u.isLive?`라이브 종료`:`라이브 시작`,y.className=`action-btn ${u.isLive?`btn-danger-solid`:`btn-success-solid`}`),n.products&&Array.isArray(n.products)){let e=JSON.stringify(n.products);if(JSON.stringify(f)!==e){Array.isArray(f)||(f=[]),f.length=0,f.push(...n.products),Et(t,f);let e=S.querySelector(`#product-list-container`)||document.getElementById(`product-list-container`);e&&!e.contains(document.activeElement)&&typeof de==`function`&&(e.innerHTML=de())}}}).subscribe()),X&&setInterval(async()=>{try{let{data:e,error:n}=await X.from(`live_control`).select(`viewers, cum_viewers, hearts`).eq(`live_id`,t).maybeSingle();e&&!n&&(d.viewers=parseInt(e.viewers)||0,d.cumViewers=parseInt(e.cum_viewers)||0,d.hearts=parseInt(e.hearts)||0,wt(t,d),typeof window.updateAdminViewersDisplay==`function`&&window.updateAdminViewersDisplay())}catch{}},2500);let ve=w.querySelectorAll(`.tab-btn`),ye=e=>{A.dispatchEvent(new Event(`adminTabLeave`)),ve.forEach(t=>t.classList.toggle(`active`,t.dataset.tab===e)),e===`config`?le():e===`scheme`?B():e===`chat`?ue():e===`product`?fe():e===`leads`&&pe()};ve.forEach(e=>{e.addEventListener(`click`,()=>ye(e.dataset.tab))}),o?B():le()}function It(){let e=document.createElement(`div`),t=``;function n(){let r=U.getAll(`hosts`);if(t){let e=t.toLowerCase();r=r.filter(t=>t.name.toLowerCase().includes(e)||t.phone&&t.phone.includes(e))}let i=r.map(e=>{let t=U.getHostStats(e.id);return{...e,stats:t}});e.innerHTML=`
  ...
  `,r=document.createElement(`div`);r.style.cssText=`display: flex; gap: var(--space-3); justify-content: flex-end; width: 100%;`;let i=document.createElement(`button`);i.className=`btn btn-secondary`,i.textContent=`취소`,i.addEventListener(`click`,q);let a=document.createElement(`button`);a.className=`btn btn-primary`,a.textContent=`등록`,a.addEventListener(`click`,()=>{let n=document.getElementById(`proj-brandName`).value.trim(),r=document.getElementById(`proj-date`).value;if(!n){Y(`방송 제목(브랜드)을 입력해주세요.`);return}if(!r){Y(`방송일을 선택해주세요.`);return}let i=t.find(e=>e.name===n),a=i?i.id:`b_`+n,o={id:L(`live`),brandId:a,brandName:n,adName:``,category:document.getElementById(`proj-category`).value,broadcastMonth:r.substring(0,7),broadcastDate:r,broadcastTime:document.getElementById(`proj-time`).value,platform:document.getElementById(`proj-platform`).value,liveUrl:``,pd:document.getElementById(`proj-pd`).value.trim(),designer:document.getElementById(`proj-designer`).value.trim(),cuesheetLink:``,note:document.getElementById(`proj-note`).value.trim(),broadcastStatus:`new`,settleStatus:`wait`,createdAt:new Date().toISOString().split(`T`)[0]};U.create(`projects`,o),q(),J(`프로젝트가 등록되었습니다.`),e&&e()}),r.appendChild(i),r.appendChild(a),K({title:`신규 프로젝트 등록`,size:`lg`,content:n,footer:r})}function qt(e){let t=document.createElement(`div`),n=U.getCurrentRole(),r=n&&n.startsWith(`brand:`);r&&n.split(`:`)[1];let i=r?`scheme`:`info`;function a(){let n=U.getById(`projects`,e.id);if(!n){t.innerHTML=`<div class="page-header"><div class="page-header-left"><h1 class="page-title">프로젝트를 찾을 수 없습니다</h1></div></div>
    ...
    `,t||n.querySelector(`#btn-copy-scheme-url`)?.addEventListener(`click`,()=>{let t=`${window.location.origin}${window.location.pathname}#/shared_scheme/${e.id}`;navigator.clipboard.writeText(t).then(()=>J(`공유 URL이 클립보드에 복사되었습니다.`)).catch(()=>Y(`URL 복사에 실패했습니다.`))}),n.querySelector(`#btn-add-prod-row`).addEventListener(`click`,()=>{s(),r.products.push({prodName:``,prodUrl:``,stock:``,price:``,livePrice:``,targetQty:``,feeRate:``}),o()}),n.querySelectorAll(`.btn-delete-prod-row`).forEach(e=>{e.addEventListener(`click`,()=>{s();let t=parseInt(e.getAttribute(`data-idx`),10);r.products.splice(t,1),o()})});let c=e=>{let t=e.replace(/[^0-9]/g,``);return t?parseInt(t,10).toLocaleString():``},l=e=>parseFloat(e.replace(/,/g,``))||0,u=e=>{let t=l(e.querySelector(`.prod-price`).value),n=l(e.querySelector(`.prod-livePrice`).value),r=parseInt(e.querySelector(`.prod-targetQty`).value,10)||0,i=t>0?Math.round((t-n)/t*100)+`%`:`0%`;e.querySelector(`.prod-discountRate`).textContent=i;let a=n*r;e.querySelector(`.prod-targetSales`).textContent=a.toLocaleString()};n.querySelectorAll(`.product-row`).forEach(e=>{let t=e.querySelector(`.prod-price`),n=e.querySelector(`.prod-livePrice`),r=t=>{t.addEventListener(`input`,t=>{let n=t.target.selectionStart,r=t.target.value.length,i=c(t.target.value);t.target.value=i;let a=i.length;t.target.setSelectionRange(n+(a-r),n+(a-r)),u(e)})};t&&r(t),n&&r(n);let i=e.querySelector(`.prod-prodUrl`);i&&i.addEventListener(`input`,t=>{let n=t.target.value.trim(),r=e.querySelector(`.btn-prod-url-link`);r&&(n?(r.href=n.startsWith(`http`)?n:`https://${n}`,r.style.display=`inline-flex`):(r.href=`#`,r.style.display=`none`))}),e.querySelectorAll(`input`).forEach(r=>{r!==t&&r!==n&&r.addEventListener(`input`,()=>{u(e)})})});let d=n.querySelector(`#sch-productionDriveUrl`);d&&d.addEventListener(`input`,e=>{let t=e.target.value.trim(),r=n.querySelector(`.btn-production-drive-link`);r&&(t?(r.href=t.startsWith(`http`)?t:`https://${t}`,r.style.display=`inline-flex`):(r.href=`#`,r.style.display=`none`))});function f(){let e=JSON.parse(JSON.stringify(r.sampleRequest||{deliveryDate:``,returnAddress:``,items:[]}));e.items||=[];let t=document.createElement(`div`);t.className=`flex-col`,t.style.gap=`16px`;let n=()=>e.items.length===0?`<tr><td colspan="6" style="text-align:center; padding: 20px; color: var(--text-tertiary);">등록된 제품이 없습니다. 우측 상단의 행 추가 버튼을 눌러주세요.</td></tr>`:e.items.map((e,t)=>`
        ...
        `).join(``),i=()=>{t.querySelector(`#sample-table-body`).innerHTML=n(),t.querySelectorAll(`.btn-delete-sample-row`).forEach(t=>{t.addEventListener(`click`,()=>{a();let n=parseInt(t.getAttribute(`data-idx`),10);e.items.splice(n,1),i()})})},a=()=>{let n=t.querySelectorAll(`.sample-item-row`);e.items=Array.from(n).map(e=>({product:e.querySelector(`.sam-product`).value,size:e.querySelector(`.sam-size`).value,qty:e.querySelector(`.sam-qty`).value?parseInt(e.querySelector(`.sam-qty`).value,10):``,method:e.querySelector(`.sam-method`).value,collect:e.querySelector(`.sam-collect`).value}))};t.innerHTML=`
