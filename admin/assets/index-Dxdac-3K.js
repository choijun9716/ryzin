  ...
  `;let p=()=>r.map((e,t)=>`
      <div style="display:flex; gap:12px; align-items:center; background:#f9fafb; padding:12px; border-radius:8px; margin-bottom:8px; border:1px solid #e5e7eb;">
        ...
        <div>
           ...
           <input type="number" min="0" max="100" class="form-control" style="width:70px; font-size:13px; margin-bottom:4px; padding:4px 8px;" value="${e.discountRate||0}" data-idx="${t}" data-field="discountRate" placeholder="할인율%">
