      ...
      <div style="padding: var(--space-4);">
        ...
        <div style="display: flex; flex-direction: column; gap: 14px;">
          ...
          <div class="form-group">
            ...
            <input type="text" id="news-form-image" class="input" value="${e?e.image||``:`assets/001.jpg`}" placeholder="assets/001.jpg 또는 이미지 링크" style="width: 100%;">
          </div>
          <div class="form-group">
