...
`;e.forEach(e=>{let t=new Date(e.created_at).toLocaleString(`ko-KR`).replace(/,/g,``),r=(e.name||``).replace(/,/g,` `),i=(e.phone||``).replace(/,/g,` `);n+=`${t},${r},${i}\n`});let r=new Blob([`﻿`+n],{type:`text/csv;charset=utf-8;`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=`상담DB_${t}.csv`,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(i)})},le=v.querySelector(`#btn-back`);le&&le.addEventListener(`click`,()=>{T.dispatchEvent(new Event(`adminTabLeave`)),w(),u&&clearInterval(u),de&&X.removeChannel(de),ue&&X.removeChannel(ue),n(null)});let B=v.querySelector(`#btn-refresh-preview`);B&&B.addEventListener(`click`,()=>{let e=v.querySelector(`#live-preview-iframe`);e&&(e.src=D)});let ue=null;X&&(ue=X.channel(`bot-sync-${t}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`live_chats`,filter:`live_id=eq.${t}`},e=>{let n=e.new;if(n&&l.autoReplyActive&&l.autoReplyRules&&l.autoReplyRules.length>0){let e=n.nickname||``;if(!e.includes(`|`)&&e!==`관리자`&&e!==`자동응답봇`){let e=(n.content||``).toLowerCase();for(let n of l.autoReplyRules)if(n.keywords.split(`,`).map(e=>e.trim().toLowerCase()).filter(e=>e).some(t=>e.includes(t))){setTimeout(async()=>{try{if(!X)return;await X.from(`live_chats`).insert([{live_id:t,nickname:`자동응답봇`,content:n.answer,created_at:Date.now().toString()}])}catch(e){console.warn(`Auto-reply failed`,e)}},600);break}}}}).subscribe());let de=null;X&&(de=X.channel(`admin-sync-${t}`).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`live_control`,filter:`live_id=eq.${t}`},e=>{let n=e.new;if(!n)return;o.brandName=n.title||``,o.title=n.subtitle||``;let r=n.profile_image||``,i=`라이브 보기`,a=`right`,s=``,l=!1,u=r.split(`#`),d=u[0];u.slice(1).forEach(e=>{e===`nosplash`||(e.startsWith(`widgetText=`)?i=decodeURIComponent(e.replace(`widgetText=`,``)):e.startsWith(`widgetPosition=`)?a=e.replace(`widgetPosition=`,``):e.startsWith(`widgetImageUrl=`)?s=e.replace(`widgetImageUrl=`,``):e.startsWith(`showOnMain=`)&&(l=e.replace(`showOnMain=`,``)===`true`))}),o.showSplash=!r.includes(`#nosplash`),o.logoUrl=d,o.widgetText=i,o.widgetPosition=a,o.widgetImageUrl=s,o.showOnMain=l,o.streamUrl=n.stream_url||``,o.showViewers=n.show_viewers!==!1,o.thumbnailUrl=n.thumbnail_url||``,o.liveStartTime=n.start_time||``,o.isLive=n.status===`ON`,o.shareTitle=n.share_title||``,o.shareDesc=n.share_desc||``,o.shareImageUrl=n.share_image||``,o.likeImageUrl=n.like_image_url||``,o.bannedWords=n.banned_words||``,o.bannedUsers=n.banned_users||``,n.winner_name!==void 0&&(o.winner_name=n.winner_name),n.winner_timestamp!==void 0&&(o.winner_timestamp=n.winner_timestamp),St(t,o);let f=(e,t)=>{let n=v.querySelector(`#`+e)||document.getElementById(e);n&&document.activeElement!==n&&(n.type===`checkbox`?n.checked=!!t:n.value=t)};f(`cfg-brandName`,o.brandName),f(`cfg-title`,o.title),f(`cfg-stream`,o.streamUrl),f(`cfg-showViewers`,o.showViewers),f(`cfg-liveStartTime`,o.liveStartTime),f(`cfg-shareTitle`,o.shareTitle),f(`cfg-shareDesc`,o.shareDesc),f(`cfg-bannedWords`,o.bannedWords),f(`cfg-bannedUsers`,o.bannedUsers);let p=v.querySelector(`#logo-preview`)||document.getElementById(`logo-preview`);p&&(p.src=o.logoUrl);let m=v.querySelector(`#thumbnail-preview`)||document.getElementById(`thumbnail-preview`);m&&(m.src=o.thumbnailUrl);let h=v.querySelector(`#like-preview`)||document.getElementById(`like-preview`);h&&(h.src=o.likeImageUrl,h.style.display=o.likeImageUrl?`block`:`none`);let g=v.querySelector(`#like-preview-placeholder`)||document.getElementById(`like-preview-placeholder`);g&&(g.style.display=o.likeImageUrl?`none`:`block`);let _=v.querySelector(`#btn-clear-like-icon`)||document.getElementById(`btn-clear-like-icon`);_&&(_.style.display=o.likeImageUrl?`block`:`none`);let y=v.querySelector(`#btn-toggle-live`)||document.getElementById(`btn-toggle-live`);if(y&&document.activeElement!==y&&(y.textContent=o.isLive?`라이브 종료`:`라이브 시작`,y.className=`action-btn ${o.isLive?`btn-danger-solid`:`btn-success-solid`}`),n.products&&Array.isArray(n.products)){let e=JSON.stringify(n.products);if(JSON.stringify(c)!==e){Array.isArray(c)||(c=[]),c.length=0,c.push(...n.products),Et(t,c);let e=v.querySelector(`#product-list-container`)||document.getElementById(`product-list-container`);e&&!e.contains(document.activeElement)&&typeof z==`function`&&(e.innerHTML=z())}}}).subscribe());let fe=b.querySelectorAll(`.tab-btn`),pe=e=>{T.dispatchEvent(new Event(`adminTabLeave`)),fe.forEach(t=>t.classList.toggle(`active`,t.dataset.tab===e)),e===`config`?L():e===`chat`?R():e===`product`?se():e===`leads`&&ce()};fe.forEach(e=>{e.addEventListener(`click`,()=>pe(e.dataset.tab))}),L()}function It(){let e=document.createElement(`div`),t=``;function n(){let r=U.getAll(`hosts`);if(t){let e=t.toLowerCase();r=r.filter(t=>t.name.toLowerCase().includes(e)||t.phone&&t.phone.includes(e))}let i=r.map(e=>{let t=U.getHostStats(e.id);return{...e,stats:t}});e.innerHTML=`
  ...
  `,setTimeout(()=>{t.querySelector(`#btn-edit-finance`)?.addEventListener(`click`,()=>{let i=`
    ...
    `;let w=e.querySelector(`#finance-month-filter`);w&&w.addEventListener(`change`,e=>{t=e.target.value,n()})}return n(),e}function an(e,t={}){if(!e||typeof e!=`string`)return[];let n=t.paymentDate||new Date().toISOString().split(`T`)[0],r=t.groupByRecipient!==!1,i=e.split(/\r?\n/).map(e=>e.trim()).filter(e=>e.length>0);if(i.length===0)return[];let a=i[0],o=`	`;o=a.includes(`	`)?`	`:a.includes(`,`)?`,`:a.includes(`;`)?`;`:/\s+/;let s=[];for(let e=0;e<i.length;e++){let t=i[e],n=[];if(n=o instanceof RegExp?t.split(o):t.split(o).map(e=>e.trim().replace(/^["']|["']$/g,``)),n.length<2||n.some(e=>[`성명`,`이름`,`방송일`,`시작시간`,`종료시간`,`업무상세`,`총 지급액`,`지급액`,`금액`].includes(e.replace(/\s+/g,``))))continue;let r=n[0]||`미지정`,a=n[1]||``,c=n[2]||``,l=n[3]||``,u=n[4]||``,d=n[5]||`0`;if(isNaN(parseInt(d.replace(/[^0-9]/g,``),10))&&n.length>2){let e=n.find((e,t)=>t>0&&/[\d,]+/.test(e)&&!e.includes(`-`)&&!e.includes(`:`));e&&(d=e)}let f=parseInt(d.replace(/[^0-9]/g,``),10)||0,p=Math.floor(f*.033),m=f-p;s.push({id:`item-${e}-${Math.random().toString(36).substr(2,5)}`,name:r,date:a,startTime:c,endTime:l,detail:u,amount:f,tax:p,netAmount:m})}if(s.length===0)return[];if(!r){let e=s.reduce((e,t)=>e+t.amount,0),t=s.reduce((e,t)=>e+t.tax,0),r=e-t;return[{id:`STMT-${Date.now().toString(36)}`,paymentDate:n,recipientName:s[0]?.name||`쇼호스트`,company:{name:`라이진`,bizNo:`821-29-01197`,ceo:`채이준`,email:`choijun@ryzincorp.com`},items:s,totals:{amount:e,tax:t,netAmount:r}}]}let c={};return s.forEach(e=>{let t=e.name;c[t]||(c[t]=[]),c[t].push(e)}),Object.keys(c).map((e,t)=>{let r=c[e],i=r.reduce((e,t)=>e+t.amount,0),a=r.reduce((e,t)=>e+t.tax,0),o=i-a;return{id:`STMT-${Date.now().toString(36)}-${t}`,paymentDate:n,recipientName:e,company:{name:`라이진`,bizNo:`821-29-01197`,ceo:`채이준`,email:`choijun@ryzincorp.com`},items:r,totals:{amount:i,tax:a,netAmount:o}}})}function on(e){try{let t=JSON.stringify(e);return btoa(encodeURIComponent(t).replace(/%([0-9A-F]{2})/g,(e,t)=>String.fromCharCode(`0x`+t))).replace(/\+/g,`-`).replace(/\//g,`_`).replace(/=+$/,``)}catch(e){return console.error(`Payslip encode error:`,e),``}}function sn(){let e=document.createElement(`div`),t=`all`;function n(){let r=U.getAll(`projects`),i=U.getAll(`liveHosts`);U.getAll(`hosts`),U.getAll(`brands`);let a=[];i.forEach(e=>{let t=U.getById(`hosts`,e.hostId)||{name:e.hostName||`미지정 쇼호스트`},n=U.getById(`projects`,e.liveId||e.projectId),r=e.date||n?.date||`2026-04-01`,i=e.brandName||n?.brandName||U.getById(`brands`,n?.brandId)?.name||n?.title||`라이진`,o=e.fee||n?.hostFee||0,s=Math.floor(o*.033),c=o-s,l=e.settleStatus||`pending`;a.push({id:e.id,hostId:e.hostId,hostName:t.name,date:r,month:r.slice(0,7),brandName:i,fee:o,tax:s,netFee:c,settleStatus:l,rawMatching:e})}),r.forEach(e=>{if(e.hostName&&!a.some(t=>t.id===e.id||t.rawMatching?.liveId===e.id)){let t=e.hostFee||1e5,n=Math.floor(t*.033),r=t-n,i=e.date||`2026-04-01`;a.push({id:`proj-host-${e.id}`,hostId:e.hostId||e.hostName,hostName:e.hostName,date:i,month:i.slice(0,7),brandName:e.brandName||e.title||`라이진`,fee:t,tax:n,netFee:r,settleStatus:e.hostSettleStatus||`pending`,rawMatching:null})}});let o=Array.from(new Set(a.map(e=>e.month))).filter(Boolean).sort().reverse();t!==`all`&&!o.includes(t)&&o.length;let s=t===`all`?a:a.filter(e=>e.month===t);s.sort((e,t)=>new Date(t.date)-new Date(e.date));let c=s.reduce((e,t)=>e+t.fee,0),l=s.reduce((e,t)=>e+t.tax,0),u=s.reduce((e,t)=>e+t.netFee,0),d=s.filter(e=>e.settleStatus!==`done`).length;e.innerHTML=`
      <div class="page-header">
        <div class="page-header-left">
          <div>
        ...
        <div class="stats-grid" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: var(--space-4); margin-bottom: var(--space-6);">
          <div class="stat-card" style="background: #fff; padding: 20px; border-radius: 12px; border: 1px solid #e2e8f0;">
            ...
            <div class="stat-value" style="font-size: 24px; font-weight: 700; color: #0f172a; margin-top: 6px;">
              ${s.length}건 <span style="font-size: 13px; font-weight: normal; color: #f59e0b;">(대기 ${d}건)</span>
            </div>
          </div>
        ...
        <div class="card" style="background: #fff; border-radius: 12px; border: 1px solid #e2e8f0; padding: 20px;">
          <div class="card-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
            <div style="display: flex; align-items: center; gap: 10px;">
              ...
              <span class="badge badge-secondary" style="font-size: 12px;">${s.length}개 항목</span>
            </div>
            ${d>0?`
    ...
    `;let f=e.querySelector(`#month-filter-select`);f&&f.addEventListener(`change`,e=>{t=e.target.value,n()}),e.querySelectorAll(`.btn-single-settle`).forEach(e=>{e.addEventListener(`click`,e=>{let t=e.target.dataset.id;i.find(e=>e.id===t)&&U.update(`liveHosts`,t,{settleStatus:`done`}),J(`지급 완료 처리되었습니다.`)})});let p=e.querySelector(`#btn-settle-all-pending`);p&&p.addEventListener(`click`,()=>{confirm(`현재 목록의 지급대기 건을 모두 지급 완료 처리하시겠습니까?`)&&(s.filter(e=>e.settleStatus!==`done`).forEach(e=>{e.rawMatching&&U.update(`liveHosts`,e.rawMatching.id,{settleStatus:`done`})}),J(`전체 지급 완료 처리되었습니다.`))}),e.querySelectorAll(`.btn-generate-single-link`).forEach(e=>{e.addEventListener(`click`,e=>{let t=e.target.dataset.name,n=e.target.dataset.date,r=e.target.dataset.brand,i=parseInt(e.target.dataset.amount,10)||0,a=Math.floor(i*.033),o=i-a,s=on({id:`STMT-${Date.now()}`,paymentDate:n,recipientName:t,company:{name:`라이진`,bizNo:`821-29-01197`,ceo:`채이준`,email:`choijun@ryzincorp.com`},items:[{name:t,date:n,startTime:`10:00`,endTime:`11:00`,detail:r,amount:i,tax:a,netAmount:o}],totals:{amount:i,tax:a,netAmount:o}}),c=`${window.location.origin}/paystmt.html?d=${s}`;navigator.clipboard.writeText(c).then(()=>{J(`${t} 님의 지급명세서 공유 링크가 클립보드에 복사되었습니다.\n\n${c}`)})})});let m=e.querySelector(`#payslip-modal`),h=e.querySelector(`#payslip-date-input`);h.value=new Date().toISOString().split(`T`)[0],e.querySelector(`#btn-open-payslip-modal`).addEventListener(`click`,()=>{m.style.display=`flex`}),e.querySelector(`#btn-close-payslip-modal`).addEventListener(`click`,()=>{m.style.display=`none`}),m.addEventListener(`click`,e=>{e.target===m&&(m.style.display=`none`)}),e.querySelector(`#btn-load-sample`).addEventListener(`click`,()=>{e.querySelector(`#payslip-raw-text`).value=`성명	방송일	시작시간	종료시간	업무상세	총 지급액(원)
정해원	2026-04-02	19:00	20:00	부이	96,700
장서연	2026-04-07	10:00	11:00	트루쿡	96,700
장서연	2026-04-09	10:00	11:00	트루쿡	96,700`,J(`예시 데이터가 입력되었습니다.`)});let g=e.querySelector(`#payslip-file-input`);e.querySelector(`#btn-trigger-file`).addEventListener(`click`,()=>g.click()),g.addEventListener(`change`,t=>{let n=t.target.files[0];if(!n)return;let r=new FileReader;r.onload=t=>{e.querySelector(`#payslip-raw-text`).value=t.target.result,J(`${n.name} 파일을 읽었습니다.`)},r.readAsText(n)}),e.querySelector(`#btn-generate-payslip`).addEventListener(`click`,()=>{let t=e.querySelector(`#payslip-raw-text`).value,n=h.value||new Date().toISOString().split(`T`)[0];if(!t.trim()){Y(`CSV 또는 텍스트 데이터를 입력해주세요.`);return}let r=an(t,{paymentDate:n,groupByRecipient:!0});if(!r||r.length===0){Y(`파싱 가능한 지급 데이터가 없습니다. 형식(성명, 방송일, 시작시간, 종료시간, 업무상세, 총지급액)을 확인해주세요.`);return}let i=e.querySelector(`#payslip-result-area`),a=e.querySelector(`#payslip-cards-list`);a.innerHTML=``,i.style.display=`block`;let o=window.location.origin;r.forEach(e=>{let t=`${o}/paystmt.html?d=${on(e)}`,n=e.totals.netAmount.toLocaleString(`ko-KR`),r=e.totals.amount.toLocaleString(`ko-KR`),i=e.totals.tax.toLocaleString(`ko-KR`),s=document.createElement(`div`);s.style.cssText=`background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 14px; display: flex; flex-direction: column; gap: 10px;`,s.innerHTML=`
          <div style="display: flex; justify-content: space-between; align-items: center;">
            <div style="display: flex; align-items: center; gap: 10px;">
