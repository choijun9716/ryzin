...
`).map(e=>e.trim()).filter(e=>e.includes(`|`)),p.length===0){alert(`닉네임|내용 형식으로 1줄 이상 입력해주세요.`),d=!1;return}f>=p.length&&(f=0),A();let e=parseInt(k.value)||10;u&&clearInterval(u),u=setInterval(async()=>{if(f>=p.length){clearInterval(u),u=null,d=!1,A();return}let[e,...n]=p[f++].split(`|`),r=n.join(`|`).trim();if(!e||!r)return;let i=Date.now(),a=document.createElement(`div`);a.style.cssText=`margin-bottom:8px; padding:6px 0; border-bottom:1px solid #f1f5f9;`,a.innerHTML=`<span style="font-weight:700; color:#64748b;">${e.trim()}:</span> ${r}`,g.innerHTML.includes(`실시간 채팅`)&&(g.innerHTML=``),g.appendChild(a),g.scrollTop=g.scrollHeight;try{if(!Z)return;await Z.from(`live_chats`).insert([{live_id:t,created_at:i,nickname:e.trim(),content:r}])}catch(e){console.warn(`Bot chat failed`,e)}},e*1e3)}else u&&clearInterval(u),u=null,A()});let j=document.getElementById(`auto-reply-active`),M=document.getElementById(`btn-add-ar`),P=document.getElementById(`ar-title`),ee=document.getElementById(`ar-keywords`),te=document.getElementById(`ar-answer`),F=document.getElementById(`ar-list-container`),I=()=>{if(F){if(!l.autoReplyRules||l.autoReplyRules.length===0){F.innerHTML=`<div style="text-align:center; padding:20px; color:#94a3b8; font-size:13px; font-weight:500;">등록된 자동응답 규칙이 없습니다.</div>`;return}F.innerHTML=l.autoReplyRules.map((e,t)=>`
      ...
      `).join(``),F.querySelectorAll(`.btn-del-ar`).forEach(e=>{e.addEventListener(`click`,e=>{let t=parseInt(e.target.dataset.index);l.autoReplyRules.splice(t,1),_(),I()})})}};j&&j.addEventListener(`change`,e=>{l.autoReplyActive=e.target.checked,_()}),M&&M.addEventListener(`click`,()=>{let e=P.value.trim(),t=ee.value.trim(),n=te.value.trim();if(!t||!n){alert(`키워드와 답변 내용을 모두 입력해주세요.`);return}l.autoReplyRules||=[],l.autoReplyRules.push({title:e,keywords:t,answer:n}),_(),P.value=``,ee.value=``,te.value=``,I()}),I();let ne=0,re=null,ie=(e,n,r=!1)=>{g.innerHTML.includes(`실시간 채팅 내역이 여기에`)&&(g.innerHTML=``);let i=document.createElement(`div`);i.style.cssText=`margin-bottom:8px; padding:6px 0; border-bottom:1px solid #f1f5f9; display:flex; justify-content:space-between; align-items:center;`+(r?`opacity:0.72;`:``);let a=e===`관리자`||e.includes(`|`)?`#3b82f6`:`#64748b`,l=e,u=!1;e.includes(`|`)?(l=e.split(`|`)[0],u=!0):e===`관리자`&&(u=!0);let d=!u&&l!==`?`?`<button class="btn-ban-user" data-nickname="${l}" style="background:#ef4444; color:#fff; border:none; border-radius:4px; padding:2px 8px; font-size:11px; font-weight:700; cursor:pointer; margin-left:8px; line-height:1.4; flex-shrink:0;">차단</button>`:``;i.innerHTML=`
        ...
        ${d}
      `;let f=i.querySelector(`.btn-ban-user`);f&&f.addEventListener(`click`,e=>{e.stopPropagation();let n=f.dataset.nickname;if(confirm(`📡 [${n}] 시청자를 차단하시겠습니까?\n차단 이후에는 이 시청자의 채팅 전송이 제한됩니다.`)){let e=o.bannedUsers?o.bannedUsers.split(`,`).map(e=>e.trim()).filter(e=>e):[];e.includes(n)||(e.push(n),o.bannedUsers=e.join(`,`),m(),At(t,o,s,c,!0),alert(`[${n}] 님이 정상 차단되었습니다.`),N())}}),g.appendChild(i),r||(g.scrollTop=g.scrollHeight)},ae=async()=>{if(Z)try{let{data:e,error:n}=await Z.from(`live_chats`).select(`*`).eq(`live_id`,t).order(`created_at`,{ascending:!1}).limit(300);if(n)throw n;e&&Array.isArray(e)&&(e.reverse().forEach(e=>{ie(e.nickname||`?`,e.content||``,!0),ne=parseInt(e.created_at)||0}),setTimeout(()=>{g.scrollTop=g.scrollHeight},100))}catch(e){console.warn(`Failed to load chat history`,e)}};window.updateAdminViewersDisplay=()=>{let e=document.getElementById(`cfg-viewers-display`);e&&(e.innerHTML=`${(s.viewers+(s.cumViewers||0)).toLocaleString()}명 <span style="font-size:11px; font-weight:normal; color:#64748b; margin-left:4px;">(방송+수동: ${s.viewers.toLocaleString()}, 누적: ${(s.cumViewers||0).toLocaleString()})</span>`);let t=document.getElementById(`cfg-cumViewers`);t&&(t.value=s.cumViewers||0);let n=document.getElementById(`cfg-hearts`);n&&(n.value=s.hearts||0)};let oe=null;ae(),Z&&(re=Z.channel(`admin-chat-ui-channel-${t}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`live_chats`,filter:`live_id=eq.${t}`},e=>{let t=e.new;t&&parseInt(t.created_at)>ne&&(ie(t.nickname||`?`,t.content||``,!1),ne=parseInt(t.created_at))}).subscribe()),Z&&(oe=setInterval(async()=>{try{let{data:e,error:n}=await Z.from(`live_control`).select(`viewers, cum_viewers, hearts`).eq(`live_id`,t).maybeSingle();e&&!n&&(s.viewers=parseInt(e.viewers)||0,s.cumViewers=parseInt(e.cum_viewers)||0,s.hearts=parseInt(e.hearts)||0,typeof window.updateAdminViewersDisplay==`function`&&window.updateAdminViewersDisplay())}catch{}},3e3)),T.addEventListener(`adminTabLeave`,()=>{re&&Z.removeChannel(re),oe&&clearInterval(oe),w&&clearInterval(w)});let L=document.getElementById(`btn-winner-start`),R=document.getElementById(`btn-winner-cancel`),z=o.winner_name&&o.winner_name.startsWith(`구매인증`)?`구매인증`:`소통왕`,se=T.querySelectorAll(`.type-segment-btn`);se.forEach(e=>{e.addEventListener(`click`,()=>{se.forEach(e=>{e.classList.remove(`active`),e.style.background=`transparent`,e.style.color=`#64748b`}),e.classList.add(`active`),e.style.background=`#3b82f6`,e.style.color=`#fff`,z=e.dataset.type})}),L&&L.addEventListener(`click`,async()=>{let e=document.getElementById(`winner-announce-text`).value.trim(),n=parseInt(document.getElementById(`winner-announce-min`).value)||1;if(!e){alert(`당첨자 닉네임을 입력해 주세요.`);return}L.disabled=!0,L.textContent=`적용 중...`;let r=`${z}|${e}`,i=Date.now()+n*60*1e3;try{if(!Z)return;let{error:e}=await Z.from(`live_control`).update({winner_name:r,winner_timestamp:i,updated_at:new Date().toISOString()}).eq(`live_id`,t);if(e)throw e;o.winner_name=r,o.winner_timestamp=i,N()}catch{alert(`시작 처리에 실패했습니다.`)}finally{L.disabled=!1,L.textContent=`시작`}}),R&&R.addEventListener(`click`,async()=>{R.disabled=!0,R.textContent=`종료 중...`;try{if(!Z)return;let{error:e}=await Z.from(`live_control`).update({winner_timestamp:0,updated_at:new Date().toISOString()}).eq(`live_id`,t);if(e)throw e;o.winner_timestamp=0,N()}catch{alert(`종료 처리에 실패했습니다.`)}finally{R.disabled=!1,R.textContent=`종료`}})},P=()=>c.map((e,t)=>{let n=e.clicks||0;return`
...
`+e.message)}finally{o&&(o.style.opacity=`1`)}})}),n.querySelectorAll(`.btn-deal-start`).forEach(r=>{r.addEventListener(`click`,r=>{let i=parseInt(r.target.dataset.idx),a=parseInt(document.getElementById(`deal-min-${i}`).value);a>0&&(c[i].dealText=document.getElementById(`deal-text-${i}`).value||`깜짝딜 종료까지`,c[i].dealEndTime=Date.now()+a*60*1e3,g(),n.innerHTML=P(),e(),At(t,o,s,c,!0),setTimeout(()=>alert(`${a}분 깜짝딜이 시작되었습니다!`),10))})}),n.querySelectorAll(`.btn-deal-cancel`).forEach(r=>{r.addEventListener(`click`,r=>{let i=parseInt(r.target.dataset.idx);c[i].dealEndTime=0,g(),n.innerHTML=P(),e(),At(t,o,s,c,!0)})}),n.querySelectorAll(`.btn-del-product`).forEach(t=>{t.addEventListener(`click`,t=>{let r=parseInt(t.target.dataset.idx),i=c[r]?.name||`이 상품`;confirm(`정말 "${i}" 상품을 삭제하시겠습니까?`)&&(c.splice(r,1),g(),n.innerHTML=P(),e())})}),n.querySelectorAll(`.btn-move-up`).forEach(t=>{t.addEventListener(`click`,t=>{let r=parseInt(t.target.dataset.idx);if(r>0){let t=c[r-1];c[r-1]=c[r],c[r]=t,g(),n.innerHTML=P(),e()}})}),n.querySelectorAll(`.btn-move-down`).forEach(t=>{t.addEventListener(`click`,t=>{let r=parseInt(t.target.dataset.idx);if(r<c.length-1){let t=c[r+1];c[r+1]=c[r],c[r]=t,g(),n.innerHTML=P(),e()}})})};e(),document.getElementById(`btn-add-product`).addEventListener(`click`,()=>{c.push({id:Date.now(),name:`새 상품`,price:``,normalPrice:``,discountRate:0,image:`https://via.placeholder.com/72`,url:`#`}),g(),document.getElementById(`product-list-container`).innerHTML=P(),e()}),document.getElementById(`btn-save-products`).addEventListener(`click`,()=>{At(t,o,s,c,!0),alert(`상품 목록이 적용되었습니다!`)})},te=()=>{T.innerHTML=`
      <div class="section-card">
        <div style="display:flex; justify-content:space-between; align-items:center; padding-bottom:16px; border-bottom:1.5px solid #f1f5f9; margin-bottom:20px;">
...
`;e.forEach(e=>{let t=new Date(e.created_at).toLocaleString(`ko-KR`).replace(/,/g,``),r=(e.name||``).replace(/,/g,` `),i=(e.phone||``).replace(/,/g,` `);n+=`${t},${r},${i}\n`});let r=new Blob([`﻿`+n],{type:`text/csv;charset=utf-8;`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=`상담DB_${t}.csv`,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(i)})},F=v.querySelector(`#btn-back`);F&&F.addEventListener(`click`,()=>{T.dispatchEvent(new Event(`adminTabLeave`)),w(),u&&clearInterval(u),re&&Z.removeChannel(re),ne&&Z.removeChannel(ne),n(null)});let I=v.querySelector(`#btn-refresh-preview`);I&&I.addEventListener(`click`,()=>{let e=v.querySelector(`#live-preview-iframe`);e&&(e.src=D)});let ne=null;Z&&(ne=Z.channel(`bot-sync-${t}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`live_chats`,filter:`live_id=eq.${t}`},e=>{let n=e.new;if(n&&l.autoReplyActive&&l.autoReplyRules&&l.autoReplyRules.length>0){let e=n.nickname||``;if(!e.includes(`|`)&&e!==`관리자`&&e!==`자동응답봇`){let e=(n.content||``).toLowerCase();for(let n of l.autoReplyRules)if(n.keywords.split(`,`).map(e=>e.trim().toLowerCase()).filter(e=>e).some(t=>e.includes(t))){setTimeout(async()=>{try{if(!Z)return;await Z.from(`live_chats`).insert([{live_id:t,nickname:`자동응답봇`,content:n.answer,created_at:Date.now().toString()}])}catch(e){console.warn(`Auto-reply failed`,e)}},600);break}}}}).subscribe());let re=null;Z&&(re=Z.channel(`admin-sync-${t}`).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`live_control`,filter:`live_id=eq.${t}`},e=>{let n=e.new;if(!n)return;o.brandName=n.title||``,o.title=n.subtitle||``;let r=n.profile_image||``;o.showSplash=!r.includes(`#nosplash`),o.logoUrl=r.replace(`#nosplash`,``),o.streamUrl=n.stream_url||``,o.showViewers=n.show_viewers!==!1,o.thumbnailUrl=n.thumbnail_url||``,o.liveStartTime=n.start_time||``,o.isLive=n.status===`ON`,o.shareTitle=n.share_title||``,o.shareDesc=n.share_desc||``,o.shareImageUrl=n.share_image||``,o.likeImageUrl=n.like_image_url||``,o.bannedWords=n.banned_words||``,o.bannedUsers=n.banned_users||``,n.winner_name!==void 0&&(o.winner_name=n.winner_name),n.winner_timestamp!==void 0&&(o.winner_timestamp=n.winner_timestamp),xt(t,o);let i=(e,t)=>{let n=v.querySelector(`#`+e)||document.getElementById(e);n&&document.activeElement!==n&&(n.type===`checkbox`?n.checked=!!t:n.value=t)};i(`cfg-brandName`,o.brandName),i(`cfg-title`,o.title),i(`cfg-stream`,o.streamUrl),i(`cfg-showViewers`,o.showViewers),i(`cfg-liveStartTime`,o.liveStartTime),i(`cfg-shareTitle`,o.shareTitle),i(`cfg-shareDesc`,o.shareDesc),i(`cfg-bannedWords`,o.bannedWords),i(`cfg-bannedUsers`,o.bannedUsers);let a=v.querySelector(`#logo-preview`)||document.getElementById(`logo-preview`);a&&(a.src=o.logoUrl);let s=v.querySelector(`#thumbnail-preview`)||document.getElementById(`thumbnail-preview`);s&&(s.src=o.thumbnailUrl);let l=v.querySelector(`#like-preview`)||document.getElementById(`like-preview`);l&&(l.src=o.likeImageUrl,l.style.display=o.likeImageUrl?`block`:`none`);let u=v.querySelector(`#like-preview-placeholder`)||document.getElementById(`like-preview-placeholder`);u&&(u.style.display=o.likeImageUrl?`none`:`block`);let d=v.querySelector(`#btn-clear-like-icon`)||document.getElementById(`btn-clear-like-icon`);d&&(d.style.display=o.likeImageUrl?`block`:`none`);let f=v.querySelector(`#btn-toggle-live`)||document.getElementById(`btn-toggle-live`);if(f&&document.activeElement!==f&&(f.textContent=o.isLive?`라이브 종료`:`라이브 시작`,f.className=`action-btn ${o.isLive?`btn-danger-solid`:`btn-success-solid`}`),n.products&&Array.isArray(n.products)){let e=JSON.stringify(n.products);if(JSON.stringify(c)!==e){Array.isArray(c)||(c=[]),c.length=0,c.push(...n.products),Tt(t,c);let e=v.querySelector(`#product-list-container`)||document.getElementById(`product-list-container`);e&&!e.contains(document.activeElement)&&typeof P==`function`&&(e.innerHTML=P())}}}).subscribe());let ie=b.querySelectorAll(`.tab-btn`),ae=e=>{T.dispatchEvent(new Event(`adminTabLeave`)),ie.forEach(t=>t.classList.toggle(`active`,t.dataset.tab===e)),e===`config`?M():e===`chat`?N():e===`product`?ee():e===`leads`&&te()};ie.forEach(e=>{e.addEventListener(`click`,()=>ae(e.dataset.tab))}),M()}function Ft(){let e=document.createElement(`div`),t=``;function n(){let r=U.getAll(`hosts`);if(t){let e=t.toLowerCase();r=r.filter(t=>t.name.toLowerCase().includes(e)||t.phone&&t.phone.includes(e))}let i=r.map(e=>{let t=U.getHostStats(e.id);return{...e,stats:t}});e.innerHTML=`
  ...
  `,i=document.createElement(`div`);if(i.style.cssText=`display: flex; gap: var(--space-3); justify-content: flex-end; width: 100%;`,t){let t=document.createElement(`button`);t.className=`btn btn-danger`,t.textContent=`삭제`,t.style.marginRight=`auto`,t.addEventListener(`click`,()=>{J(),ot({title:`브랜드 삭제`,message:`"${n.name}" 브랜드를 삭제하시겠습니까?`,confirmText:`삭제`,danger:!0,onConfirm:()=>{U.delete(`brands`,e),Y(`브랜드가 삭제되었습니다.`)}})}),i.appendChild(t)}let a=document.createElement(`button`);a.className=`btn btn-secondary`,a.textContent=`취소`,a.addEventListener(`click`,J);let o=document.createElement(`button`);o.className=`btn btn-primary`,o.textContent=t?`수정`:`등록`,o.addEventListener(`click`,()=>{let n=document.getElementById(`brand-name`).value.trim();if(!n){X(`브랜드명을 입력해주세요.`);return}let r={name:n,companyName:document.getElementById(`brand-company`).value.trim(),category:document.getElementById(`brand-category`).value,manager:document.getElementById(`brand-manager`).value.trim(),phone:document.getElementById(`brand-phone`).value.trim(),email:document.getElementById(`brand-email`).value.trim(),businessNo:document.getElementById(`brand-biz`).value.trim(),taxInvoice:document.getElementById(`brand-tax`).value===`true`,address:document.getElementById(`brand-address`).value.trim(),memo:document.getElementById(`brand-memo`).value.trim()};t?(U.update(`brands`,e,r),Y(`브랜드 정보가 수정되었습니다.`)):(r.id=L(`brand`),r.createdAt=new Date().toISOString().split(`T`)[0],U.create(`brands`,r),Y(`브랜드가 등록되었습니다.`)),J()}),i.appendChild(a),i.appendChild(o),q({title:t?`브랜드 수정`:`브랜드 등록`,size:`lg`,content:r,footer:i})}function Ht(e){let t=document.createElement(`div`),n=U.getById(`brands`,e.id);if(!n)return t.innerHTML=`<div class="page-header"><div class="page-header-left"><h1 class="page-title">브랜드를 찾을 수 없습니다</h1></div></div>
  ...
  `,setTimeout(()=>{n.querySelector(`#btn-edit-info`)?.addEventListener(`click`,()=>{Jt(e)}),n.querySelectorAll(`.status-change-btn`).forEach(t=>{t.addEventListener(`click`,()=>{let n=t.getAttribute(`data-status`);U.update(`projects`,e.id,{broadcastStatus:n}),Y(`방송 상태가 "${R(n)}"(으)로 변경되었습니다.`),M.navigate(`/projects/${e.id}`)})}),n.querySelectorAll(`.settle-status-change-btn`).forEach(t=>{t.addEventListener(`click`,()=>{let n=t.getAttribute(`data-status`);U.update(`projects`,e.id,{settleStatus:n}),Y(`정산 상태가 "${z(n)}"(으)로 변경되었습니다.`),M.navigate(`/projects/${e.id}`)})}),n.querySelector(`.tax-invoice-btn`)?.addEventListener(`click`,()=>{if(!t){X(`등록된 브랜드 정보가 없어 세금계산서 상태를 변경할 수 없습니다.`);return}let n=!t.taxInvoice;U.update(`brands`,t.id,{taxInvoice:n}),Y(`세금계산서 상태가 "${n?`발행완료`:`미발행`}"(으)로 변경되었습니다.`),M.navigate(`/projects/${e.id}`)})},0),n}function Jt(e){let t=U.getAll(`brands`),n=`
    <div class="form-grid">
      <div class="input-group">
...
`;return typeof a==`function`&&a(null,p),p}}));o((e=>{var t=vi(),n=Vi(),r=Ui(),i=Wi();function a(e,r,i,a,o){let s=[].slice.call(arguments,1),c=s.length,l=typeof s[c-1]==`function`;if(!l&&!t())throw Error(`Callback required as last argument`);if(l){if(c<2)throw Error(`Too few arguments provided`);c===2?(o=i,i=r,r=a=void 0):c===3&&(r.getContext&&o===void 0?(o=a,a=void 0):(o=a,a=i,i=r,r=void 0))}else{if(c<1)throw Error(`Too few arguments provided`);return c===1?(i=r,r=a=void 0):c===2&&!r.getContext&&(a=i,i=r,r=void 0),new Promise(function(t,o){try{t(e(n.create(i,a),r,a))}catch(e){o(e)}})}try{let t=n.create(i,a);o(null,e(t,r,a))}catch(e){o(e)}}e.create=n.create,e.toCanvas=a.bind(null,r.render),e.toDataURL=a.bind(null,r.renderToDataURL),e.toString=a.bind(null,function(e,t,n){return i.render(e,n)})}))();function Gi(){U.isDemoMode&&(localStorage.setItem(`ryzin_is_demo_mode`,`false`),U.isDemoMode=!1,U.STORAGE_KEY=`livecommerce_erp_data`,U._load());let e=document.createElement(`div`);return e.className=`login-container`,e.innerHTML=`
  ...
  `,e.appendChild(t)}function aa(e){return String(e||``).replace(/&/g,`&amp;`).replace(/"/g,`&quot;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function oa(e,t=!1){let n=document.createElement(`div`);n.textContent=e,n.style.cssText=`position:fixed;bottom:28px;left:50%;transform:translateX(-50%);
    background:${t?`#ef4444`:`#0f172a`};color:#fff;padding:12px 24px;
    border-radius:40px;font-size:13px;font-weight:600;z-index:9999;
    box-shadow:0 8px 24px rgba(0,0,0,0.3);`,document.body.appendChild(n),setTimeout(()=>n.remove(),2200)}function sa(e,t,n,r=`text`,i=!1){return`<div${i?` style="grid-column:span 2;"`:``}>
    <label class="sm-label">${aa(e)}</label>
    <input class="sm-input ${t}" type="${r}" value="${aa(n)}">
  </div>`}function ca(e,t,n){return`<div style="grid-column:span 2;">
    <label class="sm-label">${aa(e)}</label>
    <div style="display:flex;gap:8px;">
      <input class="sm-input ${t}" value="${aa(n)}">
      <button class="sm-action-btn sm-btn-neutral ${t}-preview" type="button">미리보기</button>
    </div>
  </div>`}var la=`banners`,ua=[];function da(){let e=document.createElement(`div`);e.style.cssText=`display:flex; flex-direction:column; height:calc(100vh - 48px); background:#f8fafc; overflow:hidden;`,ia(e);let t=document.createElement(`div`);return t.style.cssText=`max-width:960px; margin:0 auto; padding:40px 24px; width:100%; overflow-y:auto; height:100%; box-sizing:border-box;`,t.innerHTML=`
    ...
    <div id="sm-tabs" style="display:flex; gap:8px; margin-bottom:28px; border-bottom:1.5px solid #e2e8f0; padding-bottom:12px;">
      ${[`banners`,`lives`,`sections`,`menus`].map(e=>`<button class="sm-tab-btn${e===la?` active`:``}" data-tab="${e}">${{banners:`상단 배너`,lives:`라이브 NOW`,sections:`상품 섹션`,menus:`퀵메뉴`}[e]}</button>`).join(``)}
    </div>
  ...
  `,t.querySelectorAll(`.sm-tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{la=e.dataset.tab,t.querySelectorAll(`.sm-tab-btn`).forEach(e=>{e.classList.toggle(`active`,e.dataset.tab===la)}),fa(t)})}),e.appendChild(t),setTimeout(async()=>{try{ua=await ea.getAll()}catch{ua=[]}await fa(t)},0),e}async function fa(e){let t=e.querySelector(`#sm-loading`),n=e.querySelector(`#sm-panel`);t.style.display=`block`,n.innerHTML=``;try{la===`banners`?await pa(n):la===`lives`?await ma(n):la===`sections`?await ha(n,e):la===`menus`&&await _a(n)}catch(e){n.innerHTML=`
    ...
    `}t.style.display=`none`}async function pa(e){let t=await $i.getAll();e.innerHTML=`
  ...
  `,e.querySelector(`#add-banner`).addEventListener(`click`,async()=>{await $i.insert({sort_order:99,title:`새 특집 배너`,desc:``,label:`오늘`,time_text:`오후 8시`,img_url:``,link_url:`/shop/live_teaser.html`}),oa(`새 배너가 생성되었습니다.`),await pa(e)});let n=e.querySelector(`#banner-list`);t.forEach((r,i)=>{let a=document.createElement(`div`);a.className=`sm-card`,a.innerHTML=`
      <div style="display:flex; gap:20px; align-items:flex-start; flex-wrap:wrap;">
        <div style="width:140px; flex-shrink:0;">
          <label class="sm-label">배너 프리뷰</label>
          <img class="b-thumb" src="${aa(r.img_url)}" style="width:100%; height:94px; object-fit:cover; border-radius:10px; border:1.5px solid #e2e8f0; background:#f1f5f9;">
        </div>
        <div style="flex:1; min-width:280px; display:grid; grid-template-columns:1fr 1fr; gap:12px;">
          ${sa(`배너 대제목 (타이틀)`,`b-title`,r.title)}
          ${sa(`소제목 (서브 타이틀)`,`b-desc`,r.desc)}
          ${sa(`라벨 뱃지 (예: 오늘, 내일)`,`b-label`,r.label)}
          ${sa(`시간 문구 (예: 오후 8시)`,`b-time`,r.time_text)}
          ${ca(`배너 이미지 URL`,`b-img`,r.img_url)}
          ${sa(`클릭 시 이동할 링크 URL`,`b-link`,r.link_url,`text`,!0)}
        </div>
      </div>
    ...
    `,a.querySelector(`.b-img-preview`).addEventListener(`click`,()=>{a.querySelector(`.b-thumb`).src=a.querySelector(`.b-img`).value.trim()}),a.querySelector(`.b-save`).addEventListener(`click`,async()=>{await $i.update(r.id,{title:a.querySelector(`.b-title`).value.trim(),desc:a.querySelector(`.b-desc`).value.trim(),label:a.querySelector(`.b-label`).value.trim(),time_text:a.querySelector(`.b-time`).value.trim(),img_url:a.querySelector(`.b-img`).value.trim(),link_url:a.querySelector(`.b-link`).value.trim()}),oa(`배너 정보가 동기화되었습니다.`)}),a.querySelector(`.b-del`).addEventListener(`click`,async()=>{confirm(`배너를 삭제하시겠습니까?`)&&(await $i.delete(r.id),oa(`배너가 제거되었습니다.`),await pa(e))}),a.querySelector(`.b-up`).addEventListener(`click`,async()=>{i!==0&&(await $i.update(t[i-1].id,{sort_order:i}),await $i.update(r.id,{sort_order:i-1}),await pa(e))}),a.querySelector(`.b-dn`).addEventListener(`click`,async()=>{i!==t.length-1&&(await $i.update(t[i+1].id,{sort_order:i}),await $i.update(r.id,{sort_order:i+1}),await pa(e))}),n.appendChild(a)})}async function ma(e){let t=await ra.getAll();e.innerHTML=`
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
  ...
  `,e.querySelector(`#add-live`).addEventListener(`click`,async()=>{await ra.insert({sort_order:99,title:`새로운 라이브 방송`,viewers:`0명 시청 중`,img_url:``,link_url:``}),oa(`새 라이브가 생성되었습니다.`),await ma(e)});let n=e.querySelector(`#live-list`);t.forEach((t,r)=>{let i=document.createElement(`div`);i.className=`sm-card`,i.innerHTML=`
      <div style="display:flex; gap:20px; align-items:flex-start; flex-wrap:wrap;">
        <div style="width:140px; flex-shrink:0;">
          <label class="sm-label">방송 썸네일</label>
          <img class="lv-thumb" src="${aa(t.img_url)}" style="width:100%; height:94px; object-fit:cover; border-radius:10px; border:1.5px solid #e2e8f0; background:#f1f5f9;">
        </div>
        <div style="flex:1; min-width:280px; display:grid; grid-template-columns:1fr 1fr; gap:12px;">
          ${sa(`방송 타이틀`,`lv-title`,t.title,`text`,!0)}
          ${sa(`시청자 수 문구`,`lv-viewers`,t.viewers)}
          ${sa(`이동 링크 URL`,`lv-link`,t.link_url)}
          ${ca(`썸네일 이미지 URL`,`lv-img`,t.img_url)}
        </div>
      </div>
    ...
    `,i.querySelector(`.lv-img-preview`).addEventListener(`click`,()=>{i.querySelector(`.lv-thumb`).src=i.querySelector(`.lv-img`).value.trim()}),i.querySelector(`.lv-save`).addEventListener(`click`,async()=>{await ra.update(t.id,{title:i.querySelector(`.lv-title`).value.trim(),viewers:i.querySelector(`.lv-viewers`).value.trim(),link_url:i.querySelector(`.lv-link`).value.trim(),img_url:i.querySelector(`.lv-img`).value.trim()}),oa(`라이브 제어 카드 저장 완료`)}),i.querySelector(`.lv-del`).addEventListener(`click`,async()=>{confirm(`라이브 정보를 삭제합니까?`)&&(await ra.delete(t.id),oa(`제거되었습니다.`),await ma(e))}),n.appendChild(i)})}async function ha(e,t){ua=await ea.getAll();let n=await na.getAll(),r={};n.forEach(e=>{r[e.section_id]||(r[e.section_id]=[]),r[e.section_id].push(e)}),e.innerHTML=`
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
      <h2 style="font-size:16px; font-weight:700; color:#0f172a; margin:0;">상설관 및 기획전 상품 섹션 (${ua.length}개)</h2>
      <button id="add-section" class="sm-action-btn sm-btn-primary">+ 새 상품 섹션 추가</button>
    </div>
    <div id="section-list"></div>
  `,e.querySelector(`#add-section`).addEventListener(`click`,async()=>{await ea.insert({sort_order:99,title:`새로운 추천 기획전`,subtitle:`단독 특별 혜택가 구성`,show_timer:!1}),ua=await ea.getAll(),oa(`새 상품 섹션이 생성되었습니다.`),await ha(e,t)});let i=e.querySelector(`#section-list`);ua.forEach((n,a)=>{let o=r[n.id]||[],s=document.createElement(`div`);s.className=`sm-card`,s.style.cssText=`padding:0; overflow:hidden; margin-bottom:28px; border-color:#cbd5e1;`,s.innerHTML=`
      <!-- 섹션 바디 헤더 -->
      <div style="padding:20px 24px; background:#f8fafc; border-bottom:1.5px solid #e2e8f0; display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
        ...
        <div style="flex:1; min-width:240px; display:flex; gap:10px;">
          <input class="sm-input sec-title" value="${aa(n.title)}" placeholder="섹션 주제목" style="font-weight:700;">
          <input class="sm-input sec-sub" value="${aa(n.subtitle)}" placeholder="섹션 부제목(설명)">
        </div>
    ...
    `,s.querySelector(`.sec-save`).addEventListener(`click`,async()=>{await ea.update(n.id,{title:s.querySelector(`.sec-title`).value.trim(),subtitle:s.querySelector(`.sec-sub`).value.trim(),show_timer:s.querySelector(`.sec-timer`).checked}),ua=await ea.getAll(),oa(`섹션이 저장되었습니다.`)}),s.querySelector(`.sec-del`).addEventListener(`click`,async()=>{confirm(`"${n.title}" 섹션 및 섹션 내 모든 등록 상품을 삭제하시겠습니까?`)&&(await ea.delete(n.id),ua=await ea.getAll(),oa(`섹션이 삭제되었습니다.`),await ha(e,t))}),s.querySelector(`.add-prod`).addEventListener(`click`,async()=>{await na.insert({section_id:n.id,sort_order:99,brand_title:`신규 특별 제안 상품`,sale_price:`0원`,origin_price:`0원`,discount:`특가`,unit_price:``,rating:`5.0`,reviews:`1`,img_url:``,chips:`[]`}),oa(`새 상품 입력란이 하단에 추가되었습니다.`),await ha(e,t)}),ga(s.querySelector(`.prod-list`),o,e,t),i.appendChild(s)})}function ga(e,t,n,r){if(e.innerHTML=``,t.length===0){e.innerHTML=`<div style="text-align:center; padding:32px 0; color:#94a3b8; font-size:13px;">등록된 특가 상품이 없습니다. 오른쪽의 '상품 추가' 버튼을 눌러주세요.</div>`;return}t.forEach((t,i)=>{let a=document.createElement(`div`);a.style.cssText=`display:flex; gap:16px; align-items:flex-start; padding:18px; border-radius:12px; border:1.5px solid #e2e8f0; background:#fafafa; margin-bottom:12px;`,a.innerHTML=`
      <div style="width:90px; flex-shrink:0;">
        <label class="sm-label">상품 사진</label>
        <img class="p-thumb" src="${aa(t.img_url)}" style="width:100%; height:74px; object-fit:cover; border-radius:8px; border:1.5px solid #e2e8f0; background:#f1f5f9;">
      </div>
      <div style="flex:1; display:grid; grid-template-columns:1fr 1fr; gap:10px;">
        ${sa(`브랜드 및 상품명`,`p-name`,t.brand_title,`text`,!0)}
        ${sa(`현재 판매가 (예: 9,900원)`,`p-sale`,t.sale_price)}
        ${sa(`원래 정가 (예: 50,000원)`,`p-origin`,t.origin_price)}
        ${sa(`할인율 태그 (예: 80% 특가)`,`p-disc`,t.discount)}
        ${sa(`단가 정보 (예: 10ml 당 708원)`,`p-unit`,t.unit_price)}
        ${sa(`평점 (예: 4.8)`,`p-rating`,t.rating)}
        ${sa(`리뷰 수 (예: 124)`,`p-reviews`,t.reviews)}
        ${ca(`상품 이미지 URL`,`p-img`,t.img_url)}
      </div>
    ...
    `,a.querySelector(`.p-img-preview`).addEventListener(`click`,()=>{a.querySelector(`.p-thumb`).src=a.querySelector(`.p-img`).value.trim()}),a.querySelector(`.p-save`).addEventListener(`click`,async()=>{await na.update(t.id,{brand_title:a.querySelector(`.p-name`).value.trim(),sale_price:a.querySelector(`.p-sale`).value.trim(),origin_price:a.querySelector(`.p-origin`).value.trim(),discount:a.querySelector(`.p-disc`).value.trim(),unit_price:a.querySelector(`.p-unit`).value.trim(),rating:a.querySelector(`.p-rating`).value.trim(),reviews:a.querySelector(`.p-reviews`).value.trim(),img_url:a.querySelector(`.p-img`).value.trim()}),oa(`상품 정보 동기화 성공`)}),a.querySelector(`.p-del`).addEventListener(`click`,async()=>{confirm(`상품을 삭제하시겠습니까?`)&&(await na.delete(t.id),oa(`제거되었습니다.`),await ha(n,r))}),e.appendChild(a)})}async function _a(e){let[t,n]=await Promise.all([ta.getAll(),ea.getAll()]);ua=n;let r=`<option value="">-- 섹션 연결 안함 --</option>`+n.map(e=>`<option value="${e.id}">${aa(e.title)}</option>`).join(``);e.innerHTML=`
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
  ...
  `,e.querySelector(`#add-menu`).addEventListener(`click`,async()=>{await ta.insert({sort_order:99,name:`새 카테고리 탭`,section_id:null}),oa(`새 탭이 추가되었습니다.`),await _a(e)});let i=e.querySelector(`#menu-list`);t.forEach((t,n)=>{let a=document.createElement(`div`);a.className=`sm-card`,a.style.cssText=`padding:16px 20px; display:flex; align-items:center; gap:16px; flex-wrap:wrap; margin-bottom:12px;`,a.innerHTML=`
      ...
      <div style="flex:1; min-width:200px;">
        ...
        <input class="sm-input m-name" value="${aa(t.name)}" placeholder="메뉴 이름" style="font-weight:600;">
      </div>
    ...
    `;let o=a.querySelector(`.m-sec`);o.value=t.section_id||``,a.querySelector(`.m-save`).addEventListener(`click`,async()=>{await ta.update(t.id,{name:a.querySelector(`.m-name`).value.trim(),section_id:o.value||null}),oa(`저장 완료`)}),a.querySelector(`.m-del`).addEventListener(`click`,async()=>{confirm(`이 탭 메뉴를 삭제하시겠습니까?`)&&(await ta.delete(t.id),oa(`삭제되었습니다.`),await _a(e))}),i.appendChild(a)})}x(),j();async function va(){let e=document.getElementById(`app`);if(e.innerHTML=`
