...
`;e.forEach(e=>{let t=new Date(e.created_at).toLocaleString(`ko-KR`).replace(/,/g,``),r=(e.name||``).replace(/,/g,` `),i=(e.phone||``).replace(/,/g,` `);n+=`${t},${r},${i}\n`});let r=new Blob([`﻿`+n],{type:`text/csv;charset=utf-8;`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=`상담DB_${t}.csv`,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(i)})},le=v.querySelector(`#btn-back`);le&&le.addEventListener(`click`,()=>{T.dispatchEvent(new Event(`adminTabLeave`)),w(),u&&clearInterval(u),de&&X.removeChannel(de),ue&&X.removeChannel(ue),n(null)});let B=v.querySelector(`#btn-refresh-preview`);B&&B.addEventListener(`click`,()=>{let e=v.querySelector(`#live-preview-iframe`);e&&(e.src=D)});let ue=null;X&&(ue=X.channel(`bot-sync-${t}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`live_chats`,filter:`live_id=eq.${t}`},e=>{let n=e.new;if(n&&l.autoReplyActive&&l.autoReplyRules&&l.autoReplyRules.length>0){let e=n.nickname||``;if(!e.includes(`|`)&&e!==`관리자`&&e!==`자동응답봇`){let e=(n.content||``).toLowerCase();for(let n of l.autoReplyRules)if(n.keywords.split(`,`).map(e=>e.trim().toLowerCase()).filter(e=>e).some(t=>e.includes(t))){setTimeout(async()=>{try{if(!X)return;await X.from(`live_chats`).insert([{live_id:t,nickname:`자동응답봇`,content:n.answer,created_at:Date.now().toString()}])}catch(e){console.warn(`Auto-reply failed`,e)}},600);break}}}}).subscribe());let de=null;X&&(de=X.channel(`admin-sync-${t}`).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`live_control`,filter:`live_id=eq.${t}`},e=>{let n=e.new;if(!n)return;o.brandName=n.title||``,o.title=n.subtitle||``;let r=n.profile_image||``,i=`라이브 보기`,a=`right`,s=``,l=!1,u=r.split(`#`),d=u[0];u.slice(1).forEach(e=>{e===`nosplash`||(e.startsWith(`widgetText=`)?i=decodeURIComponent(e.replace(`widgetText=`,``)):e.startsWith(`widgetPosition=`)?a=e.replace(`widgetPosition=`,``):e.startsWith(`widgetImageUrl=`)?s=e.replace(`widgetImageUrl=`,``):e.startsWith(`showOnMain=`)&&(l=e.replace(`showOnMain=`,``)===`true`))}),o.showSplash=!r.includes(`#nosplash`),o.logoUrl=d,o.widgetText=i,o.widgetPosition=a,o.widgetImageUrl=s,o.showOnMain=l,o.streamUrl=n.stream_url||``,o.showViewers=n.show_viewers!==!1,o.thumbnailUrl=n.thumbnail_url||``,o.liveStartTime=n.start_time||``,o.isLive=n.status===`ON`,o.shareTitle=n.share_title||``,o.shareDesc=n.share_desc||``,o.shareImageUrl=n.share_image||``,o.likeImageUrl=n.like_image_url||``,o.bannedWords=n.banned_words||``,o.bannedUsers=n.banned_users||``,n.winner_name!==void 0&&(o.winner_name=n.winner_name),n.winner_timestamp!==void 0&&(o.winner_timestamp=n.winner_timestamp),St(t,o);let f=(e,t)=>{let n=v.querySelector(`#`+e)||document.getElementById(e);n&&document.activeElement!==n&&(n.type===`checkbox`?n.checked=!!t:n.value=t)};f(`cfg-brandName`,o.brandName),f(`cfg-title`,o.title),f(`cfg-stream`,o.streamUrl),f(`cfg-showViewers`,o.showViewers),f(`cfg-liveStartTime`,o.liveStartTime),f(`cfg-shareTitle`,o.shareTitle),f(`cfg-shareDesc`,o.shareDesc),f(`cfg-bannedWords`,o.bannedWords),f(`cfg-bannedUsers`,o.bannedUsers);let p=v.querySelector(`#logo-preview`)||document.getElementById(`logo-preview`);p&&(p.src=o.logoUrl);let m=v.querySelector(`#thumbnail-preview`)||document.getElementById(`thumbnail-preview`);m&&(m.src=o.thumbnailUrl);let h=v.querySelector(`#like-preview`)||document.getElementById(`like-preview`);h&&(h.src=o.likeImageUrl,h.style.display=o.likeImageUrl?`block`:`none`);let g=v.querySelector(`#like-preview-placeholder`)||document.getElementById(`like-preview-placeholder`);g&&(g.style.display=o.likeImageUrl?`none`:`block`);let _=v.querySelector(`#btn-clear-like-icon`)||document.getElementById(`btn-clear-like-icon`);_&&(_.style.display=o.likeImageUrl?`block`:`none`);let y=v.querySelector(`#btn-toggle-live`)||document.getElementById(`btn-toggle-live`);if(y&&document.activeElement!==y&&(y.textContent=o.isLive?`라이브 종료`:`라이브 시작`,y.className=`action-btn ${o.isLive?`btn-danger-solid`:`btn-success-solid`}`),n.products&&Array.isArray(n.products)){let e=JSON.stringify(n.products);if(JSON.stringify(c)!==e){Array.isArray(c)||(c=[]),c.length=0,c.push(...n.products),Et(t,c);let e=v.querySelector(`#product-list-container`)||document.getElementById(`product-list-container`);e&&!e.contains(document.activeElement)&&typeof z==`function`&&(e.innerHTML=z())}}}).subscribe());let fe=b.querySelectorAll(`.tab-btn`),pe=e=>{T.dispatchEvent(new Event(`adminTabLeave`)),fe.forEach(t=>t.classList.toggle(`active`,t.dataset.tab===e)),e===`config`?L():e===`chat`?R():e===`product`?se():e===`leads`&&ce()};fe.forEach(e=>{e.addEventListener(`click`,()=>pe(e.dataset.tab))}),L()}function It(){let e=document.createElement(`div`),t=``;function n(){let r=U.getAll(`hosts`);if(t){let e=t.toLowerCase();r=r.filter(t=>t.name.toLowerCase().includes(e)||t.phone&&t.phone.includes(e))}let i=r.map(e=>{let t=U.getHostStats(e.id);return{...e,stats:t}});e.innerHTML=`
  ...
  `,setTimeout(()=>{t.querySelector(`#btn-edit-finance`)?.addEventListener(`click`,()=>{let i=`
    ...
    `;let p=e.querySelector(`#month-filter-select`);p&&p.addEventListener(`change`,e=>{t=e.target.value,n()});let m={};c.forEach(e=>{let t=`${e.hostName}__${e.month}`;m[t]||(m[t]={hostName:e.hostName,month:e.month,items:[]}),m[t].items.push(e)});let h=Object.values(m).sort((e,t)=>e.month===t.month?e.hostName.localeCompare(t.hostName,`ko`):t.month.localeCompare(e.month)),g=e.querySelector(`#settle-tbody`);g&&(h.length===0?g.innerHTML=`<tr><td colspan="8" class="text-center" style="padding:40px;color:#94a3b8;">선택한 조건의 정산 내역이 없습니다.</td></tr>`:(g.innerHTML=``,h.forEach((e,t)=>{let n=e.items.reduce((e,t)=>e+t.fee,0),r=e.items.reduce((e,t)=>e+t.tax,0),i=e.items.reduce((e,t)=>e+t.netFee,0),a=e.items.every(e=>e.settleStatus===`done`),o=`${e.hostName}__${e.month}`,s=e.items.length>1,c=[...new Set(e.items.map(e=>e.brandName))],l=c.length>1?`${c[0]} 외 ${c.length-1}건`:c[0],u=e.items[0].date,d=s?`${u} (${e.items.length}건)`:u,f=document.createElement(`tr`);f.className=`group-main-row`,f.style.cssText=`border-bottom: 1px solid #e2e8f0; cursor: pointer; background: #ffffff; transition: background 0.15s;`,f.dataset.grpKey=o,f.innerHTML=`
            <td style="padding: 12px; font-weight: 700; color: #0f172a; display: flex; align-items: center; gap: 8px;">
              ${s?`<span class="expand-icon" style="font-size: 10px; color: #64748b; transition: transform 0.2s; display: inline-block;">▶</span>`:`<span style="font-size: 10px; opacity: 0;">▶</span>`}
              <span>${e.hostName}</span>
            </td>
            <td style="padding: 12px; text-align: center; color: #475569; font-size: 13px;">${d}</td>
            <td style="padding: 12px; font-weight: 500; color: #334155;">${l}</td>
            <td style="padding: 12px; text-align: right; font-weight: 600; color: #0f172a;">${n.toLocaleString(`ko-KR`)}</td>
            <td style="padding: 12px; text-align: right; color: #dc2626; font-weight: 500;">${r.toLocaleString(`ko-KR`)}</td>
            <td style="padding: 12px; text-align: right; color: #2563eb; font-weight: 700;">${i.toLocaleString(`ko-KR`)}</td>
            <td style="padding: 12px; text-align: center;">
              ${a?`<span class="badge badge-success" style="background:#dcfce7;color:#166534;font-size:11px;padding:4px 8px;border-radius:12px;">지급완료</span>`:`<span class="badge badge-warning" style="background:#fef3c7;color:#92400e;font-size:11px;padding:4px 8px;border-radius:12px;">지급대기</span>`}
            </td>
            <td style="padding: 12px; text-align: center;">
              <div style="display: flex; gap: 6px; justify-content: center;" onclick="event.stopPropagation();">
                ${a?``:`<button class="btn btn-xs btn-secondary btn-settle-group" data-grp-key="${o}" style="padding:4px 8px;font-size:11px;">전체 지급완료</button>`}
                <button class="btn btn-xs btn-primary btn-generate-month-link" data-grp-key="${o}" style="padding:4px 8px;font-size:11px;">명세서 링크</button>
              </div>
            </td>
          `,g.appendChild(f),e.items.forEach(e=>{let t=document.createElement(`tr`);t.className=`sub-row-${o}`,t.style.cssText=`display: none; background: #f8fafc; border-bottom: 1px solid #edf2f7; font-size: 13px;`,t.innerHTML=`
              <td style="padding: 12px 12px 12px 32px; color: #64748b; font-size: 12px;">
                <span style="color: #cbd5e1; margin-right: 4px;">└</span> 방송 건별
              </td>
              <td style="padding: 12px; text-align: center; color: #475569;">${e.date}</td>
              <td style="padding: 12px; color: #334155;">${e.brandName}</td>
              <td style="padding: 12px; text-align: right; color: #475569;">${e.fee.toLocaleString(`ko-KR`)}</td>
              <td style="padding: 12px; text-align: right; color: #dc2626;">${e.tax.toLocaleString(`ko-KR`)}</td>
              <td style="padding: 12px; text-align: right; color: #2563eb; font-weight: 600;">${e.netFee.toLocaleString(`ko-KR`)}</td>
              <td style="padding: 12px; text-align: center;">
                ${e.settleStatus===`done`?`<span style="color:#166534; font-size:11px;">완료</span>`:`<span style="color:#92400e; font-size:11px;">대기</span>`}
              </td>
              <td style="padding: 12px; text-align: center;">
                ${e.settleStatus===`done`?``:`<button class="btn btn-xs btn-secondary btn-single-settle" data-id="${e.id}" style="padding:2px 6px;font-size:10px;" onclick="event.stopPropagation();">지급완료</button>`}
              </td>
            `,g.appendChild(t)}),f.addEventListener(`click`,()=>{let e=g.querySelectorAll(`.sub-row-${o}`),t=f.querySelector(`.expand-icon`),n=e[0]&&e[0].style.display!==`none`;e.forEach(e=>{e.style.display=n?`none`:`table-row`}),t&&(t.style.transform=n?`rotate(0deg)`:`rotate(90deg)`),f.style.background=n?`#ffffff`:`#f1f5f9`})}))),e.querySelectorAll(`.btn-settle-group`).forEach(e=>{e.addEventListener(`click`,e=>{e.stopPropagation();let t=m[e.target.dataset.grpKey];t&&confirm(`${t.hostName} 님 ${t.month} 전체 ${t.items.length}건을 지급완료 처리하시겠습니까?`)&&(t.items.forEach(e=>{e.rawMatching&&U.update(`liveHosts`,e.rawMatching.id,{settleStatus:`done`})}),J(`${t.hostName} 님 ${t.month} 지급완료 처리되었습니다.`))})}),e.querySelectorAll(`.btn-single-settle`).forEach(e=>{e.addEventListener(`click`,e=>{e.stopPropagation();let t=e.target.dataset.id;U.update(`liveHosts`,t,{settleStatus:`done`}),J(`지급 완료 처리되었습니다.`)})}),e.querySelectorAll(`.btn-generate-month-link`).forEach(e=>{e.addEventListener(`click`,e=>{e.stopPropagation();let t=m[e.target.dataset.grpKey];if(!t)return;let n=t.items.map(e=>({name:e.hostName,date:e.date,detail:e.brandName,amount:e.fee,tax:e.tax,netAmount:e.netFee})),r=t.items.reduce((e,t)=>e+t.fee,0),i=t.items.reduce((e,t)=>e+t.tax,0),a=r-i,o=on({id:`STMT-${Date.now()}`,paymentDate:new Date().toISOString().slice(0,10),month:t.month,recipientName:t.hostName,company:{name:`라이진`,bizNo:`821-29-01197`,ceo:`채이준`,email:`choijun@ryzincorp.com`},items:n,totals:{amount:r,tax:i,netAmount:a}}),s=`${window.location.origin}/paystmt.html?d=${o}`,c=t.month?t.month.replace(`-`,`년 `)+`월`:``,l=t.items.length;navigator.clipboard.writeText(s).then(()=>{J(`${t.hostName} 님 ${c} 명세서 (${l}건 포함) 링크 복사 완료!`)})})});let _=e.querySelector(`#btn-settle-all-pending`);_&&_.addEventListener(`click`,()=>{confirm(`현재 목록의 지급대기 건을 모두 지급 완료 처리하시겠습니까?`)&&(c.filter(e=>e.settleStatus!==`done`).forEach(e=>{e.rawMatching&&U.update(`liveHosts`,e.rawMatching.id,{settleStatus:`done`})}),J(`전체 지급 완료 처리되었습니다.`))}),e.querySelectorAll(`.btn-generate-single-link`).forEach(e=>{e.addEventListener(`click`,e=>{let t=e.target.dataset.name,n=e.target.dataset.date,r=e.target.dataset.brand,i=parseInt(e.target.dataset.amount,10)||0,a=Math.floor(i*.033),o=i-a,s=on({id:`STMT-${Date.now()}`,paymentDate:n,recipientName:t,company:{name:`라이진`,bizNo:`821-29-01197`,ceo:`채이준`,email:`choijun@ryzincorp.com`},items:[{name:t,date:n,startTime:`10:00`,endTime:`11:00`,detail:r,amount:i,tax:a,netAmount:o}],totals:{amount:i,tax:a,netAmount:o}}),c=`${window.location.origin}/paystmt.html?d=${s}`;navigator.clipboard.writeText(c).then(()=>{J(`${t} 님의 지급명세서 공유 링크가 클립보드에 복사되었습니다.\n\n${c}`)})})});let v=e.querySelector(`#payslip-modal`),y=e.querySelector(`#payslip-date-input`);y.value=new Date().toISOString().split(`T`)[0],e.querySelector(`#btn-open-payslip-modal`).addEventListener(`click`,()=>{v.style.display=`flex`}),e.querySelector(`#btn-close-payslip-modal`).addEventListener(`click`,()=>{v.style.display=`none`}),v.addEventListener(`click`,e=>{e.target===v&&(v.style.display=`none`)}),e.querySelector(`#btn-load-sample`).addEventListener(`click`,()=>{e.querySelector(`#payslip-raw-text`).value=`성명	방송일	시작시간	종료시간	업무상세	총 지급액(원)
정해원	2026-04-02	19:00	20:00	부이	96,700
장서연	2026-04-07	10:00	11:00	트루쿡	96,700
