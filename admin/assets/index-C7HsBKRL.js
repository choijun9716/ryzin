...
`;return typeof a==`function`&&a(null,p),p}}));o((e=>{var t=bi(),n=Ui(),r=Gi(),i=Ki();function a(e,r,i,a,o){let s=[].slice.call(arguments,1),c=s.length,l=typeof s[c-1]==`function`;if(!l&&!t())throw Error(`Callback required as last argument`);if(l){if(c<2)throw Error(`Too few arguments provided`);c===2?(o=i,i=r,r=a=void 0):c===3&&(r.getContext&&o===void 0?(o=a,a=void 0):(o=a,a=i,i=r,r=void 0))}else{if(c<1)throw Error(`Too few arguments provided`);return c===1?(i=r,r=a=void 0):c===2&&!r.getContext&&(a=i,i=r,r=void 0),new Promise(function(t,o){try{t(e(n.create(i,a),r,a))}catch(e){o(e)}})}try{let t=n.create(i,a);o(null,e(t,r,a))}catch(e){o(e)}}e.create=n.create,e.toCanvas=a.bind(null,r.render),e.toDataURL=a.bind(null,r.renderToDataURL),e.toString=a.bind(null,function(e,t,n){return i.render(e,n)})}))();function qi(){H.isDemoMode&&(localStorage.setItem(`ryzin_is_demo_mode`,`false`),H.isDemoMode=!1,H.STORAGE_KEY=`livecommerce_erp_data`,H._load());let e=document.createElement(`div`);return e.className=`login-container`,e.innerHTML=`
  ...
  `}var fa=`products`,pa=[],ma=[];function ha(){let e=document.createElement(`div`);e.style.cssText=`min-height:100vh; background:#f8fafc; padding:24px; color:#0f172a; font-family:"Pretendard",sans-serif;`,oa(e);let t=document.createElement(`div`);return t.style.cssText=`max-width:1100px; margin:0 auto;`,t.innerHTML=`
    ...
    <div style="display:flex; gap:8px; margin-bottom:20px; border-bottom:1px solid #e2e8f0; padding-bottom:10px; overflow-x:auto;">
      ${[{key:`products`,label:`상품 관리`},{key:`sections`,label:`기획전 관리`},{key:`banners`,label:`탑배너 관리`},{key:`menus`,label:`퀵메뉴 관리`}].map(e=>`<button class="sm-tab-btn${e.key===fa?` active`:``}" data-tab="${e.key}">${e.label}</button>`).join(``)}
    </div>
  ...
  `,t.querySelectorAll(`.sm-tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{fa=e.dataset.tab,t.querySelectorAll(`.sm-tab-btn`).forEach(e=>{e.classList.toggle(`active`,e.dataset.tab===fa)}),ga(t)})}),t.querySelector(`#btn-refresh`).addEventListener(`click`,()=>{Q(`데이터를 새로고침합니다.`),ga(t)}),e.appendChild(t),setTimeout(async()=>{try{pa=await na.getAll()}catch{pa=[]}await ga(t)},0),e}async function ga(e){let t=e.querySelector(`#sm-loading`),n=e.querySelector(`#sm-panel`);t.style.display=`block`,n.innerHTML=``;try{ma=await ia.getAll(),fa===`products`?await _a(n,e):fa===`sections`?await ba(n,e):fa===`banners`?await xa(n):fa===`menus`&&await Sa(n)}catch(e){n.innerHTML=`
    ...
    `}t.style.display=`none`}async function _a(e,t){e.innerHTML=`
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px; flex-wrap:wrap; gap:12px;">
      <div>
        <h2 style="font-size:16px; font-weight:800; color:#0f172a; margin:0 0 4px 0;">전체 상품 리스트 (${ma.length}개 등록)</h2>
  ...
  `;let n=e.querySelector(`#prod-table-body`),r=e.querySelector(`#prod-search-input`);function i(){let e=r.value.trim().toLowerCase(),i=ma.filter(t=>{let n=(t.product_code||``).toLowerCase(),r=(t.product_title||t.brand_title||``).toLowerCase(),i=(t.brand_name||``).toLowerCase();return!e||n.includes(e)||r.includes(e)||i.includes(e)});if(!i.length){n.innerHTML=`<tr><td colspan="8" style="text-align:center; padding:30px; color:#94a3b8;">검색된 상품이 없습니다.</td></tr>`;return}n.innerHTML=i.map(e=>{let t=e.product_code||aa(),n=e.badge_color||`#ef4444`,r=e.best_rank&&e.best_rank>0?`RANK #${e.best_rank}`:`-`;return`
        <tr>
      ...
      `}).join(``),n.querySelectorAll(`.btn-edit-prod`).forEach(e=>{e.addEventListener(`click`,()=>{let n=ma.find(t=>t.id===e.dataset.id);n&&va(n,t)})}),n.querySelectorAll(`.btn-del-prod`).forEach(e=>{e.addEventListener(`click`,async()=>{confirm(`이 상품을 삭제하시겠습니까?`)&&(await ia.delete(e.dataset.id),Q(`삭제되었습니다.`),await ga(t))})})}r.addEventListener(`input`,i),i(),e.querySelector(`#btn-open-add-modal`).addEventListener(`click`,()=>{va(null,t)})}function va(e,t){let n=!!e,r=e&&e.product_code||aa(),i=t.querySelector(`#sm-modal-container`),a=e&&e.badge_color||`#ef4444`,o=e&&e.best_rank||0;i.innerHTML=`
        ...
        <form id="modal-prod-form" style="display:grid; grid-template-columns:1fr 1fr; gap:12px;">
          ...
          <div>
            ...
            <select class="sm-input" id="m-psection" style="font-weight:700; cursor:pointer; height:37px;">
              ...
              ${pa.map(t=>`<option value="${t.id}" ${e&&e.section_id===t.id?`selected`:``}>${$(t.title)}</option>`).join(``)}
            </select>
          </div>
          ${ua(`브랜드명 (예: 설화수)`,`m-bname`,e?e.brand_name:``)}
          ${ua(`상품명 (예: 윤조 에센스 90ml)`,`m-ptitle`,e?e.product_title||e.brand_title:``)}
          ${ua(`판매가 (예: 9,900원)`,`m-sale`,e?e.sale_price:``)}
          ${ua(`원래 정가 (예: 50,000원)`,`m-origin`,e?e.origin_price:``)}
          ${ua(`할인 태그 (예: 80% 특가)`,`m-disc`,e?e.discount:``)}
          <div>
  ...
  `;let r=()=>{n.innerHTML=``};n.querySelector(`#search-modal-close`).addEventListener(`click`,r);let i=n.querySelector(`#modal-search-keyword`),a=n.querySelector(`#search-result-list`);function o(){let e=i.value.trim().toLowerCase(),n=ma.filter(t=>{let n=(t.product_code||``).toLowerCase(),r=(t.product_title||t.brand_title||``).toLowerCase(),i=(t.brand_name||``).toLowerCase();return!e||n.includes(e)||r.includes(e)||i.includes(e)});if(!n.length){a.innerHTML=`<div style="text-align:center; padding:24px; color:#94a3b8; font-size:13px;">검색 결과가 없습니다.</div>`;return}a.innerHTML=n.map(e=>`
    ...
    `).join(``),a.querySelectorAll(`.search-item-card`).forEach(e=>{e.addEventListener(`click`,()=>{let n=ma.find(t=>t.id===e.dataset.id);n&&(t(n),r())})})}i.addEventListener(`input`,o),o()}async function ba(e,t){pa=await na.getAll();let n=ma,r={};n.forEach(e=>{r[e.section_id]||(r[e.section_id]=[]),r[e.section_id].push(e)}),e.innerHTML=`
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px;">
      <h2 style="font-size:15px; font-weight:800; color:#0f172a; margin:0;">기획전 관리 (${pa.length}개 섹션)</h2>
      <button id="add-sec" class="sm-action-btn sm-btn-primary">+ 새 기획전 섹션 추가</button>
    </div>
    <div id="section-list"></div>
  `,e.querySelector(`#add-sec`).addEventListener(`click`,async()=>{await na.insert({sort_order:99,title:`새 기획전 섹션`,subtitle:`단독 특가로 만나보세요`,show_timer:!1}),Q(`새 기획전 섹션이 생성되었습니다.`),await ba(e,t)});let i=e.querySelector(`#section-list`);pa.forEach(n=>{let a=r[n.id]||[],o=document.createElement(`div`);o.className=`sm-card`,o.innerHTML=`
  ...
  `,e.querySelector(`#add-banner`).addEventListener(`click`,async()=>{await ta.insert({sort_order:99,title:`새 기획 배너`,desc:``,label:`오늘`,time_text:`오후 8시`,img_url:``,link_url:`/shop/live_teaser.html`}),Q(`새 배너가 추가되었습니다.`),await xa(e)});let n=e.querySelector(`#banner-list`);t.forEach(t=>{let r=document.createElement(`div`);r.className=`sm-card`,r.innerHTML=`
      <div style="display:flex; gap:16px; align-items:flex-start; flex-wrap:wrap;">
        ...
        <div style="flex:1; min-width:260px; display:grid; grid-template-columns:1fr 1fr; gap:10px;">
          ${ua(`배너 대제목`,`b-title`,t.title)}
          ${ua(`서브 설명`,`b-desc`,t.desc)}
          ${ua(`라벨 (예: 오늘, 내일)`,`b-label`,t.label)}
          ${ua(`시간 문구 (예: 오후 8시)`,`b-time`,t.time_text)}
          ${da(`이미지 URL`,`b-img`,t.img_url)}
          ${ua(`이동 링크 URL`,`b-link`,t.link_url,`text`,!0)}
        </div>
      </div>
    ...
    `,la(r.querySelector(`.b-uploader`),r.querySelector(`.b-img`),e=>{r.querySelector(`.b-thumb`).src=e}),r.querySelector(`.b-img-preview`).addEventListener(`click`,()=>{r.querySelector(`.b-thumb`).src=r.querySelector(`.b-img`).value.trim()}),r.querySelector(`.b-save`).addEventListener(`click`,async()=>{await ta.update(t.id,{title:r.querySelector(`.b-title`).value.trim(),desc:r.querySelector(`.b-desc`).value.trim(),label:r.querySelector(`.b-label`).value.trim(),time_text:r.querySelector(`.b-time`).value.trim(),img_url:r.querySelector(`.b-img`).value.trim(),link_url:r.querySelector(`.b-link`).value.trim()}),Q(`배너 저장 완료`)}),r.querySelector(`.b-del`).addEventListener(`click`,async()=>{confirm(`배너를 삭제합니까?`)&&(await ta.delete(t.id),Q(`삭제되었습니다.`),await xa(e))}),n.appendChild(r)})}async function Sa(e){let[t,n]=await Promise.all([ra.getAll(),na.getAll()]);pa=n;let r=`<option value="">-- 기획전 섹션 연결 안함 --</option>`+n.map(e=>`<option value="${e.id}">${$(e.title)}</option>`).join(``);e.innerHTML=`
