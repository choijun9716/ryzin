...
`;return typeof a==`function`&&a(null,p),p}}));o((e=>{var t=Xr(),n=yi(),r=xi(),i=Si();function a(e,r,i,a,o){let s=[].slice.call(arguments,1),c=s.length,l=typeof s[c-1]==`function`;if(!l&&!t())throw Error(`Callback required as last argument`);if(l){if(c<2)throw Error(`Too few arguments provided`);c===2?(o=i,i=r,r=a=void 0):c===3&&(r.getContext&&o===void 0?(o=a,a=void 0):(o=a,a=i,i=r,r=void 0))}else{if(c<1)throw Error(`Too few arguments provided`);return c===1?(i=r,r=a=void 0):c===2&&!r.getContext&&(a=i,i=r,r=void 0),new Promise(function(t,o){try{t(e(n.create(i,a),r,a))}catch(e){o(e)}})}try{let t=n.create(i,a);o(null,e(t,r,a))}catch(e){o(e)}}e.create=n.create,e.toCanvas=a.bind(null,r.render),e.toDataURL=a.bind(null,r.renderToDataURL),e.toString=a.bind(null,function(e,t,n){return i.render(e,n)})}))();function Ci(){H.isDemoMode&&(localStorage.setItem(`ryzin_is_demo_mode`,`false`),H.isDemoMode=!1,H.STORAGE_KEY=`livecommerce_erp_data`,H._load());let e=document.createElement(`div`);return e.className=`login-container`,e.innerHTML=`
  ...
  `,!await H.init()){e.innerHTML=`
    ...
    `;return}let t=()=>{if(e.querySelector(`.sidebar`))return;e.innerHTML=``,e.className=`app-layout`,e.appendChild(Ae());let t=document.createElement(`div`);t.className=`mobile-overlay`,t.onclick=()=>document.querySelector(`.sidebar`).classList.remove(`open`),e.appendChild(t);let n=document.createElement(`button`);n.className=`mobile-menu-btn`,n.innerHTML=`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>`,n.onclick=()=>document.querySelector(`.sidebar`).classList.toggle(`open`),e.appendChild(n);let r=document.createElement(`main`);r.className=`main-content`,r.id=`page-content`,e.appendChild(r),u.setContainer(r)};u.beforeEach(n=>{let r=!!H.getCurrentUser();return!r&&n!==`/login`?`/login`:r&&n===`/login`?`/`:(n===`/login`?(e.innerHTML=``,e.className=``,u.setContainer(e)):t(),!0)}),u.register(`/login`,()=>Ci()),u.register(`/`,()=>Ue()),u.register(`/live_stream`,()=>ut()),u.register(`/projects`,()=>St()),u.register(`/projects/new`,()=>St()),u.register(`/projects/:id`,e=>wt(e)),u.register(`/hosts`,()=>pt()),u.register(`/hosts/:id`,e=>ht(e)),u.register(`/brands`,()=>vt()),u.register(`/brands/:id`,e=>bt(e)),u.register(`/finance`,()=>Pt()),u.register(`/settlement`,()=>Ft()),u.register(`/contracts`,()=>Rt()),u.register(`/marketing`,()=>Ht()),u.register(`/crm`,()=>Ut()),u.register(`/settings`,()=>Wt()),u.start(),document.addEventListener(`click`,e=>{let t=e.target.closest(`a[href]`);t&&t.getAttribute(`href`).startsWith(`/`)&&!t.getAttribute(`target`)&&(e.preventDefault(),u.navigate(t.getAttribute(`href`)))})}wi();