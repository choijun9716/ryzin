...
`))},a=(e,t,n,r=.82)=>new Promise((i,a)=>{let o=new Image;o.src=URL.createObjectURL(e),o.onload=()=>{let e=o.width,a=o.height;e>a?e>t&&(a=Math.round(a*t/e),e=t):a>n&&(e=Math.round(e*n/a),a=n);let s=document.createElement(`canvas`);s.width=e,s.height=a,s.getContext(`2d`).drawImage(o,0,0,e,a);let c=s.toDataURL(`image/jpeg`,r);URL.revokeObjectURL(o.src),i(c.split(`,`)[1])},o.onerror=e=>{URL.revokeObjectURL(o.src),a(e)}});window[`live_loaded_${t}`]===void 0&&(window[`live_loaded_${t}`]=!1);let o=bt(t)||{},s=St(t),c=wt(t),l=Et(t),u=null,d=!1,f=0,p=[];Z&&!window[`live_loaded_${t}`]?Z.from(`live_control`).select(`*`).eq(`live_id`,t).maybeSingle().then(({data:e,error:r})=>{if(!r&&e){let r=vt().findIndex(e=>e.id===t),i=r===-1?1:r+1;o={brandName:e.title||`라이브 ${i}`,title:e.subtitle||`단독 특가 라이브 방송 중!`,streamUrl:e.stream_url||``,logoUrl:(e.profile_image||``).replace(`#nosplash`,``),showSplash:!(e.profile_image||``).endsWith(`#nosplash`),thumbnailUrl:e.thumbnail_url||``,liveStartTime:e.start_time||``,showViewers:e.show_viewers!==!1,isLive:e.status===`ON`,botEnabled:!1,shareTitle:e.share_title||``,shareDesc:e.share_desc||``,shareImageUrl:e.share_image||``,likeImageUrl:e.like_image_url||``},s={viewers:e.viewers||0,hearts:e.hearts||0,cumViewers:e.cum_viewers||0},e.products&&(c=typeof e.products==`string`?JSON.parse(e.products):e.products),xt(t,o),Ct(t,s),Tt(t,c),window[`live_loaded_${t}`]=!0,n(t)}else window[`live_loaded_${t}`]=!0}).catch(()=>{window[`live_loaded_${t}`]=!0}):window[`live_loaded_${t}`]=!0;let m=()=>{xt(t,o),At(t,o,s,c)},h=()=>{Ct(t,s),At(t,o,s,c)},g=()=>{Tt(t,c),At(t,o,s,c)},_=()=>Dt(t,l),v=document.createElement(`div`);v.style.cssText=`display:flex; gap:0; height:100%; overflow:hidden;`;let y=document.createElement(`div`);y.style.cssText=`flex:1; display:flex; flex-direction:column; overflow:hidden;`;let b=document.createElement(`div`);b.style.cssText=`display:flex; align-items:center; gap:18px; padding:18px 28px; background:#fff; border-bottom:1.5px solid #e2e8f0; flex-shrink:0;`;let x=o.isLive?`<span style="font-size:10px; font-weight:800; color:#ef4444; background:#fee2e2; border:1px solid #fecaca; padding:2px 6px; border-radius:4px; white-space:nowrap; height:16px; display:inline-flex; align-items:center; gap:4px;"><span style="width:5px; height:5px; background:#ef4444; border-radius:50%; display:inline-block;"></span>라이브 중</span>`:`<span style="font-size:10px; font-weight:800; color:#64748b; background:#f1f5f9; border:1px solid #e2e8f0; padding:2px 6px; border-radius:4px; white-space:nowrap; height:16px; display:inline-flex; align-items:center;">송출 대기</span>`,S=o.isLive?`<div id="onair-timer-wrapper" style="display:inline-flex; align-items:center; gap:6px; font-size:12px; font-weight:700; color:#ef4444; background:#fef2f2; padding:4px 10px; border-radius:6px; border:1px solid #fecaca; white-space:nowrap;"> <div style="width:6px; height:6px; background:#ef4444; border-radius:50%; box-shadow:0 0 0 2px #fee2e2;"></div> 방송 중 <span id="onair-timer-text" style="font-family:monospace; margin-left:2px; letter-spacing:0.02em;">00:00:00</span> </div>`:``;b.innerHTML=`
  ...
  `,v.appendChild(E),e.appendChild(v);let k=(e,t)=>{let n=document.getElementById(e),r=document.getElementById(t);!n||!r||navigator.clipboard.writeText(n.value).then(()=>{r.textContent=`복사됨!`,r.style.background=`#22c55e`,setTimeout(()=>{r.textContent=`복사`,r.style.background=`#3b82f6`},2e3)}).catch(()=>{n.select(),document.execCommand(`copy`),r.textContent=`복사됨!`,r.style.background=`#22c55e`,setTimeout(()=>{r.textContent=`복사`,r.style.background=`#3b82f6`},2e3)})};document.getElementById(`btn-copy-embed-mobile`).addEventListener(`click`,()=>k(`embed-url-mobile`,`btn-copy-embed-mobile`)),document.getElementById(`btn-copy-embed-wide`).addEventListener(`click`,()=>k(`embed-url-wide`,`btn-copy-embed-wide`));let A=()=>{T.innerHTML=`
...
`).map(e=>e.trim()).filter(e=>e.includes(`|`)),p.length===0){alert(`닉네임|내용 형식으로 1줄 이상 입력해주세요.`),d=!1;return}f=0,A();let e=parseInt(k.value)||10;u&&clearInterval(u),u=setInterval(async()=>{if(f>=p.length){clearInterval(u),u=null,d=!1,A();return}let[e,...n]=p[f++].split(`|`),r=n.join(`|`).trim();if(!e||!r)return;let i=Date.now(),a=document.createElement(`div`);a.style.cssText=`margin-bottom:8px; padding:6px 0; border-bottom:1px solid #f1f5f9;`,a.innerHTML=`<span style="font-weight:700; color:#64748b;">${e.trim()}:</span> ${r}`,g.innerHTML.includes(`실시간 채팅`)&&(g.innerHTML=``),g.appendChild(a),g.scrollTop=g.scrollHeight;try{if(!Z)return;await Z.from(`live_chats`).insert([{live_id:t,created_at:i,nickname:e.trim(),content:r}])}catch(e){console.warn(`Bot chat failed`,e)}},e*1e3)}else u&&clearInterval(u),u=null,A()});let M=0,N=null,P=(e,n,r=!1)=>{g.innerHTML.includes(`실시간 채팅 내역이 여기에`)&&(g.innerHTML=``);let i=document.createElement(`div`);i.style.cssText=`margin-bottom:8px; padding:6px 0; border-bottom:1px solid #f1f5f9; display:flex; justify-content:space-between; align-items:center;`+(r?`opacity:0.72;`:``);let a=e===`관리자`||e.includes(`|`)?`#3b82f6`:`#64748b`,l=e,u=!1;e.includes(`|`)?(l=e.split(`|`)[0],u=!0):e===`관리자`&&(u=!0);let d=!u&&l!==`?`?`<button class="btn-ban-user" data-nickname="${l}" style="background:#ef4444; color:#fff; border:none; border-radius:4px; padding:2px 8px; font-size:11px; font-weight:700; cursor:pointer; margin-left:8px; line-height:1.4; flex-shrink:0;">차단</button>`:``;i.innerHTML=`
        <div style="flex:1; min-width:0; word-break:break-all; font-size:13px;">
          <span style="font-weight:700; color:${a};">${l}:</span> ${n}
        </div>
        ${d}
      `;let f=i.querySelector(`.btn-ban-user`);f&&f.addEventListener(`click`,e=>{e.stopPropagation();let n=f.dataset.nickname;if(confirm(`📡 [${n}] 시청자를 차단하시겠습니까?\n차단 이후에는 이 시청자의 채팅 전송이 제한됩니다.`)){let e=o.bannedUsers?o.bannedUsers.split(`,`).map(e=>e.trim()).filter(e=>e):[];e.includes(n)||(e.push(n),o.bannedUsers=e.join(`,`),m(),At(t,o,s,c,!0),alert(`[${n}] 님이 정상 차단되었습니다.`),j())}}),g.appendChild(i),r||(g.scrollTop=g.scrollHeight)},ee=async()=>{if(Z)try{let{data:e,error:n}=await Z.from(`live_chats`).select(`*`).eq(`live_id`,t).order(`created_at`,{ascending:!0}).limit(100);if(n)throw n;e&&Array.isArray(e)&&(e.forEach(e=>{P(e.nickname||`?`,e.content||``,!0),M=parseInt(e.created_at)||0}),setTimeout(()=>{g.scrollTop=g.scrollHeight},100))}catch(e){console.warn(`Failed to load chat history`,e)}};window.updateAdminViewersDisplay=()=>{let e=document.getElementById(`cfg-viewers-display`);e&&(e.innerHTML=`${(s.viewers+(s.cumViewers||0)).toLocaleString()}명 <span style="font-size:11px; font-weight:normal; color:#64748b; margin-left:4px;">(방송+수동: ${s.viewers.toLocaleString()}, 누적: ${(s.cumViewers||0).toLocaleString()})</span>`);let t=document.getElementById(`cfg-cumViewers`);t&&(t.value=s.cumViewers||0);let n=document.getElementById(`cfg-hearts`);n&&(n.value=s.hearts||0)};let te=null;ee(),Z&&(N=Z.channel(`admin-chat-channel-${t}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`live_chats`,filter:`live_id=eq.${t}`},e=>{let t=e.new;t&&parseInt(t.created_at)>M&&(P(t.nickname||`?`,t.content||``,!1),M=parseInt(t.created_at))}).subscribe()),Z&&(te=setInterval(async()=>{try{let{data:e,error:n}=await Z.from(`live_control`).select(`viewers, cum_viewers, hearts`).eq(`live_id`,t).maybeSingle();e&&!n&&(s.viewers=parseInt(e.viewers)||0,s.cumViewers=parseInt(e.cum_viewers)||0,s.hearts=parseInt(e.hearts)||0,typeof window.updateAdminViewersDisplay==`function`&&window.updateAdminViewersDisplay())}catch{}},3e3)),T.addEventListener(`adminTabLeave`,()=>{N&&Z.removeChannel(N),te&&clearInterval(te),w&&clearInterval(w)});let F=document.getElementById(`btn-winner-start`),I=document.getElementById(`btn-winner-cancel`),ne=o.winner_name&&o.winner_name.startsWith(`구매인증`)?`구매인증`:`소통왕`,re=document.querySelectorAll(`.type-segment-btn`);re.forEach(e=>{e.addEventListener(`click`,()=>{re.forEach(e=>{e.classList.remove(`active`),e.style.background=`transparent`,e.style.color=`#64748b`}),e.classList.add(`active`),e.style.background=`#fab005`,e.style.color=`#fff`,ne=e.dataset.type})}),F&&F.addEventListener(`click`,async()=>{let e=document.getElementById(`winner-announce-text`).value.trim(),n=parseInt(document.getElementById(`winner-announce-min`).value)||1;if(!e){alert(`당첨자 닉네임을 입력해 주세요.`);return}F.disabled=!0,F.textContent=`적용 중...`;let r=`${ne}|${e}`,i=Date.now()+n*60*1e3;try{if(!Z)return;let{error:e}=await Z.from(`live_control`).update({winner_name:r,winner_timestamp:i,updated_at:new Date().toISOString()}).eq(`live_id`,t);if(e)throw e;o.winner_name=r,o.winner_timestamp=i,alert(`🎉 ${ne} 당첨 배너 노출이 시작되었습니다!`),j()}catch{alert(`시작 처리에 실패했습니다.`)}finally{F.disabled=!1,F.textContent=`시작`}}),I&&I.addEventListener(`click`,async()=>{I.disabled=!0,I.textContent=`종료 중...`;try{if(!Z)return;let{error:e}=await Z.from(`live_control`).update({winner_timestamp:0,updated_at:new Date().toISOString()}).eq(`live_id`,t);if(e)throw e;o.winner_timestamp=0,alert(`당첨 배너 노출이 종료되었습니다.`),j()}catch{alert(`종료 처리에 실패했습니다.`)}finally{I.disabled=!1,I.textContent=`종료`}})},M=()=>c.map((e,t)=>{let n=e.clicks||0;return`
    ...
    `}).join(``),N=()=>{T.innerHTML=`
      <div class="section-card">
        ...
        <div id="product-list-container">${M()}</div>
      </div>
    `,Z&&Z.from(`live_control`).select(`products`).eq(`live_id`,t).maybeSingle().then(({data:t,error:n})=>{if(n)throw n;if(t&&t.products)try{let n=typeof t.products==`string`?JSON.parse(t.products):t.products;if(Array.isArray(n)){!c||c.length===0?c=n:c.forEach(e=>{let t=n.find(t=>t.name===e.name);t&&(e.clicks=parseInt(t.clicks)||0,!e.image&&t.image&&(e.image=t.image))}),g();let t=document.getElementById(`product-list-container`);t&&(t.innerHTML=M(),e())}}catch{}}).catch(e=>console.warn(`Failed to load product clicks from Supabase`,e));let e=()=>{let n=document.getElementById(`product-list-container`);n.querySelectorAll(`.price-input`).forEach(e=>{e.addEventListener(`input`,e=>{let t=e.target.value.replace(/[^0-9]/g,``);e.target.value=t?Number(t).toLocaleString():``})}),n.querySelectorAll(`input[data-field]`).forEach(t=>{t.addEventListener(`change`,t=>{let r=parseInt(t.target.dataset.idx),i=t.target.dataset.field;if(t.target.type===`checkbox`){if(c[r][i]=t.target.checked,i===`isLeadForm`){t.target.checked?c[r].url=`__LEAD_FORM__`:c[r].url===`__LEAD_FORM__`&&(c[r].url=``),n.innerHTML=M(),e();return}}else i===`price`||i===`normalPrice`?c[r][i]=t.target.value.replace(/[^0-9]/g,``):c[r][i]=t.target.value;if(i===`price`||i===`normalPrice`){let e=Number((c[r].normalPrice||``).toString().replace(/[^0-9]/g,``)),t=Number((c[r].price||``).toString().replace(/[^0-9]/g,``));if(e>0&&e>=t){c[r].discountRate=Math.floor((e-t)/e*100);let i=n.querySelector(`input[data-idx="${r}"][data-field="discountRate"]`);i&&(i.value=c[r].discountRate)}else{c[r].discountRate=0;let e=n.querySelector(`input[data-idx="${r}"][data-field="discountRate"]`);e&&(e.value=0)}}g()})}),n.querySelectorAll(`.prod-img-upload`).forEach(t=>{t.addEventListener(`change`,async t=>{let r=t.target.files[0];if(!r)return;let a=parseInt(t.target.dataset.idx),o=document.getElementById(`img-prev-${a}`);o&&(o.style.opacity=`0.5`);try{let t=await i(await new Promise((e,t)=>{let n=new FileReader;n.onload=()=>e(n.result.split(`,`)[1]),n.onerror=t,n.readAsDataURL(r)}));if(!t)throw Error(`서버로부터 다운로드 URL을 받지 못했습니다.`);c[a].image=t,o&&(o.src=t),g(),n.innerHTML=M(),e(),alert(`🎉 상품 이미지 변경 성공!`)}catch(e){console.error(e),alert(`❌ 상품 이미지 업로드 에러:
`+e.message)}finally{o&&(o.style.opacity=`1`)}})}),n.querySelectorAll(`.btn-deal-start`).forEach(r=>{r.addEventListener(`click`,r=>{let i=parseInt(r.target.dataset.idx),a=parseInt(document.getElementById(`deal-min-${i}`).value);a>0&&(c[i].dealText=document.getElementById(`deal-text-${i}`).value||`깜짝딜 종료까지`,c[i].dealEndTime=Date.now()+a*60*1e3,g(),n.innerHTML=M(),e(),At(t,o,s,c,!0),setTimeout(()=>alert(`${a}분 깜짝딜이 시작되었습니다!`),10))})}),n.querySelectorAll(`.btn-deal-cancel`).forEach(r=>{r.addEventListener(`click`,r=>{let i=parseInt(r.target.dataset.idx);c[i].dealEndTime=0,g(),n.innerHTML=M(),e(),At(t,o,s,c,!0)})}),n.querySelectorAll(`.btn-del-product`).forEach(t=>{t.addEventListener(`click`,t=>{let r=parseInt(t.target.dataset.idx),i=c[r]?.name||`이 상품`;confirm(`정말 "${i}" 상품을 삭제하시겠습니까?`)&&(c.splice(r,1),g(),n.innerHTML=M(),e())})}),n.querySelectorAll(`.btn-move-up`).forEach(t=>{t.addEventListener(`click`,t=>{let r=parseInt(t.target.dataset.idx);if(r>0){let t=c[r-1];c[r-1]=c[r],c[r]=t,g(),n.innerHTML=M(),e()}})}),n.querySelectorAll(`.btn-move-down`).forEach(t=>{t.addEventListener(`click`,t=>{let r=parseInt(t.target.dataset.idx);if(r<c.length-1){let t=c[r+1];c[r+1]=c[r],c[r]=t,g(),n.innerHTML=M(),e()}})})};e(),document.getElementById(`btn-add-product`).addEventListener(`click`,()=>{c.push({id:Date.now(),name:`새 상품`,price:``,normalPrice:``,discountRate:0,image:`https://via.placeholder.com/72`,url:`#`}),g(),document.getElementById(`product-list-container`).innerHTML=M(),e()}),document.getElementById(`btn-save-products`).addEventListener(`click`,()=>{At(t,o,s,c,!0),alert(`상품 목록이 적용되었습니다!`)})},P=()=>{T.innerHTML=`
      <div class="section-card">
        <div style="display:flex; justify-content:space-between; align-items:center; padding-bottom:16px; border-bottom:1.5px solid #f1f5f9; margin-bottom:20px;">
...
`;e.forEach(e=>{let t=new Date(e.created_at).toLocaleString(`ko-KR`).replace(/,/g,``),r=(e.name||``).replace(/,/g,` `),i=(e.phone||``).replace(/,/g,` `);n+=`${t},${r},${i}\n`});let r=new Blob([`﻿`+n],{type:`text/csv;charset=utf-8;`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=`상담DB_${t}.csv`,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(i)})};setTimeout(()=>{document.getElementById(`btn-back`).addEventListener(`click`,()=>{w(),u&&clearInterval(u),n(null)}),document.getElementById(`btn-refresh-preview`).addEventListener(`click`,()=>{document.getElementById(`live-preview-iframe`).src=D});let e=b.querySelectorAll(`.tab-btn`),t=t=>{T.dispatchEvent(new Event(`adminTabLeave`)),e.forEach(e=>e.classList.toggle(`active`,e.dataset.tab===t)),t===`config`?A():t===`chat`?j():t===`product`?N():t===`leads`&&P()};e.forEach(e=>{e.addEventListener(`click`,()=>t(e.dataset.tab))}),A()},0)}function Ft(){let e=document.createElement(`div`),t=``;function n(){let r=H.getAll(`hosts`);if(t){let e=t.toLowerCase();r=r.filter(t=>t.name.toLowerCase().includes(e)||t.phone&&t.phone.includes(e))}let i=r.map(e=>{let t=H.getHostStats(e.id);return{...e,stats:t}});e.innerHTML=`
      <div class="page-header">
        <div class="page-header-left">
          <div>
