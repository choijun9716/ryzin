...
`;return typeof a==`function`&&a(null,p),p}}));o((e=>{var t=yi(),n=Hi(),r=Wi(),i=Gi();function a(e,r,i,a,o){let s=[].slice.call(arguments,1),c=s.length,l=typeof s[c-1]==`function`;if(!l&&!t())throw Error(`Callback required as last argument`);if(l){if(c<2)throw Error(`Too few arguments provided`);c===2?(o=i,i=r,r=a=void 0):c===3&&(r.getContext&&o===void 0?(o=a,a=void 0):(o=a,a=i,i=r,r=void 0))}else{if(c<1)throw Error(`Too few arguments provided`);return c===1?(i=r,r=a=void 0):c===2&&!r.getContext&&(a=i,i=r,r=void 0),new Promise(function(t,o){try{t(e(n.create(i,a),r,a))}catch(e){o(e)}})}try{let t=n.create(i,a);o(null,e(t,r,a))}catch(e){o(e)}}e.create=n.create,e.toCanvas=a.bind(null,r.render),e.toDataURL=a.bind(null,r.renderToDataURL),e.toString=a.bind(null,function(e,t,n){return i.render(e,n)})}))();function Ki(){U.isDemoMode&&(localStorage.setItem(`ryzin_is_demo_mode`,`false`),U.isDemoMode=!1,U.STORAGE_KEY=`livecommerce_erp_data`,U._load());let e=document.createElement(`div`);return e.className=`login-container`,e.innerHTML=`
  ...
  `,e.querySelectorAll(`.shop-tab-btn`).forEach(t=>{t.addEventListener(`click`,()=>{e.querySelectorAll(`.shop-tab-btn`).forEach(e=>{e.style.color=`var(--text-secondary)`,e.style.fontWeight=`600`,e.style.borderBottom=`2px solid transparent`,e.classList.remove(`active`)}),e.querySelectorAll(`.shop-panel`).forEach(e=>e.style.display=`none`),t.style.color=`var(--primary)`,t.style.fontWeight=`700`,t.style.borderBottom=`2px solid var(--primary)`,t.classList.add(`active`),e.querySelector(`#panel-${t.dataset.tab}`).style.display=`block`})});function t(){let n=e.querySelector(`#banner-list`),r=$(qi,Xi);n.innerHTML=``,r.forEach((e,i)=>{let a=document.createElement(`div`);a.style.cssText=`background: var(--bg-secondary); border-radius: 12px; padding: 20px; margin-bottom: 16px; border: 1px solid var(--border-color);`,a.innerHTML=`
        <div style="display: flex; gap: 16px; align-items: flex-start;">
          <img src="${e.img}" alt="" style="width: 120px; height: 80px; object-fit: cover; border-radius: 8px; flex-shrink:0; background:#333;">
          <div style="flex:1; display:flex; flex-direction:column; gap:10px;">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
              <div>
                ...
                <input class="b-title" value="${ta(e.title)}" style="width:100%; padding:8px 10px; border-radius:8px; border:1px solid var(--border-color); background:var(--bg-primary); color:var(--text-primary); font-size:13px;">
              </div>
              <div>
                <label style="font-size:11px; font-weight:600; color:var(--text-secondary); display:block; margin-bottom:4px;">부제목</label>
                <input class="b-desc" value="${ta(e.desc)}" style="width:100%; padding:8px 10px; border-radius:8px; border:1px solid var(--border-color); background:var(--bg-primary); color:var(--text-primary); font-size:13px;">
              </div>
              <div>
                <label style="font-size:11px; font-weight:600; color:var(--text-secondary); display:block; margin-bottom:4px;">날짜 라벨 (예: 오늘)</label>
                <input class="b-label" value="${ta(e.label)}" style="width:100%; padding:8px 10px; border-radius:8px; border:1px solid var(--border-color); background:var(--bg-primary); color:var(--text-primary); font-size:13px;">
              </div>
              <div>
                <label style="font-size:11px; font-weight:600; color:var(--text-secondary); display:block; margin-bottom:4px;">시간 (예: 오후 8시)</label>
                <input class="b-time" value="${ta(e.time)}" style="width:100%; padding:8px 10px; border-radius:8px; border:1px solid var(--border-color); background:var(--bg-primary); color:var(--text-primary); font-size:13px;">
              </div>
            </div>
            <div>
              <label style="font-size:11px; font-weight:600; color:var(--text-secondary); display:block; margin-bottom:4px;">이미지 URL</label>
              <div style="display:flex; gap:8px;">
                <input class="b-img" value="${ta(e.img)}" style="flex:1; padding:8px 10px; border-radius:8px; border:1px solid var(--border-color); background:var(--bg-primary); color:var(--text-primary); font-size:12px;">
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; margin-top:14px; border-top:1px solid var(--border-color); padding-top:14px;">
          <div style="display:flex; gap:8px;">
            ...
            ${i<r.length-1?`<button class="b-dn-btn" style="padding:6px 12px; border-radius:8px; border:1px solid var(--border-color); background:var(--bg-primary); color:var(--text-secondary); font-size:12px; cursor:pointer;">▼ 아래로</button>`:``}
          </div>
          <div style="display:flex; gap:8px;">
      ...
      `,a.querySelector(`.b-preview-btn`).addEventListener(`click`,()=>{let e=a.querySelector(`.b-img`).value.trim();a.querySelector(`img`).src=e}),a.querySelector(`.b-save-btn`).addEventListener(`click`,()=>{let e=$(qi,Xi);e[i]={...e[i],title:a.querySelector(`.b-title`).value.trim(),desc:a.querySelector(`.b-desc`).value.trim(),label:a.querySelector(`.b-label`).value.trim(),time:a.querySelector(`.b-time`).value.trim(),img:a.querySelector(`.b-img`).value.trim()},$i(qi,e),na(`배너가 저장되었습니다.`),t()}),a.querySelector(`.b-del-btn`).addEventListener(`click`,()=>{if(!confirm(`이 배너를 삭제하시겠습니까?`))return;let e=$(qi,Xi);e.splice(i,1),$i(qi,e),t()}),i>0&&a.querySelector(`.b-up-btn`)?.addEventListener(`click`,()=>{let e=$(qi,Xi);[e[i-1],e[i]]=[e[i],e[i-1]],$i(qi,e),t()}),i<r.length-1&&a.querySelector(`.b-dn-btn`)?.addEventListener(`click`,()=>{let e=$(qi,Xi);[e[i],e[i+1]]=[e[i+1],e[i]],$i(qi,e),t()}),n.appendChild(a)})}e.querySelector(`#add-banner-btn`).addEventListener(`click`,()=>{let e=$(qi,Xi);e.push({id:`b`+Date.now(),img:``,label:``,time:``,title:`새 배너`,desc:``}),$i(qi,e),t()});function n(){let t=e.querySelector(`#menu-list`),r=$(Ji,Zi);t.innerHTML=``,r.forEach((e,i)=>{let a=document.createElement(`div`);a.style.cssText=`background: var(--bg-secondary); border-radius: 12px; padding: 16px 20px; margin-bottom: 12px; border: 1px solid var(--border-color); display: flex; align-items: center; gap: 12px;`,a.innerHTML=`
        <span style="font-size:13px; font-weight:600; color:var(--text-secondary); min-width:28px;">#${i+1}</span>
        <input class="m-name" value="${ta(e.name)}" style="flex:1; padding:8px 12px; border-radius:8px; border:1px solid var(--border-color); background:var(--bg-primary); color:var(--text-primary); font-size:14px; font-weight:600;">
        ...
        ${i<r.length-1?`<button class="m-dn-btn" style="padding:6px 10px; border-radius:8px; border:1px solid var(--border-color); background:var(--bg-primary); color:var(--text-secondary); font-size:12px; cursor:pointer;">▼</button>`:``}
        <button class="m-del-btn btn btn-danger btn-sm">삭제</button>
      `,a.querySelector(`.m-save-btn`).addEventListener(`click`,()=>{let e=$(Ji,Zi);e[i].name=a.querySelector(`.m-name`).value.trim(),$i(Ji,e),na(`메뉴가 저장되었습니다.`)}),a.querySelector(`.m-del-btn`).addEventListener(`click`,()=>{let e=$(Ji,Zi);e.splice(i,1),$i(Ji,e),n()}),i>0&&a.querySelector(`.m-up-btn`)?.addEventListener(`click`,()=>{let e=$(Ji,Zi);[e[i-1],e[i]]=[e[i],e[i-1]],$i(Ji,e),n()}),i<r.length-1&&a.querySelector(`.m-dn-btn`)?.addEventListener(`click`,()=>{let e=$(Ji,Zi);[e[i],e[i+1]]=[e[i+1],e[i]],$i(Ji,e),n()}),t.appendChild(a)})}e.querySelector(`#add-menu-btn`).addEventListener(`click`,()=>{let e=$(Ji,Zi);e.push({id:`m`+Date.now(),name:`새 메뉴`}),$i(Ji,e),n()});function r(){let t=e.querySelector(`#live-list`),n=$(Yi,Qi);t.innerHTML=``,n.forEach((e,n)=>{let i=document.createElement(`div`);i.style.cssText=`background: var(--bg-secondary); border-radius: 12px; padding: 20px; margin-bottom: 16px; border: 1px solid var(--border-color);`,i.innerHTML=`
        <div style="display: flex; gap: 16px; align-items: flex-start;">
          <img src="${e.img}" alt="" style="width: 100px; height: 70px; object-fit: cover; border-radius: 8px; flex-shrink:0; background:#333;">
          <div style="flex:1; display:flex; flex-direction:column; gap:10px;">
            <div>
              <label style="font-size:11px; font-weight:600; color:var(--text-secondary); display:block; margin-bottom:4px;">라이브 제목</label>
              <input class="lv-title" value="${ta(e.title)}" style="width:100%; padding:8px 10px; border-radius:8px; border:1px solid var(--border-color); background:var(--bg-primary); color:var(--text-primary); font-size:13px;">
            </div>
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
              <div>
                <label style="font-size:11px; font-weight:600; color:var(--text-secondary); display:block; margin-bottom:4px;">시청자 수 텍스트</label>
                <input class="lv-viewers" value="${ta(e.viewers)}" style="width:100%; padding:8px 10px; border-radius:8px; border:1px solid var(--border-color); background:var(--bg-primary); color:var(--text-primary); font-size:13px;">
              </div>
              <div>
                <label style="font-size:11px; font-weight:600; color:var(--text-secondary); display:block; margin-bottom:4px;">링크 URL</label>
                <input class="lv-link" value="${ta(e.link)}" style="width:100%; padding:8px 10px; border-radius:8px; border:1px solid var(--border-color); background:var(--bg-primary); color:var(--text-primary); font-size:12px;">
              </div>
            </div>
            <div>
              <label style="font-size:11px; font-weight:600; color:var(--text-secondary); display:block; margin-bottom:4px;">썸네일 이미지 URL</label>
              <div style="display:flex; gap:8px;">
                <input class="lv-img" value="${ta(e.img)}" style="flex:1; padding:8px 10px; border-radius:8px; border:1px solid var(--border-color); background:var(--bg-primary); color:var(--text-primary); font-size:12px;">
      ...
      `,i.querySelector(`.lv-preview-btn`).addEventListener(`click`,()=>{i.querySelector(`img`).src=i.querySelector(`.lv-img`).value.trim()}),i.querySelector(`.lv-save-btn`).addEventListener(`click`,()=>{let e=$(Yi,Qi);e[n]={...e[n],title:i.querySelector(`.lv-title`).value.trim(),viewers:i.querySelector(`.lv-viewers`).value.trim(),link:i.querySelector(`.lv-link`).value.trim(),img:i.querySelector(`.lv-img`).value.trim()},$i(Yi,e),na(`라이브 정보가 저장되었습니다.`),r()}),i.querySelector(`.lv-del-btn`).addEventListener(`click`,()=>{if(!confirm(`이 라이브 항목을 삭제하시겠습니까?`))return;let e=$(Yi,Qi);e.splice(n,1),$i(Yi,e),r()}),t.appendChild(i)})}return e.querySelector(`#add-live-btn`).addEventListener(`click`,()=>{let e=$(Yi,Qi);e.push({id:`l`+Date.now(),img:``,title:`새 라이브`,viewers:``,link:``}),$i(Yi,e),r()}),t(),n(),r(),e}function ta(e){return String(e||``).replace(/&/g,`&amp;`).replace(/"/g,`&quot;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function na(e){let t=document.createElement(`div`);t.textContent=e,t.style.cssText=`
    position: fixed; bottom: 24px; left: 50%; transform: translateX(-50%);
    background: #1e293b; color: #fff; padding: 12px 24px; border-radius: 40px;
    font-size: 13px; font-weight: 600; z-index: 9999;
    box-shadow: 0 8px 24px rgba(0,0,0,0.3);
    animation: fadeInUp 0.25s ease;
  `,document.body.appendChild(t),setTimeout(()=>t.remove(),2200)}x(),j();async function ra(){let e=document.getElementById(`app`);if(e.innerHTML=`
  ...
  `,!await U.init()){e.innerHTML=`
    ...
    `;return}let t=()=>{if(e.querySelector(`.sidebar`))return;e.innerHTML=``,e.className=`app-layout`,e.appendChild(Qe());let t=document.createElement(`div`);t.className=`mobile-overlay`,t.onclick=()=>document.querySelector(`.sidebar`).classList.remove(`open`),e.appendChild(t);let n=document.createElement(`button`);n.className=`mobile-menu-btn`,n.innerHTML=`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>`,n.onclick=()=>document.querySelector(`.sidebar`).classList.toggle(`open`),e.appendChild(n);let r=document.createElement(`main`);r.className=`main-content`,r.id=`page-content`,e.appendChild(r),M.setContainer(r)};M.beforeEach(n=>{let r=!!U.getCurrentUser();if(!r&&n!==`/login`)return`/login`;if(r&&n===`/login`)return`/`;if(r&&n===`/live_stream`){let e=U.getCurrentUser();if(U.isDemoMode||e&&(e.id===`demo`||e.role===`demo`))return`/`}return n===`/login`?(e.innerHTML=``,e.className=``,M.setContainer(e)):t(),!0}),M.register(`/login`,()=>Ki()),M.register(`/`,()=>pt()),M.register(`/live_stream`,()=>Nt()),M.register(`/projects`,()=>Gt()),M.register(`/projects/new`,()=>Gt()),M.register(`/projects/:id`,e=>qt(e)),M.register(`/hosts`,()=>It()),M.register(`/hosts/:id`,e=>Rt(e)),M.register(`/brands`,()=>Vt()),M.register(`/brands/:id`,e=>Ut(e)),M.register(`/finance`,()=>rn()),M.register(`/settlement`,()=>an()),M.register(`/contracts`,()=>cn()),M.register(`/marketing`,()=>fn()),M.register(`/crm`,()=>pn()),M.register(`/shop_manage`,()=>ea()),M.register(`/settings`,()=>mn()),M.start(),document.addEventListener(`click`,e=>{let t=e.target.closest(`a[href]`);t&&t.getAttribute(`href`).startsWith(`/`)&&!t.getAttribute(`target`)&&(e.preventDefault(),M.navigate(t.getAttribute(`href`)))})}ra();