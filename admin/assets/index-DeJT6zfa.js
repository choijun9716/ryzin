...
`).map(e=>e.trim()).filter(e=>e.includes(`|`));if(o.length===0){alert(`닉네임|내용 형식으로 1줄 이상 입력해주세요.`),l=!1;return}e.textContent=`⏸`,r.textContent=`채팅 봇 중지`,i.className=`action-btn btn-danger-solid`,i.style.cssText=`width:100%; justify-content:center; padding:14px; font-size:15px; gap:8px;`;let u=parseInt(s.value)||10;c=setInterval(async()=>{let[e,...r]=o[Math.floor(Math.random()*o.length)].split(`|`),i=r.join(`|`).trim();if(!e||!i)return;let a=Date.now(),s=document.createElement(`div`);s.style.cssText=`margin-bottom:8px; padding:6px 0; border-bottom:1px solid #f1f5f9;`,s.innerHTML=`<span style="font-weight:700; color:#64748b;">${e.trim()}:</span> ${i}`,n.innerHTML.includes(`실시간 채팅`)&&(n.innerHTML=``),n.appendChild(s),n.scrollTop=n.scrollHeight;try{if(!Z)return;await Z.from(`live_chats`).insert([{live_id:t,created_at:a,nickname:e.trim(),content:i}])}catch(e){console.warn(`Bot chat failed`,e)}},u*1e3)}else c&&clearInterval(c),e.textContent=`▶`,r.textContent=`채팅 봇 시작`,i.className=`action-btn btn-primary-solid`,i.style.cssText=`width:100%; justify-content:center; padding:14px; font-size:15px; gap:8px;`});let d=0,f=null,p=(e,t,r=!1)=>{n.innerHTML.includes(`실시간 채팅 내역이 여기에`)&&(n.innerHTML=``);let i=document.createElement(`div`);i.style.cssText=`margin-bottom:8px; padding:6px 0; border-bottom:1px solid #f1f5f9;`+(r?`opacity:0.72;`:``),i.innerHTML=`<span style="font-weight:700; color:${e===`관리자`?`#3b82f6`:`#64748b`};">${e}:</span> ${t}`,n.appendChild(i),r||(n.scrollTop=n.scrollHeight)};(async()=>{if(Z)try{let{data:e,error:r}=await Z.from(`live_chats`).select(`*`).eq(`live_id`,t).order(`created_at`,{ascending:!0}).limit(100);if(r)throw r;e&&Array.isArray(e)&&(e.forEach(e=>{p(e.nickname||`?`,e.content||``,!0),d=parseInt(e.created_at)||0}),setTimeout(()=>{n.scrollTop=n.scrollHeight},100))}catch(e){console.warn(`Failed to load chat history`,e)}})(),Z&&(f=Z.channel(`admin-chat-channel-${t}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`live_chats`,filter:`live_id=eq.${t}`},e=>{let t=e.new;t&&parseInt(t.created_at)>d&&(p(t.nickname||`?`,t.content||``,!1),d=parseInt(t.created_at))}).subscribe()),m.addEventListener(`adminTabLeave`,()=>{f&&Z.removeChannel(f),c&&clearInterval(c)})},x=()=>a.map((e,t)=>{let n=e.clicks||0;return`
    ...
    `,setTimeout(()=>{e.querySelector(`#host-search`)?.addEventListener(`input`,e=>{t=e.target.value,n();let r=document.getElementById(`host-search`);if(r){r.focus();let e=r.value.length;r.setSelectionRange(e,e)}}),e.querySelector(`#btn-add-host`)?.addEventListener(`click`,()=>{ft()}),e.querySelectorAll(`.host-link`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),u.navigate(`/hosts/${e.getAttribute(`data-id`)}`)})}),e.querySelectorAll(`.btn-edit-host`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),ft(e.getAttribute(`data-id`))})}),e.querySelectorAll(`tr.clickable`).forEach(e=>{e.addEventListener(`click`,()=>{u.navigate(`/hosts/${e.getAttribute(`data-id`)}`)})})},0)}return n(),V.on(`hosts:changed`,n),e}function ft(e=null){let t=!!e,n=t?V.getById(`hosts`,e):{},r=`
    <div class="form-grid">
  ...
  `,i=document.createElement(`div`);i.style.cssText=`display: flex; gap: var(--space-3); justify-content: flex-end; width: 100%;`;let a=document.createElement(`button`);a.className=`btn btn-secondary`,a.textContent=`취소`,a.addEventListener(`click`,J);let o=document.createElement(`button`);o.className=`btn btn-primary`,o.textContent=`저장`,o.addEventListener(`click`,()=>{let t={};n.forEach(e=>{t[e.key]=document.getElementById(`memo-${e.key}`).value.trim()}),V.update(`hosts`,e.id,{memo:t}),J(),Y(`메모가 저장되었습니다.`),u.navigate(`/hosts/${e.id}`)}),i.appendChild(a),i.appendChild(o),q({title:`메모 수정`,size:`lg`,content:r,footer:i})}function gt(){let e=document.createElement(`div`),t=``;function n(){let r=V.getAll(`brands`);if(t){let e=t.toLowerCase();r=r.filter(t=>t.name.toLowerCase().includes(e)||t.manager&&t.manager.toLowerCase().includes(e)||t.category&&t.category.toLowerCase().includes(e))}let i=r.map(e=>{let t=V.getBrandStats(e.id);return{...e,stats:t}});e.innerHTML=`
    ...
    `,setTimeout(()=>{e.querySelector(`#brand-search`)?.addEventListener(`input`,e=>{t=e.target.value,n();let r=document.getElementById(`brand-search`);if(r){r.focus();let e=r.value.length;r.setSelectionRange(e,e)}}),e.querySelector(`#btn-add-brand`)?.addEventListener(`click`,()=>_t()),e.querySelectorAll(`.brand-link`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),u.navigate(`/brands/${e.getAttribute(`data-id`)}`)})}),e.querySelectorAll(`.btn-edit-brand`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),_t(e.getAttribute(`data-id`))})}),e.querySelectorAll(`tr.clickable`).forEach(e=>{e.addEventListener(`click`,()=>u.navigate(`/brands/${e.getAttribute(`data-id`)}`))})},0)}return n(),V.on(`brands:changed`,n),e}function _t(e=null){let t=!!e,n=t?V.getById(`brands`,e):{},r=`
    <div class="form-grid">
      <div class="input-group">
  ...
  `,setTimeout(()=>{t.querySelector(`#btn-add-host-match`)?.addEventListener(`click`,()=>{Et(e.id,null,()=>{let n=Tt(e);t.replaceWith(n)})}),t.querySelectorAll(`.btn-edit-match`).forEach(n=>{n.addEventListener(`click`,()=>{Et(e.id,n.getAttribute(`data-id`),()=>{let n=Tt(e);t.replaceWith(n)})})})},0),t}function Et(e,t,n){let r=!!t,i=r?V.getById(`liveHosts`,t):{},a=V.getAll(`hosts`),o=`
    <div class="form-grid">
...
`;return typeof a==`function`&&a(null,p),p}}));o((e=>{var t=Jr(),n=_i(),r=yi(),i=bi();function a(e,r,i,a,o){let s=[].slice.call(arguments,1),c=s.length,l=typeof s[c-1]==`function`;if(!l&&!t())throw Error(`Callback required as last argument`);if(l){if(c<2)throw Error(`Too few arguments provided`);c===2?(o=i,i=r,r=a=void 0):c===3&&(r.getContext&&o===void 0?(o=a,a=void 0):(o=a,a=i,i=r,r=void 0))}else{if(c<1)throw Error(`Too few arguments provided`);return c===1?(i=r,r=a=void 0):c===2&&!r.getContext&&(a=i,i=r,r=void 0),new Promise(function(t,o){try{t(e(n.create(i,a),r,a))}catch(e){o(e)}})}try{let t=n.create(i,a);o(null,e(t,r,a))}catch(e){o(e)}}e.create=n.create,e.toCanvas=a.bind(null,r.render),e.toDataURL=a.bind(null,r.renderToDataURL),e.toString=a.bind(null,function(e,t,n){return i.render(e,n)})}))();function xi(){V.isDemoMode&&(localStorage.setItem(`ryzin_is_demo_mode`,`false`),V.isDemoMode=!1,V.STORAGE_KEY=`livecommerce_erp_data`,V._load());let e=document.createElement(`div`);return e.className=`login-container`,e.innerHTML=`
  ...
  `,!await V.init()){e.innerHTML=`
    ...
    `;return}let t=()=>{if(e.querySelector(`.sidebar`))return;e.innerHTML=``,e.className=`app-layout`,e.appendChild(Ae());let t=document.createElement(`div`);t.className=`mobile-overlay`,t.onclick=()=>document.querySelector(`.sidebar`).classList.remove(`open`),e.appendChild(t);let n=document.createElement(`button`);n.className=`mobile-menu-btn`,n.innerHTML=`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>`,n.onclick=()=>document.querySelector(`.sidebar`).classList.toggle(`open`),e.appendChild(n);let r=document.createElement(`main`);r.className=`main-content`,r.id=`page-content`,e.appendChild(r),u.setContainer(r)};u.beforeEach(n=>{let r=!!V.getCurrentUser();return!r&&n!==`/login`?`/login`:r&&n===`/login`?`/`:(n===`/login`?(e.innerHTML=``,e.className=``,u.setContainer(e)):t(),!0)}),u.register(`/login`,()=>xi()),u.register(`/`,()=>He()),u.register(`/live_stream`,()=>ct()),u.register(`/projects`,()=>bt()),u.register(`/projects/new`,()=>bt()),u.register(`/projects/:id`,e=>St(e)),u.register(`/hosts`,()=>dt()),u.register(`/hosts/:id`,e=>pt(e)),u.register(`/brands`,()=>gt()),u.register(`/brands/:id`,e=>vt(e)),u.register(`/finance`,()=>Mt()),u.register(`/settlement`,()=>Nt()),u.register(`/contracts`,()=>It()),u.register(`/marketing`,()=>Bt()),u.register(`/crm`,()=>Vt()),u.register(`/settings`,()=>Ht()),u.start(),document.addEventListener(`click`,e=>{let t=e.target.closest(`a[href]`);t&&t.getAttribute(`href`).startsWith(`/`)&&!t.getAttribute(`target`)&&(e.preventDefault(),u.navigate(t.getAttribute(`href`)))})}Si();