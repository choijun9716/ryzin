        ...
        <div style="display:flex; flex-direction:column; gap:10px; margin-top:10px; background:#f8fafc; padding:12px 14px; border-radius:12px; border:1.5px solid #e2e8f0;">
          <div style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:8px;">
            <div style="display:flex; align-items:center; gap:8px;">
              ...
              <span style="font-size:11px; font-weight:700; color:#475569; background:#e2e8f0; padding:2px 8px; border-radius:6px;">총 ${a.length}장</span>
            </div>
            <div style="display:flex; align-items:center; gap:6px;">
              <input type="file" id="upload-detail-${t}" accept="image/*,.gif" multiple style="display:none;" data-idx="${t}" class="prod-detail-upload">
              <button type="button" id="btn-upload-detail-${t}" class="action-btn" onclick="document.getElementById('upload-detail-${t}').click()" style="padding:6px 12px; font-size:12px; font-weight:700; background:#0f172a; color:#ffffff; border:none; border-radius:8px; cursor:pointer; white-space:nowrap;">
                + 이미지/GIF 다중 추가
              </button>
              ${a.length>0?`
              ...
              ${a.map((e,n)=>`
                <div style="position:relative; width:92px; flex-shrink:0; background:#ffffff; border:1.5px solid #cbd5e1; border-radius:10px; padding:6px; display:flex; flex-direction:column; gap:6px; box-shadow:0 2px 6px rgba(0,0,0,0.04);">
                  <div style="position:relative; width:100%; aspect-ratio:1/1; border-radius:6px; overflow:hidden; background:#f1f5f9; border:1px solid #e2e8f0;">
                    <span style="position:absolute; top:2px; left:2px; background:rgba(15,23,42,0.85); color:#ffffff; font-size:10px; font-weight:800; padding:1px 5px; border-radius:4px; z-index:2;">${n+1}</span>
                  ...
                  <div style="display:flex; align-items:center; justify-content:space-between; gap:2px;">
                    <button type="button" class="btn-move-detail-left" data-prod-idx="${t}" data-img-idx="${n}" style="flex:1; padding:3px 0; background:#f1f5f9; border:1px solid #cbd5e1; border-radius:4px; font-size:11px; cursor:pointer;" ${n===0?`disabled style="opacity:0.3; cursor:not-allowed;"`:``} title="앞으로 이동">◀</button>
                    <button type="button" class="btn-move-detail-right" data-prod-idx="${t}" data-img-idx="${n}" style="flex:1; padding:3px 0; background:#f1f5f9; border:1px solid #cbd5e1; border-radius:4px; font-size:11px; cursor:pointer;" ${n===a.length-1?`disabled style="opacity:0.3; cursor:not-allowed;"`:``} title="뒤로 이동">▶</button>
                    <button type="button" class="btn-del-single-detail" data-prod-idx="${t}" data-img-idx="${n}" style="flex:1; padding:3px 0; background:#fee2e2; border:1px solid #fca5a5; color:#ef4444; border-radius:4px; font-size:11px; font-weight:800; cursor:pointer;" title="이 이미지 삭제">✕</button>
                  </div>
                </div>
              `).join(``)}
            </div>
          ...
          <input type="text" class="modern-input" style="padding:6px 10px; font-size:11.5px;" value="${e.detailImage||``}" data-idx="${t}" data-field="detailImage" placeholder="이미지 URL 직접 편집 (쉼표로 구분하여 여러 장 순서대로 지정)">
        </div>
        ${i?``:`
