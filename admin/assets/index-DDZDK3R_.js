                    ...
                    <div class="hero-item-card" style="background:var(--bg-secondary); border:1px solid var(--border-light); border-radius:12px; padding:14px; display:flex; flex-direction:column; gap:10px; position:relative;">
                      <div style="display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <div style="display:flex; gap:4px;">
                          ${t>0?`<button class="btn btn-xs btn-secondary btn-move-hero" data-idx="${t}" data-dir="-1" title="위로">⬆️</button>`:``}
                          ${t<i.length-1?`<button class="btn btn-xs btn-secondary btn-move-hero" data-idx="${t}" data-dir="1" title="아래로">⬇️</button>`:``}
                          <button class="btn btn-xs btn-danger btn-del-hero-card" data-idx="${t}" title="삭제">🗑️</button>
                        </div>
                      </div>
