...
`;e.forEach(e=>{let t=new Date(e.created_at).toLocaleString(`ko-KR`).replace(/,/g,``),r=(e.name||``).replace(/,/g,` `),i=(e.phone||``).replace(/,/g,` `);n+=`${t},${r},${i}\n`});let r=new Blob([`﻿`+n],{type:`text/csv;charset=utf-8;`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=`상담DB_${t}.csv`,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(i)})},le=v.querySelector(`#btn-back`);le&&le.addEventListener(`click`,()=>{T.dispatchEvent(new Event(`adminTabLeave`)),w(),u&&clearInterval(u),de&&X.removeChannel(de),ue&&X.removeChannel(ue),n(null)});let B=v.querySelector(`#btn-refresh-preview`);B&&B.addEventListener(`click`,()=>{let e=v.querySelector(`#live-preview-iframe`);e&&(e.src=D)});let ue=null;X&&(ue=X.channel(`bot-sync-${t}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`live_chats`,filter:`live_id=eq.${t}`},e=>{let n=e.new;if(n&&l.autoReplyActive&&l.autoReplyRules&&l.autoReplyRules.length>0){let e=n.nickname||``;if(!e.includes(`|`)&&e!==`관리자`&&e!==`자동응답봇`){let e=(n.content||``).toLowerCase();for(let n of l.autoReplyRules)if(n.keywords.split(`,`).map(e=>e.trim().toLowerCase()).filter(e=>e).some(t=>e.includes(t))){setTimeout(async()=>{try{if(!X)return;await X.from(`live_chats`).insert([{live_id:t,nickname:`자동응답봇`,content:n.answer,created_at:Date.now().toString()}])}catch(e){console.warn(`Auto-reply failed`,e)}},600);break}}}}).subscribe());let de=null;X&&(de=X.channel(`admin-sync-${t}`).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`live_control`,filter:`live_id=eq.${t}`},e=>{let n=e.new;if(!n)return;o.brandName=n.title||``,o.title=n.subtitle||``;let r=n.profile_image||``,i=`라이브 보기`,a=`right`,s=``,l=!1,u=r.split(`#`),d=u[0];u.slice(1).forEach(e=>{e===`nosplash`||(e.startsWith(`widgetText=`)?i=decodeURIComponent(e.replace(`widgetText=`,``)):e.startsWith(`widgetPosition=`)?a=e.replace(`widgetPosition=`,``):e.startsWith(`widgetImageUrl=`)?s=e.replace(`widgetImageUrl=`,``):e.startsWith(`showOnMain=`)&&(l=e.replace(`showOnMain=`,``)===`true`))}),o.showSplash=!r.includes(`#nosplash`),o.logoUrl=d,o.widgetText=i,o.widgetPosition=a,o.widgetImageUrl=s,o.showOnMain=l,o.streamUrl=n.stream_url||``,o.showViewers=n.show_viewers!==!1,o.thumbnailUrl=n.thumbnail_url||``,o.liveStartTime=n.start_time||``,o.isLive=n.status===`ON`,o.shareTitle=n.share_title||``,o.shareDesc=n.share_desc||``,o.shareImageUrl=n.share_image||``,o.likeImageUrl=n.like_image_url||``,o.bannedWords=n.banned_words||``,o.bannedUsers=n.banned_users||``,n.winner_name!==void 0&&(o.winner_name=n.winner_name),n.winner_timestamp!==void 0&&(o.winner_timestamp=n.winner_timestamp),St(t,o);let f=(e,t)=>{let n=v.querySelector(`#`+e)||document.getElementById(e);n&&document.activeElement!==n&&(n.type===`checkbox`?n.checked=!!t:n.value=t)};f(`cfg-brandName`,o.brandName),f(`cfg-title`,o.title),f(`cfg-stream`,o.streamUrl),f(`cfg-showViewers`,o.showViewers),f(`cfg-liveStartTime`,o.liveStartTime),f(`cfg-shareTitle`,o.shareTitle),f(`cfg-shareDesc`,o.shareDesc),f(`cfg-bannedWords`,o.bannedWords),f(`cfg-bannedUsers`,o.bannedUsers);let p=v.querySelector(`#logo-preview`)||document.getElementById(`logo-preview`);p&&(p.src=o.logoUrl);let m=v.querySelector(`#thumbnail-preview`)||document.getElementById(`thumbnail-preview`);m&&(m.src=o.thumbnailUrl);let h=v.querySelector(`#like-preview`)||document.getElementById(`like-preview`);h&&(h.src=o.likeImageUrl,h.style.display=o.likeImageUrl?`block`:`none`);let g=v.querySelector(`#like-preview-placeholder`)||document.getElementById(`like-preview-placeholder`);g&&(g.style.display=o.likeImageUrl?`none`:`block`);let _=v.querySelector(`#btn-clear-like-icon`)||document.getElementById(`btn-clear-like-icon`);_&&(_.style.display=o.likeImageUrl?`block`:`none`);let y=v.querySelector(`#btn-toggle-live`)||document.getElementById(`btn-toggle-live`);if(y&&document.activeElement!==y&&(y.textContent=o.isLive?`라이브 종료`:`라이브 시작`,y.className=`action-btn ${o.isLive?`btn-danger-solid`:`btn-success-solid`}`),n.products&&Array.isArray(n.products)){let e=JSON.stringify(n.products);if(JSON.stringify(c)!==e){Array.isArray(c)||(c=[]),c.length=0,c.push(...n.products),Et(t,c);let e=v.querySelector(`#product-list-container`)||document.getElementById(`product-list-container`);e&&!e.contains(document.activeElement)&&typeof z==`function`&&(e.innerHTML=z())}}}).subscribe());let fe=b.querySelectorAll(`.tab-btn`),pe=e=>{T.dispatchEvent(new Event(`adminTabLeave`)),fe.forEach(t=>t.classList.toggle(`active`,t.dataset.tab===e)),e===`config`?L():e===`chat`?R():e===`product`?se():e===`leads`&&ce()};fe.forEach(e=>{e.addEventListener(`click`,()=>pe(e.dataset.tab))}),L()}function It(){let e=document.createElement(`div`),t=``;function n(){let r=U.getAll(`hosts`);if(t){let e=t.toLowerCase();r=r.filter(t=>t.name.toLowerCase().includes(e)||t.phone&&t.phone.includes(e))}let i=r.map(e=>{let t=U.getHostStats(e.id);return{...e,stats:t}});e.innerHTML=`
        ...
        <div style="border-top: 1px solid var(--border-light); padding-top: var(--space-5);">
          <div class="stats-grid">
            ...
            <div class="stat-card" style="border-color: var(--border-strong);">
              ...
              <div class="stat-value" style="color: ${l>=0?`var(--status-success)`:`var(--status-error)`};">${W(l)}</div>
            </div>
            <div class="stat-card" style="border-color: var(--border-strong);">
              <div class="stat-label">순마진 <span style="font-size: 11px; font-weight: normal; color: var(--text-tertiary);">(VAT 차감 후)</span></div>
              <div class="stat-value" style="color: ${d>=0?`var(--status-success)`:`var(--status-error)`};">
                ${W(d)}
                <span style="font-size: 13px; font-weight: 600; margin-left: 4px;">(${c?(d/c*100).toFixed(1):0}%)</span>
              </div>
            </div>
            <div class="stat-card">
  ...
  `,setTimeout(()=>{t.querySelector(`#btn-edit-finance`)?.addEventListener(`click`,()=>{let i=`
      ...
      `,a=document.createElement(`div`);a.style.cssText=`display: flex; gap: var(--space-3); justify-content: flex-end; width: 100%;`;let o=document.createElement(`button`);o.className=`btn btn-secondary`,o.textContent=`취소`,o.addEventListener(`click`,q);let c=document.createElement(`button`);c.className=`btn btn-primary`,c.textContent=`저장`,c.addEventListener(`click`,()=>{let n=parseInt(document.getElementById(`fin-ad`).value)||0,i=parseInt(document.getElementById(`fin-prod`).value)||0,a=parseInt(document.getElementById(`fin-other`).value)||0,o=document.getElementById(`fin-include-host`).checked,s=o?i+n:i+r+n,c=s-r-n-a,l=Math.round(s*.1),u=c-l,d={liveId:e.id,adCost:n,productionCost:i,otherCost:a,includeHostCost:o,salesRevenue:s,operatingProfit:c,vat:l,netMargin:u},f=U.getAll(`finances`).find(t=>t.liveId===e.id);f?U.update(`finances`,f.id,d):(d.id=e.id,U.create(`finances`,d)),q(),J(`정산 정보가 저장되었습니다.`);let p=nn(e);t.replaceWith(p)}),a.appendChild(o),a.appendChild(c),K({title:`정산 정보 수정`,size:`md`,content:i,footer:a}),setTimeout(()=>{let e=document.getElementById(`fin-prod`),t=document.getElementById(`fin-ad`),n=document.getElementById(`fin-other`),i=document.getElementById(`fin-include-host`),a=()=>{let a=parseInt(e?.value)||0,o=parseInt(t?.value)||0,s=parseInt(n?.value)||0,c=i&&i.checked?a+o:a+r+o,l=c-r-o-s,u=Math.round(c*.1),d=l-u,f=c?(d/c*100).toFixed(1):`0.0`,p=document.getElementById(`prev-sales`),m=document.getElementById(`prev-profit`),h=document.getElementById(`prev-vat`),g=document.getElementById(`prev-margin`);p&&(p.textContent=W(c)),m&&(m.textContent=W(l),m.style.color=l>=0?`var(--status-success)`:`var(--status-error)`),h&&(h.textContent=W(u)),g&&(g.textContent=`${W(d)} (${f}%)`,g.style.color=d>=0?`var(--status-success)`:`var(--status-error)`)};e?.addEventListener(`input`,a),t?.addEventListener(`input`,a),n?.addEventListener(`input`,a),i?.addEventListener(`change`,a),a()},0)})},0),t}function rn(){let e=document.createElement(`div`),t=``;function n(){let r=U.getAll(`projects`),i=U.getAll(`finances`),a=U.getAll(`results`),o=[...new Set(r.map(e=>{let t=e.broadcastMonth;if(e.broadcastDate){let n=new Date(e.broadcastDate.replace(/\./g,`-`));isNaN(n.getTime())||(t=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`)}return t&&!t.includes(`-`)&&t.length<=2&&(t=`2026-${String(t).padStart(2,`0`)}`),t}).filter(Boolean))].sort().reverse(),s=r,c=a;if(t){s=r.filter(e=>{let n=e.broadcastMonth;if(e.broadcastDate){let t=new Date(e.broadcastDate.replace(/\./g,`-`));isNaN(t.getTime())||(n=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}`)}return n&&!n.includes(`-`)&&n.length<=2&&(n=`2026-${String(n).padStart(2,`0`)}`),n===t});let e=s.map(e=>e.id);i.filter(t=>e.includes(t.liveId)),c=a.filter(t=>e.includes(t.liveId))}let l=e=>{let t=i.find(t=>t.liveId===e.id)||{},n=U.query(`liveHosts`,t=>t.liveId===e.id).reduce((e,t)=>e+(t.fee||0),0),r=parseInt(t.productionCost)||0,a=parseInt(t.adCost)||0,o=parseInt(t.otherCost)||0,s=t.includeHostCost?r+a:r+n+a,c=s-(n+a+o),l=Math.round(s*.1);return{productionCost:r,hostCost:n,adCost:a,otherCost:o,salesRevenue:s,operatingProfit:c,vat:l,netMargin:c-l}},u=0,d=0,f=0,p=0,m=0,h=0,g={};s.forEach(e=>{let t=e.broadcastMonth;if(e.broadcastDate){let n=new Date(e.broadcastDate.replace(/\./g,`-`));isNaN(n.getTime())||(t=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`)}if(!t&&e.date){let n=new Date(e.date.replace(/\./g,`-`));isNaN(n.getTime())||(t=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`)}t||=`2026-05`,!t.includes(`-`)&&t.length<=2&&(t=`2026-${String(t).padStart(2,`0`)}`),g[t]||(g[t]={month:t,revenue:0,profit:0,margin:0,count:0}),g[t].count++;let n=l(e);g[t].revenue+=n.salesRevenue,g[t].profit+=n.operatingProfit,g[t].margin+=n.netMargin,u+=n.salesRevenue,d+=n.operatingProfit,f+=n.netMargin,p+=n.adCost,m+=n.productionCost,h+=n.hostCost});let _=Object.values(g).sort((e,t)=>t.month.localeCompare(e.month)),v={};s.forEach(e=>{let t=U.getById(`brands`,e.brandId);if(!t)return;v[t.id]||(v[t.id]={name:t.name,revenue:0,count:0}),v[t.id].count++;let n=c.find(t=>t.liveId===e.id);n&&(v[t.id].revenue+=parseInt(n.liveRevenue)||0)});let y=Object.values(v).sort((e,t)=>t.revenue-e.revenue),b={};U.getAll(`liveHosts`).forEach(e=>{if(t&&!s.some(t=>t.id===e.liveId))return;let n=U.getById(`hosts`,e.hostId);if(!n)return;b[n.id]||(b[n.id]={name:n.name,revenue:0,count:0,fee:0}),b[n.id].count++,b[n.id].fee+=parseInt(e.fee)||0;let r=c.find(t=>t.liveId===e.liveId);r&&(b[n.id].revenue+=parseInt(r.liveRevenue)||0)});let x=Object.values(b).sort((e,t)=>t.revenue-e.revenue),S=s.filter(e=>e.status===`settle_wait`).length,C=s.filter(e=>e.status===`settle_done`).length;e.innerHTML=`
      ...
      <div class="page-header">
        ...
        <div class="page-header-right" style="display: flex; gap: 10px; align-items: center;">
          <select id="month-filter-select" class="form-control" style="padding: 8px 14px; font-size: 14px; border-radius: 8px; font-weight: 600; cursor: pointer; border: 1px solid #d0d7de;">
            <option value="all" ${t===`all`?`selected`:``}>전체 기간 보기</option>
            ${s.map(e=>`
              <option value="${e}" ${t===e?`selected`:``}>${e.replace(`-`,`년 `)}월</option>
            `).join(``)}
          </select>
        ...
        <div class="stats-grid" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: var(--space-4); margin-bottom: var(--space-6);">
          <div class="stat-card" style="background: #fff; padding: 20px; border-radius: 12px; border: 1px solid #e2e8f0;">
            ...
            <div class="stat-value" style="font-size: 24px; font-weight: 700; color: #0f172a; margin-top: 6px;">
              ${c.length}건 <span style="font-size: 13px; font-weight: normal; color: #f59e0b;">(대기 ${f}건)</span>
            </div>
          </div>
        ...
        <div class="card" style="background: #fff; border-radius: 12px; border: 1px solid #e2e8f0; padding: 20px;">
          <div class="card-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
            <div style="display: flex; align-items: center; gap: 10px;">
              ...
              <span class="badge badge-secondary" style="font-size: 12px;">${c.length}개 항목</span>
            </div>
            ${f>0?`
    ...
    `;let p=e.querySelector(`#month-filter-select`);p&&p.addEventListener(`change`,e=>{t=e.target.value,n()});let m={};c.forEach(e=>{let t=`${e.hostName}__${e.month}`;m[t]||(m[t]={hostName:e.hostName,month:e.month,items:[]}),m[t].items.push(e)});let h=e.querySelector(`#settle-tbody`);h&&(c.length===0?h.innerHTML=`<tr><td colspan="8" class="text-center" style="padding:40px;color:#94a3b8;">선택한 조건의 정산 내역이 없습니다.</td></tr>`:(h.innerHTML=``,c.forEach(e=>{let t=document.createElement(`tr`);t.style.cssText=`border-bottom: 1px solid #f1f5f9;`;let n=`${e.hostName}__${e.month}`;t.innerHTML=`
