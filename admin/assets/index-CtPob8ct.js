...
`;e.forEach(e=>{let t=new Date(e.created_at).toLocaleString(`ko-KR`).replace(/,/g,``),r=(e.name||``).replace(/,/g,` `),i=(e.phone||``).replace(/,/g,` `);n+=`${t},${r},${i}\n`});let r=new Blob([`﻿`+n],{type:`text/csv;charset=utf-8;`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=`상담DB_${t}.csv`,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(i)})};setTimeout(()=>{document.getElementById(`btn-back`).addEventListener(`click`,()=>{T.dispatchEvent(new Event(`adminTabLeave`)),w(),u&&clearInterval(u),r&&Z.removeChannel(r),e&&Z.removeChannel(e),n(null)}),document.getElementById(`btn-refresh-preview`).addEventListener(`click`,()=>{document.getElementById(`live-preview-iframe`).src=D});let e=null;Z&&(e=Z.channel(`bot-sync-${t}`).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`live_chats`,filter:`live_id=eq.${t}`},e=>{let n=e.new;if(n&&l.autoReplyActive&&l.autoReplyRules&&l.autoReplyRules.length>0){let e=n.nickname||``;if(!e.includes(`|`)&&e!==`관리자`&&e!==`자동응답봇`){let e=(n.content||``).toLowerCase();for(let n of l.autoReplyRules)if(n.keywords.split(`,`).map(e=>e.trim().toLowerCase()).filter(e=>e).some(t=>e.includes(t))){setTimeout(async()=>{try{if(!Z)return;await Z.from(`live_chats`).insert([{live_id:t,nickname:`자동응답봇`,content:n.answer,created_at:Date.now().toString()}])}catch(e){console.warn(`Auto-reply failed`,e)}},600);break}}}}).subscribe());let r=null;Z&&(r=Z.channel(`admin-sync-${t}`).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`live_control`,filter:`live_id=eq.${t}`},e=>{let n=e.new;if(!n)return;o.brandName=n.title||``,o.title=n.subtitle||``;let r=n.profile_image||``;o.showSplash=!r.includes(`#nosplash`),o.logoUrl=r.replace(`#nosplash`,``),o.streamUrl=n.stream_url||``,o.showViewers=n.show_viewers!==!1,o.thumbnailUrl=n.thumbnail_url||``,o.liveStartTime=n.start_time||``,o.isLive=n.status===`ON`,o.shareTitle=n.share_title||``,o.shareDesc=n.share_desc||``,o.shareImageUrl=n.share_image||``,o.likeImageUrl=n.like_image_url||``,o.bannedWords=n.banned_words||``,o.bannedUsers=n.banned_users||``,n.winner_name!==void 0&&(o.winner_name=n.winner_name),n.winner_timestamp!==void 0&&(o.winner_timestamp=n.winner_timestamp),xt(t,o);let i=(e,t)=>{let n=document.getElementById(e);n&&document.activeElement!==n&&(n.type===`checkbox`?n.checked=!!t:n.value=t)};i(`cfg-brandName`,o.brandName),i(`cfg-title`,o.title),i(`cfg-stream`,o.streamUrl),i(`cfg-showViewers`,o.showViewers),i(`cfg-liveStartTime`,o.liveStartTime),i(`cfg-shareTitle`,o.shareTitle),i(`cfg-shareDesc`,o.shareDesc),i(`cfg-bannedWords`,o.bannedWords),i(`cfg-bannedUsers`,o.bannedUsers);let a=document.getElementById(`logo-preview`);a&&(a.src=o.logoUrl);let s=document.getElementById(`thumbnail-preview`);s&&(s.src=o.thumbnailUrl);let l=document.getElementById(`like-preview`);l&&(l.src=o.likeImageUrl,l.style.display=o.likeImageUrl?`block`:`none`);let u=document.getElementById(`like-preview-placeholder`);u&&(u.style.display=o.likeImageUrl?`none`:`block`);let d=document.getElementById(`btn-clear-like-icon`);d&&(d.style.display=o.likeImageUrl?`block`:`none`);let f=document.getElementById(`btn-toggle-live`);if(f&&document.activeElement!==f&&(f.textContent=o.isLive?`라이브 종료`:`라이브 시작`,f.className=`action-btn ${o.isLive?`btn-danger-solid`:`btn-success-solid`}`),n.products&&Array.isArray(n.products)){let e=JSON.stringify(n.products);if(JSON.stringify(c)!==e){Array.isArray(c)||(c=[]),c.length=0,c.push(...n.products),Tt(t,c);let e=document.getElementById(`product-list-container`);e&&!e.contains(document.activeElement)&&typeof M==`function`&&(e.innerHTML=M())}}}).subscribe());let i=b.querySelectorAll(`.tab-btn`),a=e=>{T.dispatchEvent(new Event(`adminTabLeave`)),i.forEach(t=>t.classList.toggle(`active`,t.dataset.tab===e)),e===`config`?A():e===`chat`?j():e===`product`?N():e===`leads`&&P()};i.forEach(e=>{e.addEventListener(`click`,()=>a(e.dataset.tab))}),A()},0)}function Ft(){let e=document.createElement(`div`),t=``;function n(){let r=U.getAll(`hosts`);if(t){let e=t.toLowerCase();r=r.filter(t=>t.name.toLowerCase().includes(e)||t.phone&&t.phone.includes(e))}let i=r.map(e=>{let t=U.getHostStats(e.id);return{...e,stats:t}});e.innerHTML=`
      <div class="page-header">
        <div class="page-header-left">
          <div>
