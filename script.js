...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            c_phone: "전화 문의 ",
            c_email: "이메일 문의",
            f_info: "대표 : 채이준 <br> 사업자 등록번호 : 821-29-011-97<br> 개인정보관리책임자 : 채이준 <br> 통신판매업 신고번호 : 제 2026-경기하남-0239호<br> 주소 : 경기도 하남시 미사강변동로 100-1 미사역 파라곤스퀘어 2064-2<br> 이메일 : choijun@ryzincorp.com",
            f_insta: "인스타그램",
            f_blog: "블로그",
            f_career: "채용",
        ...
        en: {
            ...
            f_info: "CEO: Chae I-Jun <br> Business Registration Num: 821-29-011-97<br> Privacy Officer: Chae I-Jun <br> Mail-order Business Report Num: No. 2026-Gyeonggihanam-0239<br> Address: Misa Paragon Square 2064-2, 100-1 Misagangbyeondong-ro, Hanam-si, Gyeonggi-do<br> Email: choijun@ryzincorp.com",
            f_insta: "Instagram",
            f_blog: "Blog",
            f_career: "Careers",
        ...
        zh: {
            ...
            c_phone: "电话咨询 ",
            c_email: "邮箱咨询",
            f_info: "代表：Chae I-Jun <br> 营业执照：821-29-011-97<br> 个人信息保护责任人：Chae I-Jun <br> 邮购业务申报号：第 2026-Gyeonggihanam-0239号<br> 地址: 韩国京畿道河南市渼沙江边东路100-1 Misa Paragon Square 2064-2<br> 邮箱：choijun@ryzincorp.com",
            f_insta: "Instagram",
            f_blog: "博客",
            f_career: "招聘",
    ...
    async function loadHeroGallery() {
        ...
        displayList.forEach((img, idx) => {
            ...
            if (isVideo) {
                ...
                mediaHtml = `<img src="${imgSrc}" alt="RYZIN Portfolio" class="absolute inset-0 w-full h-full object-cover" loading="eager" draggable="false">`;
            }
